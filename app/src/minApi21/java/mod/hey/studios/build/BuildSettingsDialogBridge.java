...
public class BuildSettingsDialogBridge {
  public static String[] getAvailableJavaVersions() {
    return new String[] {
      SETTING_JAVA_VERSION_1_7, SETTING_JAVA_VERSION_1_8,
    };
  }
  ...
  public static void handleDexerChange(String choice) {
    if (choice.equals(BuildSettings.SETTING_DEXER_D8)
        && Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
      SketchwareUtil.toast(
          "Your Android version isn't compatible with D8 (requires Android 8+).\n"
