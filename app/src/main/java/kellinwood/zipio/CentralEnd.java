...
public class CentralEnd {
  ...
  public short
      numCentralEntries; // total number of entries in the central directory on this disk  2 bytes
  public short
      totalCentralEntries; // total number of entries in the central directory           2 bytes
  ...
  private static final Logger log = Logger.getLogger(CentralEnd.class);
