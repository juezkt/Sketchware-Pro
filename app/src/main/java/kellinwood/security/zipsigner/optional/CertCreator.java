...
public class CertCreator {
  ...
  /**
   * Creates a new keystore and self-signed key. The key will have the same password as the key, and
   * will be RSA 2048, with the cert signed using SHA1withRSA. The certificate will have a validity
   * of 30 years).
   *
   ...
   */
  public static void createKeystoreAndKey(
      String storePath,
      char[] password,
      String keyName,
  ...
  public static KeySet createKeystoreAndKey(
      String storePath,
      char[] storePass,
      String keyAlgorithm,
      int keySize,
  ...
  public static KeySet createKey(
      String storePath,
      char[] storePass,
      String keyAlgorithm,
      int keySize,
