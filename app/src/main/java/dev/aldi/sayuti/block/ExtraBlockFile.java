...
public class ExtraBlockFile {
  ...
  public static final File EXTRA_BLOCKS_DATA_FILE =
      new File(
          Environment.getExternalStorageDirectory(),
          ".sketchware/resources/block/My Block/block.json");
  public static final File EXTRA_BLOCKS_PALETTE_FILE =
      new File(
          Environment.getExternalStorageDirectory(),
  ...
  /**
   * @return Non-empty content of {@link ExtraBlockFile#EXTRA_BLOCKS_DATA_FILE}, as cases of <code>
   *     ""</code> as file content return <code>"[]"</code>
   */
