...
/**
 * Utility class for detecting IllegalStateException: Circular Dependencies in RelativeLayout parent
 * attributes
 */
public class CircularDependencyDetector {
  ...
  // and it seems to be working fine. I hope this code is able to detect all possible cases, or at
  // least most of them.
