...
public class ProjectScreenshotsAdapter
    extends RecyclerView.Adapter<ProjectScreenshotsAdapter.ViewHolder> {
  ...
  public ProjectScreenshotsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    ViewStoreProjectScreenshotBinding binding =
        ViewStoreProjectScreenshotBinding.inflate(inflater, parent, false);
