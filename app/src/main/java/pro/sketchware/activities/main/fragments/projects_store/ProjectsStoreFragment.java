...
public class ProjectsStoreFragment extends Fragment {
  ...
  private void fetchData() {
    ...
    sketchHubAPI.getEditorsChoicerProjects(
        ...
        projectModel -> {
          if (projectModel != null) {
            binding.editorsChoiceProjectsRecyclerView.setAdapter(
                new StorePagerProjectsAdapter(projectModel.getProjects(), activity));
          }
        });
    sketchHubAPI.getMostDownloadedProjects(
        ...
        projectModel -> {
          if (projectModel != null) {
            binding.mostDownloadedProjectsRecyclerView.setAdapter(
                new StoreProjectsAdapter(projectModel.getProjects(), activity));
          }
        });
    sketchHubAPI.getRecentProjects(
        ...
        projectModel -> {
          if (projectModel != null) {
            binding.recentProjectsRecyclerView.setAdapter(
                new StoreProjectsAdapter(projectModel.getProjects(), activity));
          }
        });
  }
