...
public class ProjectsFragment extends DA {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    binding.myprojects.addOnScrollListener(
        ...
        .addMenuProvider(
            new MenuProvider() {
              ...
              public void onCreateMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
                ...
                projectsSearchView =
                    (SearchView) menu.findItem(R.id.searchProjects).getActionView();
                if (projectsSearchView != null) {
                  projectsSearchView.setOnQueryTextListener(
  ...
  public final ActivityResultLauncher<Intent> openProjectSettings =
    ...
    executorService.execute(
        () -> {
          ...
          if (updatedProject != null) {
            int index =
                IntStream.range(0, projectsList.size())
  ...
  private void showProjectSortingDialog() {
    ...
    SortProjectDialogBinding dialogBinding =
        SortProjectDialogBinding.inflate(LayoutInflater.from(requireActivity()));
    ...
    if ((storedValue & ProjectComparator.SORT_ORDER_ASCENDING)
        == ProjectComparator.SORT_ORDER_ASCENDING) {
      sortOrderAsc.setChecked(true);
    } else if ((storedValue & ProjectComparator.SORT_ORDER_DESCENDING)
        == ProjectComparator.SORT_ORDER_DESCENDING) {
  ...
  private static class ProjectDiffCallback extends DiffUtil.Callback {
    ...
    public ProjectDiffCallback(
        List<HashMap<String, Object>> oldList, List<HashMap<String, Object>> newList) {
