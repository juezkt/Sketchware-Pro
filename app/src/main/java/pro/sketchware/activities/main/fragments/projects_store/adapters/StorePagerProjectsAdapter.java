...
public class StorePagerProjectsAdapter
    extends RecyclerView.Adapter<StorePagerProjectsAdapter.ViewHolder> {
  ...
  public StorePagerProjectsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    ViewStoreProjectPagerItemBinding binding =
        ViewStoreProjectPagerItemBinding.inflate(inflater, parent, false);
  ...
  private void openProject(ProjectModel.Project project, View view) {
    ...
    if (fm.findFragmentByTag("project_preview") == null) {
      ...
      var options = ActivityOptions.makeSceneTransitionAnimation(context, view, "project_preview");
