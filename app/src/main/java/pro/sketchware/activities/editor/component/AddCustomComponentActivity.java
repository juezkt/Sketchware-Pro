...
public class AddCustomComponentActivity extends BaseAppCompatActivity
  ...
  private void initializeHelper() {
    binding.componentName.addTextChangedListener(
        new ComponentHelper(
            new EditText[] {
              binding.componentBuildClass,
              binding.componentVarTypeName,
              binding.componentTypeName,
              binding.componentTypeClass
            },
            binding.componentTypeClass));
  }
  ...
  private void selectComponentToImport(String path) {
    ...
    if (componentNames.size() > 1) {
      ...
      ArrayAdapter<String> arrayAdapter =
          new ArrayAdapter<>(this, android.R.layout.simple_list_item_single_choice, componentNames);
