...
public class XMLCommandAdapter
  ...
  private static final DiffUtil.ItemCallback<HashMap<String, Object>> DIFF_CALLBACK =
      new DiffUtil.ItemCallback<>() {
        ...
        public boolean areItemsTheSame(
            @NonNull HashMap<String, Object> oldItem, @NonNull HashMap<String, Object> newItem) {
  ...
  public void setOnItemClickListener(ItemClickListener<Pair<View, Integer>> listener) {
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    void bind(HashMap<String, Object> item) {
      binding.tvName.setText(
          CommandBlock.getInputName(item.get("input") != null ? item.get("input").toString() : ""));
