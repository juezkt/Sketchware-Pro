...
public class ChangeLogAdapter extends RecyclerView.Adapter<ChangeLogAdapter.ViewHolder> {
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    AboutChangelogBinding binding =
        AboutChangelogBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    ...
    if (releaseDate > 0) {
      ...
      holder.binding.tvReleaseNote.setText(
          "Released on: " + formatter.format(new Date(releaseDate)));
    } else {
    ...
    holder.binding.viewAdditionalInfo.setVisibility(
        showingAdditionalInfo ? View.VISIBLE : View.GONE);
    ...
    holder.binding.logBackground.setOnClickListener(
        v -> {
