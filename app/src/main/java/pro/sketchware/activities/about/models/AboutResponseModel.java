  ...
  public static class CommitDetails {
    ...
    public String getCommitDate() {
      try {
        ...
        OffsetDateTime commitDateTime =
            OffsetDateTime.parse(commitDateString, DateTimeFormatter.ISO_OFFSET_DATE_TIME);
    ...
    private String formatCommitDate(LocalDate commitDate) {
      ...
      if (commitDate.equals(today)) {
        ...
        long monthsAgo =
            ChronoUnit.MONTHS.between(commitDate.withDayOfMonth(1), today.withDayOfMonth(1));
        if (monthsAgo <= 12) {
