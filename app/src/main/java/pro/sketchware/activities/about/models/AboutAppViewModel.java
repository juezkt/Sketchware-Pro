...
public class AboutAppViewModel extends ViewModel {
  ...
  private final MutableLiveData<ArrayList<AboutResponseModel.TeamMember>> teamMembers =
      new MutableLiveData<>();
  private final MutableLiveData<ArrayList<AboutResponseModel.ChangeLogs>> changelog =
      new MutableLiveData<>();
  private final MutableLiveData<ArrayList<AboutResponseModel.CommitDetails>> commitDetailsList =
      new MutableLiveData<>();
