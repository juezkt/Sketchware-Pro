...
public class BlockSelectorDetailsAdapter
    extends ListAdapter<String, BlockSelectorDetailsAdapter.BlockSelectorDetailsAdapterViewHolder> {
  ...
  @NonNull
  @Override
  public BlockSelectorDetailsAdapterViewHolder onCreateViewHolder(
      @NonNull ViewGroup parent, int viewType) {
    LayoutBlockSelectorBinding binding =
        LayoutBlockSelectorBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    return new BlockSelectorDetailsAdapterViewHolder(binding, onClick, onLongClick);
  }

  @Override
  public void onBindViewHolder(
      @NonNull BlockSelectorDetailsAdapterViewHolder holder, int position) {
  ...
  public static class BlockSelectorDetailsAdapterViewHolder extends RecyclerView.ViewHolder {
    ...
    public BlockSelectorDetailsAdapterViewHolder(
        LayoutBlockSelectorBinding binding,
  ...
  public static class BlockSelectorDetailsAdapterDiffCallback
      extends DiffUtil.ItemCallback<String> {
    @Override
