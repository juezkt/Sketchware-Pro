...
public class BlockSelectorAdapter
    extends ListAdapter<Selector, BlockSelectorAdapter.BlockSelectorAdapterViewHolder> {
  ...
  @NonNull
  @Override
  public BlockSelectorAdapterViewHolder onCreateViewHolder(
  ...
  public static class BlockSelectorAdapterViewHolder extends RecyclerView.ViewHolder {
    ...
    public BlockSelectorAdapterViewHolder(
        LayoutBlockSelectorBinding binding,
