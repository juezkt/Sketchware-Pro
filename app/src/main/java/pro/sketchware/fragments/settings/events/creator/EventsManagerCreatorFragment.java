...
public class EventsManagerCreatorFragment extends qA {
  ...
  private void getViewsById() {
    ...
    if (isActivityEvent) {
      ...
      ((View) binding.eventsCreatorIcon.getParent().getParent().getParent())
  ...
  private void setupViews() {
    binding.eventsCreatorCancel.setOnClickListener(
        Helper.getBackPressedClickListener(requireActivity()));
  ...
  private int figureP(String str) {
    ...
    if (FileUtil.isExistFile(concat)) {
      ArrayList<HashMap<String, Object>> arrayList =
          getGson().fromJson(FileUtil.readFile(concat), Helper.TYPE_MAP_LIST);
