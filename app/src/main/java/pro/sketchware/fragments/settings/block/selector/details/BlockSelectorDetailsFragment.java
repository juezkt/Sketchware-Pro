...
public class BlockSelectorDetailsFragment extends qA {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    adapter =
        new BlockSelectorDetailsAdapter(
  ...
  private void showCreateEditDialog(boolean isEdit, int indexA) {
    DialogAddCustomActivityBinding dialogBinding =
        DialogAddCustomActivityBinding.inflate(LayoutInflater.from(requireContext()));
  ...
  private void showConfirmationDialog(
      String message, OnDialogClickListener onConfirm, OnDialogClickListener onCancel) {
    aB dialog = new aB(requireActivity());
    dialog.b("Attention");
    dialog.a(message);
  ...
  private void saveAll() {
    FileUtil.writeFile(
        BlockSelectorConsts.BLOCK_SELECTORS_FILE.getAbsolutePath(), getGson().toJson(selectors));
