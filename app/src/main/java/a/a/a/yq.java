...
public class yq {
  ...
  /**
   * Firebase Database storage location RegExp matcher to remove unwanted parts of storage URL to
   * get the actual project ID.
   *
   * <p>Users should enter the entire storage URL without <code>https://</code> at the beginning and
   * <code>/</code> at the end, e.g. <code>sk-pro-default-rtdb.firebaseio.com</code>.
   */
  private static final String FIREBASE_DATABASE_STORAGE_LOCATION_MATCHER =
      "(-default-rtdb)?\\.[a-z](.?)+";

  private static final Pattern PACKAGE_PLACEHOLDER_PATTERN =
      Pattern.compile("<\\?package_name\\?>");
  ...
  /**
   * Path of ZIP file containing compiled resources of the current project, e.g.
   * /storage/emulated/0/.sketchware/mysc/605/bin/InternalDemo.apk.res
   */
  ...
  /**
   * Package name of current project, but "folders" separated with slashes (/) instead of periods
   * (.), e.g. com/jbk/internal/demo
   */
  public final String packageNameAsFolders;

  /**
   * Path of file with ProGuard rules automatically generated by aapt2, e.g.
   * /storage/emulated/0/.sketchware/mysc/605/bin/aapt_rules.pro
   */
  public final String proguardAaptRules;

  /**
   * Path of ProGuard rules auto-generated to exclude built-in libraries and non-Full Mode Local
   * libraries, e.g. /storage/emulated/0/.sketchware/mysc/605/bin/rules_generated.pro
   */
  public final String proguardAutoGeneratedExclusions;

  /**
   * ProGuarded classes.jar file's path of current project, e.g.
   * /storage/emulated/0/.sketchware/mysc/605/bin/classes_proguard.jar
   */
  public final String proguardClassesPath;

  /**
   * Path of file containing the ProGuard mapping, e.g.
   * /storage/emulated/0/.sketchware/mysc/605/bin/mapping.txt
   */
  public final String proguardMappingPath;

  /**
   * Path of file containing ProGuard seeds, e.g.
   * /storage/emulated/0/.sketchware/mysc/605/bin/seeds.txt
   */
  public final String proguardSeedsPath;

  /**
   * Path of file containing ProGuard usage, e.g.
   * /storage/emulated/0/.sketchware/mysc/605/bin/usage.txt
   */
  ...
  /**
   * Project's generated R.java files directory, e.g. /storage/emulated/0/.sketchware/mysc/605/gen
   */
  ...
  public yq(Context context, String myscFolderPath, HashMap<String, Object> metadata) {
    ...
    N.sc_id = sc_id;
    projectMyscPath =
        myscFolderPath.endsWith(File.separator) ? myscFolderPath : myscFolderPath + File.separator;
    ...
    colorAccent =
        yB.a(metadata, ProjectFile.COLOR_ACCENT, getDefaultColor(ProjectFile.COLOR_ACCENT));
    colorPrimary =
        yB.a(metadata, ProjectFile.COLOR_PRIMARY, getDefaultColor(ProjectFile.COLOR_PRIMARY));
    colorPrimaryDark =
        yB.a(
            metadata,
  ...
  /**
   * Creates needed build directories {@link yq#binDirectoryPath}, {@link yq#compiledClassesPath},
   * {@link yq#rJavaDirectoryPath}, {@link yq#javaFilesPath}, {@link yq#resDirectoryPath}, {@link
   * yq#layoutFilesPath}, {@link yq#importedSoundsPath}, {@link yq#assetsPath}, and {@link
   * yq#fontsPath}.
   */
  ...
  /**
   * Deletes temporary compile cache directories, {@link yq#binDirectoryPath} and {@link
   * yq#rJavaDirectoryPath}. The used method logs all files and folders which get deleted.
   */
  public void f() {
  ...
  public void h() {
    fileUtil.b(
        projectMyscPath + File.separator + "app" + File.separator + "build.gradle",
        Lx.getBuildGradleString(
            VAR_DEFAULT_TARGET_SDK_VERSION,
            VAR_DEFAULT_MIN_SDK_VERSION,
    ...
    fileUtil.b(
        projectMyscPath + File.separator + "gradle.properties",
        """
  ...
  /**
   * Copies a file to the project's app icon path, {@link
   * yq#resDirectoryPath}/drawable-xhdpi/app_icon.png
   */
  public void a(String iconPath) {
    try {
      fileUtil.a(
          iconPath,
          resDirectoryPath + File.separator + "mipmap-xhdpi" + File.separator + "ic_launcher.png");
    } catch (Exception e2) {
      e2.printStackTrace();
    }
  }
  ...
  /**
   * creates ic_launcher.xml to the project's app icon path, {@link
   * yq#resDirectoryPath}/mipmap-anydpi-v26
   */
  ...
  public void a(Context context) {
    boolean logcatEnabled =
        N.isDebugBuild
            && new BuildSettings(sc_id)
                .getValue(
                    BuildSettings.SETTING_ENABLE_LOGCAT, BuildSettings.SETTING_GENERIC_VALUE_TRUE)
                .equals(BuildSettings.SETTING_GENERIC_VALUE_TRUE);

    String javaDir =
        FileUtil.getExternalStorageDir() + "/.sketchware/data/" + sc_id + "/files/java/";
    if (!new File(javaDir, "DebugActivity.java").exists()) {
      fileUtil.b(
          javaFilesPath
              ...
              + File.separator
              + "DebugActivity.java",
          PACKAGE_PLACEHOLDER_PATTERN
              .matcher(fileUtil.b(context, "debug" + File.separator + "DebugActivity.java"))
              .replaceAll(packageName));
    }

    String customApplicationClassName =
        new ProjectSettings(sc_id)
            .getValue(ProjectSettings.SETTING_APPLICATION_CLASS, ".SketchApplication");
    boolean notUsingCustomApplicationClass =
        customApplicationClassName.equals(".SketchApplication");
    if (!new File(javaDir, "SketchApplication.java").exists() && notUsingCustomApplicationClass) {
      ...
      String sketchApplicationFileContent =
          PACKAGE_PLACEHOLDER_PATTERN
              .matcher(fileUtil.b(context, "debug" + File.separator + "SketchApplication.java"))
              .replaceAll(packageName);
      if (applyMultiDex) {
        sketchApplicationFileContent =
            sketchApplicationFileContent.replaceAll(
    ...
    if (logcatEnabled) {
      if (!new File(javaDir, "SketchLogger.java").exists()) {
        String sketchLoggerFileContent =
            PACKAGE_PLACEHOLDER_PATTERN
                .matcher(fileUtil.b(context, "debug" + File.separator + "SketchLogger.java"))
                .replaceAll(packageName);

        if (!notUsingCustomApplicationClass && customApplicationClassName.charAt(0) == '.') {
          sketchLoggerFileContent =
              sketchLoggerFileContent.replaceAll(
   ...
   * </pre>
   *
   * , while AndroidManifest.xml gets saved to {@link yq#androidManifestPath}.
   */
  public void a(String fileName, String fileContent) {
    if (fileName.endsWith("java")) {
      fileUtil.b(
          javaFilesPath + File.separator + packageNameAsFolders + File.separator + fileName,
          fileContent);
      ...
      fileUtil.b(androidManifestPath, fileContent);
        ...
        || fileName.equals("strings.xml")) {
      fileUtil.b(
          resDirectoryPath + File.separator + "values" + File.separator + fileName, fileContent);
    } else if (fileName.equals("provider_paths.xml")) {
      fileUtil.b(
          resDirectoryPath + File.separator + "xml" + File.separator + fileName, fileContent);
    } else {
  ...
  public void a(
      iC projectLibraryManager,
      hC projectFileManager,
      eC projectDataManager,
      boolean exportingProject) {
    ...
    for (ProjectFileBean activity : projectFileManager.b()) {
      ...
      for (ComponentBean component : projectDataManager.e(activity.getJavaName())) {
        switch (component.type) {
          ...
          case ComponentBean.COMPONENT_TYPE_FIREBASE_DYNAMIC_LINKS -> N.isDynamicLinkUsed = true;
          case ComponentBean.COMPONENT_TYPE_FIREBASE_CLOUD_MESSAGE -> N.x.isFCMUsed = true;
          case ComponentBean.COMPONENT_TYPE_FIREBASE_AUTH_GOOGLE_LOGIN -> N.x.isFBGoogleUsed = true;
      ...
      for (Map.Entry<String, ArrayList<BlockBean>> entry :
          projectDataManager.b(activity.getJavaName()).entrySet()) {
  ...
  /**
   * Generates the project's files, such as layouts, Java files, but also build.gradle and
   * secrets.xml.
   */
  public void b(
      hC projectFileManager,
      eC projectDataManger,
      iC projectLibraryManager,
      BuiltInLibraryManager builtInLibraryManager) {
    ArrayList<SrcCodeBean> srcCodeBeans =
        a(projectFileManager, projectDataManger, builtInLibraryManager);
    if (N.u) {
    ...
    if (N.isFirebaseEnabled || N.isAdMobEnabled || N.isMapUsed) {
      ...
      fileUtil.b(
          resDirectoryPath + File.separator + filePath,
  ...
  public ArrayList<SrcCodeBean> a(
      hC projectFileManager, eC projectDataManager, BuiltInLibraryManager builtInLibraryManager) {
    ...
    final String layoutDir =
        FileUtil.getExternalStorageDir() + "/.sketchware/data/" + sc_id + "/files/resource/layout/";
    List<File> javaFiles;
    {
    ...
    for (ProjectFileBean activity : projectFileManager.b()) {
      if (!javaFiles.contains(new File(javaDir + activity.getJavaName()))) {
        srcCodeBeans.add(
            new SrcCodeBean(
                activity.getJavaName(), new Jx(N, activity, projectDataManager).generateCode()));
      }
    }
    ...
    if (newXMLCommand && FileUtil.isExistFile(path)) {
      FileUtil.copyFile(
          path, FileUtil.getExternalStorageDir().concat("/.sketchware/temp/commands"));
    }
    ...
    for (ProjectFileBean layout : regularLayouts) {
      ...
      if (!layoutFiles.contains(ogFile)) {
        ...
        if (isViewBindingEnable()) {
          ...
          FileUtil.writeFile(
              privFile.getAbsolutePath(), CommandBlock.applyCommands(xmlName, ox.b()));
          var code = viewBindingBuilder.generateBindingForLayout(privFile);
          srcCodeBeans.add(
              new SrcCodeBean(
                  ViewBindingBuilder.generateFileNameForLayout(xmlName.replace(".xml", ""))
                      + ".java",
    ...
    if (!javaFiles.contains(new File(javaDir + "SketchwareUtil.java"))) {
      srcCodeBeans.add(new SrcCodeBean("SketchwareUtil.java", Lx.i(packageName)));
    }
    ...
    if (!FileUtil.isExistFile(javaDir + "RequestNetworkController.java") && N.isHttp3Used) {
      srcCodeBeans.add(
          new SrcCodeBean("RequestNetworkController.java", Lx.j(Lx.g(packageName), false)));
    }

    if (!javaFiles.contains(new File(javaDir + "BluetoothConnect.java"))
        && N.hasPermission(jq.PERMISSION_BLUETOOTH)) {
    ...
    if (N.isMapUsed) {
      if (!javaFiles.contains(new File(javaDir + "GoogleMapController.java")) && N.isMapUsed) {
        srcCodeBeans.add(
            new SrcCodeBean("GoogleMapController.java", Lx.j(Lx.f(packageName), false)));
      }
    }

    srcCodeBeans.add(
        new SrcCodeBean(
            "AndroidManifest.xml", CommandBlock.applyCommands("AndroidManifest.xml", ix.a())));
  ...
  private boolean isViewBindingEnable() {
    return generateDataBindingClasses
        && projectSettings
            .getValue(
  ...
  public String getFileSrc(
      String filename, hC projectFileManager, eC projectDataManager, iC projectLibraryManager) {
  ...
  private String getXMLColor() {
    ...
    colorsFileBuilder.addColor(
        "colorPrimaryDark", String.format("#%06X", colorPrimaryDark & 0xffffff));
    colorsFileBuilder.addColor("colorAccent", String.format("#%06X", colorAccent & 0xffffff));
    colorsFileBuilder.addColor(
        "colorControlHighlight", String.format("#%06X", colorControlHighlight & 0xffffff));
    colorsFileBuilder.addColor(
        "colorControlNormal", String.format("#%06X", colorControlNormal & 0xffffff));
    return CommandBlock.applyCommands("colors.xml", colorsFileBuilder.toCode());
  }

  private String getXMLStyle() {
    if (N.g) {
      boolean useNewMaterialComponentsTheme =
          projectSettings
              .getValue(
      ...
      stylesFileBuilder.addStyle(
          "AppTheme",
          "Theme.MaterialComponents.Light.NoActionBar"
              + (useNewMaterialComponentsTheme ? "" : ".Bridge"));
      ...
      stylesFileBuilder.addItemToStyle(
          "AppTheme", "colorControlHighlight", "@color/colorControlHighlight");
      stylesFileBuilder.addItemToStyle(
          "AppTheme", "colorControlNormal", "@color/colorControlNormal");
      ...
      stylesFileBuilder.addItemToStyle(
          "AppTheme.FullScreen", "android:windowContentOverlay", "@null");
      stylesFileBuilder.addStyle(
      ...
      stylesFileBuilder.addItemToStyle(
          "AppTheme.DebugActivity",
          "actionBarStyle",
          "@style/ThemeOverlay.MaterialComponents.ActionBar.Primary");
      stylesFileBuilder.addItemToStyle(
          "AppTheme.DebugActivity",
          "actionBarTheme",
          "@style/Widget.MaterialComponents.ActionBar.Primary");
      ...
      stylesFileBuilder.addItemToStyle(
          "AppTheme", "android:colorPrimaryDark", "@color/colorPrimaryDark");
      stylesFileBuilder.addItemToStyle("AppTheme", "android:colorAccent", "@color/colorAccent");
      stylesFileBuilder.addItemToStyle(
          "AppTheme", "android:colorControlHighlight", "@color/colorControlHighlight");
      stylesFileBuilder.addItemToStyle(
          "AppTheme", "android:colorControlNormal", "@color/colorControlNormal");
      stylesFileBuilder.addStyle(
          "FullScreen", "@android:style/Theme.Material.Light.NoActionBar.Fullscreen");
      stylesFileBuilder.addItemToStyle("FullScreen", "android:colorPrimary", "@color/colorPrimary");
      stylesFileBuilder.addItemToStyle(
          "FullScreen", "android:colorPrimaryDark", "@color/colorPrimaryDark");
      stylesFileBuilder.addItemToStyle("FullScreen", "android:colorAccent", "@color/colorAccent");
      stylesFileBuilder.addItemToStyle(
          "FullScreen", "android:colorControlHighlight", "@color/colorControlHighlight");
      stylesFileBuilder.addItemToStyle(
          "FullScreen", "android:colorControlNormal", "@color/colorControlNormal");
      stylesFileBuilder.addStyle("NoActionBar", "@android:style/Theme.Material.Light.NoActionBar");
      stylesFileBuilder.addItemToStyle(
          "NoActionBar", "android:colorPrimary", "@color/colorPrimary");
      stylesFileBuilder.addItemToStyle(
          "NoActionBar", "android:colorPrimaryDark", "@color/colorPrimaryDark");
      stylesFileBuilder.addItemToStyle("NoActionBar", "android:colorAccent", "@color/colorAccent");
      stylesFileBuilder.addItemToStyle(
          "NoActionBar", "android:colorControlHighlight", "@color/colorControlHighlight");
      stylesFileBuilder.addItemToStyle(
          "NoActionBar", "android:colorControlNormal", "@color/colorControlNormal");
