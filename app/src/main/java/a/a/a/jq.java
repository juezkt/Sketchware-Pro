...
public class jq {
  ...
  /**
   * A permission type for {@link jq#addPermission(String, int)}, {@link jq#addPermission(int)} and
   * {@link a#b(int)}.
   *
  ...
  /** Project's package name, e.g. com.jbk.internal.demo. */
  public String packageName = "";

  /** Application's name of project, e.g. Sketchware Pro Remod Remod Demo. */
  public String projectName;

  /** Project version code, e.g. 1 */
  public String versionCode;

  /** Project's version name, e.g. 1.0 */
  ...
  /**
   * If the built-in library AppCompat (contains the Jetpack AppCompat artefacts and Material Design
  ...
  /**
   * If at least 1 TextToSpeech Component ({@link
   * com.besome.sketch.beans.ComponentBean#COMPONENT_TYPE_TEXT_TO_SPEECH}) is used in the project.
   */
  public boolean isTextToSpeechUsed = false;

  /**
   * If at least 1 SpeechToText Component ({@link
   * com.besome.sketch.beans.ComponentBean#COMPONENT_TYPE_SPEECH_TO_TEXT}) is used in the project.
   */
  ...
  /**
   * Map containing permissions of Activities. Activity name = {@link String}, Permissions container
   * = {@link a}.
   */
  ...
  public void setupAdmob(ProjectLibraryBean projectLibraryBean) {
    ...
    if (!(projectLibraryBean == null
        || (testDevices = projectLibraryBean.testDevices) == null
        || testDevices.size() <= 0)) {
  ...
  public static class a {
    ...
    /**
     * @return (Most likely) true if the Activity associated with this {@link a} object will request
     *     any runtime permissions
     */
    public boolean a() {
      return b(PERMISSION_CALL_PHONE)
          || b(PERMISSION_READ_EXTERNAL_STORAGE)
          || b(PERMISSION_WRITE_EXTERNAL_STORAGE)
          || b(PERMISSION_CAMERA)
