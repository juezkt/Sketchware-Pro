...
public class tx extends RelativeLayout implements View.OnClickListener {
  ...
  public final void a() {
    ...
    aBVar.a(a3);
    aBVar.b(
        xB.b().a(getContext(), R.string.common_word_select),
        v -> {
  ...
  public final RadioButton a(String str) {
    ...
    LinearLayout.LayoutParams layoutParams =
        new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.WRAP_CONTENT, (int) (wB.a(getContext(), 1.0f) * 60.0f));
  ...
  public final LinearLayout a(String str, boolean z) {
    ...
    linearLayout.setLayoutParams(
        new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (60.0f * a2)));
