...
public class Pw extends RelativeLayout implements View.OnClickListener {
  ...
  private RadioButton a(String fileName) {
    ...
    LinearLayout.LayoutParams layoutParams =
        new LinearLayout.LayoutParams(-1, (int) (wB.a(getContext(), 1.0F) * 40.0F));
  ...
  private void a() {
    ...
    dialog.a(f);
    PropertyPopupSelectorSingleBinding propertyBinding =
        PropertyPopupSelectorSingleBinding.inflate(((Activity) getContext()).getLayoutInflater());
