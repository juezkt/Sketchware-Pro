...
public abstract class DA extends qA {
  ...
  public boolean c() {
    return ContextCompat.checkSelfPermission(
                requireContext(), "android.permission.WRITE_EXTERNAL_STORAGE")
            == PackageManager.PERMISSION_GRANTED
        && ContextCompat.checkSelfPermission(
                requireContext(), "android.permission.READ_EXTERNAL_STORAGE")
            == PackageManager.PERMISSION_GRANTED;
  }
  ...
  public void d(int var1) {
    if (!Sp.a) {
      ...
      dialog.b(
          xB.b().a(getContext(), R.string.common_word_ok),
          view -> {
            if (!mB.a()) {
              requestPermissions(
                  new String[] {
  ...
  public void e(int var1) {
    if (!Sp.a) {
      ...
      dialog.b(
          xB.b().a(getContext(), R.string.common_word_settings),
          view -> {
            if (!mB.a()) {
              c(var1);
              dialog.dismiss();
