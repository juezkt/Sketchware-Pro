  ...
  private class Adapter extends SoundPlayingAdapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      ...
      holder.binding.imgDelete.setImageResource(
          bean.isSelected ? R.drawable.ic_checkmark_green_48dp : R.drawable.ic_trashcan_white_48dp);
      ...
      holder.binding.tvEndtime.setText(
          String.format(Locale.US, "%d:%02d", totalDurationInS / 60, totalDurationInS % 60));
      ...
      if (projectResourceBean.isNew) {
        ...
        sounds.set(
            ...
            new ProjectResourceBean(
                ...
                projectResourceBean.resName,
                projectResourceBean.resName + substring));
      }
    }
    jC.d(sc_id).c(sounds);
    jC.d(sc_id).y();
