...
public class wq {
  ...
  public static final String A =
      "sketchware" + File.separator + "localization" + File.separator + "strings_provided.xml";
  ...
  public static final String D =
      "sketchware" + File.separator + "keystore" + File.separator + "release_key.jks";
  ...
  public static final String[] M = {
    "F83085529A75E7A8CEDD64013B1A374B",
    "90C443DFAB7F23424DE7E079787466CD",
    "F83085529A75E7A8CEDD64013B1A374B",
    "C99E5B3F179203AE2749F8F9B5A7493A",
    "100EFD7391FF1BEE4A1E2F960A1B8AF2"
  };
  public static final String[] N = {
    "1486507718310013_1788685811425534",
    "1486507718310013_1804931006467681",
    "1486507718310013_1805009746459807",
    "1486507718310013_1805001526460629",
    "1486507718310013_1805273579766757",
    "1486507718310013_1805397669754348",
    "1486507718310013_1805436593083789",
    "1486507718310013_1805666736394108",
    "1486507718310013_1805724186388363",
    "1486507718310013_1809233042704144"
  };
  public static final String[] O = {
    "255022168522663_266931247331755",
    "255022168522663_268282677196612",
    "255022168522663_268283823863164",
    "255022168522663_266575314034015",
    "255022168522663_279474749410738"
  };
  ...
  public static final String f =
      ".sketchware" + File.separator + "temp" + File.separator + "images";
  public static final String g =
      ".sketchware" + File.separator + "temp" + File.separator + "sounds";
  ...
  public static final String m =
      ".sketchware" + File.separator + "resources" + File.separator + "icons";
  public static final String n =
      ".sketchware" + File.separator + "resources" + File.separator + "images";
  public static final String o =
      ".sketchware" + File.separator + "resources" + File.separator + "sounds";
  public static final String p =
      ".sketchware" + File.separator + "resources" + File.separator + "fonts";
  public static final String r =
      ".sketchware" + File.separator + "download" + File.separator + "apk";
  public static final String s =
      ".sketchware" + File.separator + "download" + File.separator + "data";
  public static final String t =
      ".sketchware" + File.separator + "tutorial" + File.separator + "images";
  public static final String u =
      ".sketchware" + File.separator + "tutorial" + File.separator + "sounds";
  public static final String v =
      ".sketchware" + File.separator + "tutorial" + File.separator + "fonts";
  public static final String w =
      ".sketchware" + File.separator + "tutorial" + File.separator + "proj";
  ...
  public static final String z =
      "sketchware" + File.separator + "localization" + File.separator + "strings.xml";

  public static final String EXTRA_SYSTEM_DATA =
      ".sketchware" + File.separator + "data" + File.separator + "system";
  public static final String CUSTOM_COMPONENT_FILE =
      EXTRA_SYSTEM_DATA + File.separator + "component.json";
