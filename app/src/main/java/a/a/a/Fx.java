...
public class Fx {
  ...
  public final String a(String param, int type, String opcode) {
    if (!param.isEmpty() && param.charAt(0) == '@') {
       ...
       * However, upon decompiling this class, it seems to completely ignore this case. This is the
       * solution for now to prevent errors during code generation.
       */
      try {
        if (param.isEmpty()) {
          return "0";
    ...
    switch (bean.opCode) {
      case "definedFunc":
        ...
        if (bean.parameters.isEmpty()) {
          ...
          moreBlock =
              "_"
                  + (space < 0 ? bean.spec : bean.spec.substring(0, space))
                  + "()"
                  + ReturnMoreblockManager.getMbEnd(bean.type);
        } else {
      ...
      case "mapGetAllKeys":
        opcode =
            String.format(
                "SketchwareUtil.getAllKeysFromMap(%s, %s);", params.get(0), params.get(1));
        break;
      case "addListInt":
      ...
      case "insertListInt":
        opcode =
            String.format(
                "%s.add((int)(%s), Double.valueOf(%s));",
                params.get(2), params.get(1), params.get(0));
        break;
      case "getAtListInt":
      ...
      case "insertListStr":
        opcode =
            String.format("%s.add((int)(%s), %s);", params.get(2), params.get(1), params.get(0));
        break;
      case "getAtListStr":
      ...
      case "getAtListMap":
        opcode =
            String.format(
                "%s.get((int)%s).get(%s).toString()", params.get(2), params.get(0), params.get(1));
        break;
      case "setListMap":
        opcode =
            String.format(
                "%s.get((int)%s).put(%s, %s);",
                params.get(3), params.get(2), params.get(0), params.get(1));
        break;
      case "containListMap":
        opcode =
            String.format(
                "%s.get((int)%s).containsKey(%s)", params.get(0), params.get(1), params.get(2));
        break;
      ...
      case "getMapInList":
        opcode =
            String.format("%s = %s.get((int)%s);", params.get(2), params.get(1), params.get(0));
        break;
      case "deleteList":
      ...
      case "random":
        opcode =
            String.format(
                "SketchwareUtil.getRandom((int)(%s), (int)(%s))", params.get(0), params.get(1));
        break;
      case "stringLength":
      ...
      case "stringSub":
        opcode =
            String.format(
                "%s.substring((int)(%s), (int)(%s))", params.get(0), params.get(1), params.get(2));
        break;
      case "stringEquals":
      ...
      case "stringReplaceFirst":
        opcode =
            String.format("%s.replaceFirst(%s, %s)", params.get(0), params.get(1), params.get(2));
        break;
      case "stringReplaceAll":
        opcode =
            String.format("%s.replaceAll(%s, %s)", params.get(0), params.get(1), params.get(2));
        break;
      case "toNumber":
      ...
      case "strToMap":
        opcode =
            String.format(
                "%s = new Gson().fromJson(%s, new TypeToken<HashMap<String,"
                    + " Object>>(){}.getType());",
      ...
      case "strToListMap":
        opcode =
            String.format(
                "%s = new Gson().fromJson(%s, new TypeToken<ArrayList<HashMap<String,"
                    + " Object>>>(){}.getType());",
                params.get(1), params.get(0));
      ...
      case "mathGetDip":
        opcode =
            String.format(
                "SketchwareUtil.getDip(getApplicationContext(), (int)(%s))", params.get(0));
        break;
      ...
      case "setTypeface":
        ...
        if ("default_font".equals(fontName)) {
          ...
          opcode =
              String.format(
                  "%s.setTypeface(Typeface.createFromAsset(getAssets(),\"fonts/%s.ttf\"), %s);",
                  params.get(0), fontName, opcode);
        }
        break;
      case "getText":
      ...
      case "setBgResource":
        opcode =
            params.get(1).equals("NONE")
                ? "0"
                : "R.drawable." + params.get(1).replaceAll("\\.9", "");
      ...
      case "setImage":
        ...
        opcode =
            String.format("%s.setImageResource(R.drawable.%s);", params.get(0), name.toLowerCase());
        break;
      case "setColorFilter":
        opcode =
            String.format(
                "%s.setColorFilter(%s, PorterDuff.Mode.MULTIPLY);", params.get(0), params.get(1));
        break;
      case "requestFocus":
      ...
      case "doToast":
        opcode =
            String.format(
                "SketchwareUtil.showMessage(getApplicationContext(), %s);", params.get(0));
        break;
      case "copyToClipboard":
        opcode =
            String.format(
                "((ClipboardManager)"
                    + " getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText(\"clipboard\","
                    + " %s));",
                params.get(0));
        break;
      case "setTitle":
      ...
      case "intentSetAction":
        opcode =
            String.format(
                "%s.setAction(%s);",
                params.get(0), (params.get(1).equals("\"\"") ? "" : "Intent." + params.get(1)));
        break;
      case "intentSetData":
      ...
      case "intentSetScreen":
        opcode =
            String.format(
                "%s.setClass(getApplicationContext(), %s.class);", params.get(0), params.get(1));
        break;
      case "intentPutExtra":
      ...
      case "intentSetFlags":
        opcode =
            String.format(
                "%s.setFlags(%s);", params.get(0), "Intent.FLAG_ACTIVITY_" + params.get(1));
        break;
      ...
      case "fileSetFileName":
        opcode =
            String.format(
                "%s = getApplicationContext().getSharedPreferences(%s, Activity.MODE_PRIVATE);",
      ...
      case "calendarAdd":
        opcode =
            String.format(
                "%s.add(Calendar.%s, (int)(%s));", params.get(0), params.get(1), params.get(2));
        break;
      case "calendarSet":
        opcode =
            String.format(
                "%s.set(Calendar.%s, (int)(%s));", params.get(0), params.get(1), params.get(2));
        break;
      case "calendarFormat":
        opcode =
            String.format(
                "new SimpleDateFormat(%s).format(%s.getTime())",
                (!params.get(1).equals("\"\"")) ? params.get(1) : "\"yyyy/MM/dd hh:mm:ss\"",
                params.get(0));
        break;
      case "calendarDiff":
        opcode =
            String.format(
                "(long)(%s.getTimeInMillis() - %s.getTimeInMillis())",
                params.get(0), params.get(1));
        break;
      ...
      case "gridSetCustomViewData":
        ...
        opcode =
            String.format("%s.setAdapter(new %s(%s));", param, Lx.a(paramAdapter), params.get(1));
        break;
      case "listRefresh":
        opcode =
            String.format("((BaseAdapter)%s.getAdapter()).notifyDataSetChanged();", params.get(0));
        break;
      case "listSetItemChecked":
        opcode =
            String.format(
                "%s.setItemChecked((int)(%s), %s);", params.get(0), params.get(1), params.get(2));
        break;
      ...
      case "listGetCheckedPositions":
        opcode =
            String.format(
                "%s = SketchwareUtil.getCheckedItemPositionsToArray(%s);",
                params.get(1), params.get(0));
        break;
      ...
      case "listSmoothScrollTo":
        opcode =
            String.format("%s.smoothScrollToPosition((int)(%s));", params.get(0), params.get(1));
        break;
      case "spnSetData":
        opcode =
            String.format(
      ...
      case "spnRefresh":
        opcode =
            String.format("((ArrayAdapter)%s.getAdapter()).notifyDataSetChanged();", params.get(0));
        break;
      ...
      case "webViewSetCacheMode":
        opcode =
            String.format(
                "%s.getSettings().setCacheMode(WebSettings.%s);", params.get(0), params.get(1));
        break;
      ...
      case "adViewLoadAd":
        opcode =
            String.format(
                "%s.loadAd(new AdRequest.Builder()%s.build());",
                params.get(0),
                buildConfig.t.stream()
                    .map(device -> ".addTestDevice(\"" + device + "\")\n")
                    .collect(Collectors.joining()));
        break;
      case "mapViewSetMapType":
        opcode =
            String.format("_%s_controller.setMapType(GoogleMap.%s);", params.get(0), params.get(1));
        break;
      case "mapViewMoveCamera":
        opcode =
            String.format(
                "_%s_controller.moveCamera(%s, %s);", params.get(0), params.get(1), params.get(2));
        break;
      case "mapViewZoomTo":
      ...
      case "mapViewAddMarker":
        opcode =
            String.format(
                "_%s_controller.addMarker(%s, %s, %s);",
                params.get(0), params.get(1), params.get(2), params.get(3));
        break;
      case "mapViewSetMarkerInfo":
        opcode =
            String.format(
                "_%s_controller.setMarkerInfo(%s, %s, %s);",
                params.get(0), params.get(1), params.get(2), params.get(3));
        break;
      case "mapViewSetMarkerPosition":
        opcode =
            String.format(
                "_%s_controller.setMarkerPosition(%s, %s, %s);",
                params.get(0), params.get(1), params.get(2), params.get(3));
        break;
      case "mapViewSetMarkerColor":
        opcode =
            String.format(
                "_%s_controller.setMarkerColor(%s, BitmapDescriptorFactory.%s, %s);",
                params.get(0), params.get(1), params.get(2), params.get(3));
        break;
      case "mapViewSetMarkerIcon":
        ...
        opcode =
            String.format(
                "_%s_controller.setMarkerIcon(%s, R.drawable.%s);",
                params.get(0), params.get(1), name.toLowerCase());
        break;
      case "mapViewSetMarkerVisible":
        opcode =
            String.format(
                "_%s_controller.setMarkerVisible(%s, %s);",
                params.get(2), params.get(1), params.get(2));
        break;
      case "vibratorAction":
      ...
      case "firebaseAdd":
        opcode =
            String.format(
                "%s.child(%s).updateChildren(%s);", params.get(0), params.get(1), params.get(2));
        break;
      case "firebasePush":
...
public void onCancelled(DatabaseError _databaseError) {
                ...
                params.get(1),
                params.get(1),
                (bean.subStack1 >= 0) ? a(String.valueOf(bean.subStack1), "") : "");
        break;
      case "firebaseauthCreateUser":
        if (!params.get(1).equals("\"\"") && !params.get(2).equals("\"\"")) {
          opcode =
              String.format(
                  "%s.createUserWithEmailAndPassword(%s, %s).addOnCompleteListener(%s.this, %s);",
                  params.get(0),
                  params.get(1),
                  params.get(2),
                  activityName,
                  "_" + params.get(0) + "_create_user_listener");
        }
        break;
      case "firebaseauthSignInUser":
        if (!params.get(1).equals("\"\"") && !params.get(2).equals("\"\"")) {
          opcode =
              String.format(
                  "%s.signInWithEmailAndPassword(%s, %s).addOnCompleteListener(%s.this, %s);",
                  params.get(0),
                  params.get(1),
                  params.get(2),
                  activityName,
                  "_" + params.get(0) + "_sign_in_listener");
        }
        break;
      case "firebaseauthSignInAnonymously":
        opcode =
            String.format(
                "%s.signInAnonymously().addOnCompleteListener(%s.this, %s);",
                params.get(0), activityName, "_" + params.get(0) + "_sign_in_listener");
        break;
      ...
      case "firebaseauthResetPassword":
        if (!params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "%s.sendPasswordResetEmail(%s).addOnCompleteListener(%s);",
                  params.get(0), params.get(1), "_" + params.get(0) + "_reset_password_listener");
        }
        break;
      ...
      case "firebaseStartListen":
        opcode =
            String.format(
                "%s.addChildEventListener(_%s_child_listener);", params.get(0), params.get(0));
        break;
      case "firebaseStopListen":
        opcode =
            String.format(
                "%s.removeEventListener(_%s_child_listener);", params.get(0), params.get(0));
        break;
      case "gyroscopeStartListen":
        opcode =
            String.format(
                "%s.registerListener(_%s_sensor_listener,"
      ...
      case "gyroscopeStopListen":
        opcode =
            String.format(
                "%s.unregisterListener(_%s_sensor_listener);", params.get(0), params.get(0));
        break;
      case "dialogSetTitle":
      ...
      case "dialogOkButton":
        ...
        opcode =
            String.format(
                "%s.setPositiveButton(%s, new DialogInterface.OnClickListener() {\n"
                    + "@Override\n"
      ...
      case "dialogCancelButton":
        ...
        opcode =
            String.format(
                "%s.setNegativeButton(%s, new DialogInterface.OnClickListener() {\n"
                    + "@Override\n"
                    + "public void onClick(DialogInterface _dialog, int _which) {\n"
                    + "%s\n"
                    + "}\n"
      ...
      case "dialogNeutralButton":
        ...
        opcode =
            String.format(
                "%s.setNeutralButton(%s, new DialogInterface.OnClickListener() {\n"
                    + "@Override\n"
                    + "public void onClick(DialogInterface _dialog, int _which) {\n"
                    + "%s\n"
                    + "}\n"
      ...
      case "mediaplayerCreate":
        opcode =
            String.format(
                "%s = MediaPlayer.create(getApplicationContext(), R.raw.%s);",
                params.get(0), params.get(1).toLowerCase());
        break;
      ...
      case "soundpoolCreate":
        opcode =
            String.format(
                "%s = new SoundPool((int)(%s), AudioManager.STREAM_MUSIC, 0);",
                params.get(0), params.get(1));
        break;
      case "soundpoolLoad":
        opcode =
            String.format(
                "%s.load(getApplicationContext(), R.raw.%s, 1);", params.get(0), params.get(1));
        break;
      case "soundpoolStreamPlay":
        opcode =
            String.format(
                "%s.play((int)(%s), 1.0f, 1.0f, 1, (int)(%s), 1.0f);",
                params.get(0), params.get(1), params.get(2));
      ...
      case "setThumbResource":
        ...
        opcode =
            String.format("%s.setThumbResource(R.drawable.%s)", params.get(0), name.toLowerCase());
        break;
      case "setTrackResource":
        name = params.get(1).replaceAll("\\.9", "");
        opcode =
            String.format("%s.setTrackResource(R.drawable.%s)", params.get(0), name.toLowerCase());
      ...
      case "objectanimatorSetFromTo":
        opcode =
            String.format(
                "%s.setFloatValues((float)(%s), (float)(%s));",
                params.get(0), params.get(1), params.get(2));
        break;
      ...
      case "firebasestorageUploadFile":
        if (!params.get(1).equals("\"\"") && !params.get(2).equals("\"\"")) {
          opcode =
              String.format(
                  "%s.child(%s).putFile(Uri.fromFile(new"
                      + " File(%s))).addOnFailureListener(_%s_failure_listener).addOnProgressListener(_%s_upload_progress_listener).continueWithTask(new"
      ...
      case "firebasestorageDownloadFile":
        if (!params.get(1).equals("\"\"") && !params.get(2).equals("\"\"")) {
          opcode =
              String.format(
                  "_firebase_storage.getReferenceFromUrl(%s).getFile(new"
                      + " File(%s)).addOnSuccessListener(_%s_download_success_listener).addOnFailureListener(_%s_failure_listener).addOnProgressListener(_%s_download_progress_listener);",
                  params.get(1), params.get(2), params.get(0), params.get(0), params.get(0));
        }
        break;
      case "firebasestorageDelete":
        if (!params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "_firebase_storage.getReferenceFromUrl(%s).delete().addOnSuccessListener(_%s_delete_success_listener).addOnFailureListener(_%s_failure_listener);",
                  params.get(1), params.get(0), params.get(0));
        }
        break;
      case "fileutilread":
      ...
      case "resizeBitmapFileRetainRatio":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.resizeBitmapFileRetainRatio(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "resizeBitmapFileToSquare":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.resizeBitmapFileToSquare(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "resizeBitmapFileToCircle":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.resizeBitmapFileToCircle(%s, %s);", params.get(0), params.get(1));
        }
        break;
      case "resizeBitmapFileWithRoundedBorder":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.resizeBitmapFileWithRoundedBorder(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "cropBitmapFileFromCenter":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.cropBitmapFileFromCenter(%s, %s, %s, %s);",
                  params.get(0), params.get(1), params.get(3), params.get(2));
        }
        break;
      case "rotateBitmapFile":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.rotateBitmapFile(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "scaleBitmapFile":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.scaleBitmapFile(%s, %s, %s, %s);",
                  params.get(0), params.get(1), params.get(2), params.get(3));
        }
        break;
      case "skewBitmapFile":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.skewBitmapFile(%s, %s, %s, %s);",
                  params.get(0), params.get(1), params.get(2), params.get(3));
        }
        break;
      case "setBitmapFileColorFilter":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.setBitmapFileColorFilter(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "setBitmapFileBrightness":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.setBitmapFileBrightness(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "setBitmapFileContrast":
        if (!params.get(0).equals("\"\"") && !params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "FileUtil.setBitmapFileContrast(%s, %s, %s);",
                  params.get(0), params.get(1), params.get(2));
        }
        break;
      case "getJpegRotate":
      ...
      case "filepickerstartpickfiles":
        opcode =
            String.format(
                "startActivityForResult(%s, REQ_CD_%s);",
      ...
      case "setImageFilePath":
        if (!params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "%s.setImageBitmap(FileUtil.decodeSampleBitmapFromPath(%s, 1024, 1024));",
                  params.get(0), params.get(1));
        }
        break;
      case "setImageUrl":
        if (!params.get(1).equals("\"\"")) {
          opcode =
              String.format(
                  "Glide.with(getApplicationContext()).load(Uri.parse(%s)).into(%s);",
                  params.get(1), params.get(0));
        }
        break;
      case "setHint":
      ...
      case "requestnetworkSetParams":
        opcode =
            String.format(
                "%s.setParams(%s, RequestNetworkController.%s);",
                params.get(0), params.get(1), params.get(2));
        break;
      ...
      case "requestnetworkStartRequestNetwork":
        opcode =
            String.format(
                "%s.startRequestNetwork(RequestNetworkController.%s, %s, %s,"
                    + " _%s_request_listener);",
                params.get(0), params.get(1), params.get(2), params.get(3), params.get(0));
        break;
      ...
      case "textToSpeechSpeak":
        opcode =
            String.format(
                "%s.speak(%s, TextToSpeech.QUEUE_ADD, null);", params.get(0), params.get(1));
        break;
        ...
        opcode =
            String.format(
                "Intent _intent = new Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH);\n"
                    + "_intent.putExtra(RecognizerIntent.EXTRA_CALLING_PACKAGE,"
                    + " getPackageName());\n"
                    + "_intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL,"
                    + " RecognizerIntent.LANGUAGE_MODEL_FREE_FORM);\n"
                    + "_intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault());\n"
                    + "%s.startListening(_intent);",
                params.get(0));
      ...
      case "bluetoothConnectReadyConnection":
        opcode =
            String.format(
                "%s.readyConnection(_%s_bluetooth_connection_listener, %s);",
                params.get(0), params.get(0), params.get(1));
        break;
      case "bluetoothConnectReadyConnectionToUuid":
        opcode =
            String.format(
                "%s.readyConnection(_%s_bluetooth_connection_listener, %s, %s);",
                params.get(0), params.get(0), params.get(1), params.get(2));
        break;
      case "bluetoothConnectStartConnection":
        opcode =
            String.format(
                "%s.startConnection(_%s_bluetooth_connection_listener, %s, %s);",
                params.get(0), params.get(0), params.get(1), params.get(2));
        break;
      case "bluetoothConnectStartConnectionToUuid":
        opcode =
            String.format(
                "%s.startConnection(_%s_bluetooth_connection_listener, %s, %s, %s);",
                params.get(0), params.get(0), params.get(1), params.get(2), params.get(3));
        break;
      case "bluetoothConnectStopConnection":
        opcode =
            String.format(
                "%s.stopConnection(_%s_bluetooth_connection_listener, %s);",
                params.get(0), params.get(0), params.get(1));
        break;
      case "bluetoothConnectSendData":
        opcode =
            String.format(
                "%s.sendData(_%s_bluetooth_connection_listener, %s, %s);",
                params.get(0), params.get(0), params.get(1), params.get(2));
        break;
      ...
      case "locationManagerRequestLocationUpdates":
        ...
        if (buildConfig.g) {
          opcode =
              String.format(
                  "if (ContextCompat.checkSelfPermission(%s.this,"
          ...
          opcode =
              String.format(
                  "if (Build.VERSION.SDK_INT >= 23) {if"
