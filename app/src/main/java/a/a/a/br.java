...
public class br extends qA implements View.OnClickListener {
  ...
  private final ActivityResultLauncher<Intent> addComponent =
  ...
  private void initialize() {
    ...
    binding.emptyMessage.setText(
        xB.b().a(requireContext(), R.string.component_message_no_components));
    binding.componentList.setLayoutManager(
  ...
  private void openEvent(String targetId, String eventName, String eventText) {
    Intent intent =
        new Intent(requireActivity().getApplicationContext(), LogicEditorActivity.class);
  ...
  private class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    private static final ConcatAdapter.Config EVENTS_ADAPTER_CONFIG =
        new ConcatAdapter.Config.Builder().setIsolateViewTypes(false).build();
    private final RecyclerView.RecycledViewPool eventViewHolders =
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      return new ViewHolder(
          FrLogicListItemComponentBinding.inflate(
    ...
    private class ViewHolder extends CollapsibleViewHolder {
      ...
      void bind(ComponentBean componentBean) {
        binding
            ...
            .getLabel()
            .setText(
                xB.b().a(requireContext(), R.string.component_context_menu_title_delete_component));
        ...
        if (binding.componentEvents.getLayoutManager() instanceof LinearLayoutManager manager) {
        ...
        availableEventsAdapter.setOnEventClickListener(
            event -> {
        ...
        ConcatAdapter componentEventsAdapter =
            new ConcatAdapter(EVENTS_ADAPTER_CONFIG, addedEventsAdapter, availableEventsAdapter);
        ...
        switch (componentBean.type) {
          case ComponentBean.COMPONENT_TYPE_SHAREDPREF ->
              binding.tvComponentId.setText(
                  componentBean.componentId + " : " + componentBean.param1);
        ...
        if (!addedEvents.isEmpty() || !availableEvents.isEmpty()) {
          for (EventBean event : addedEvents) {
            if (availableEvents.contains(event.eventName)) {
              ...
              previewBinding.iconBg.setBackgroundResource(R.drawable.circle_bg_surface);
          ...
          if (!componentBean.isCollapsed) {
            binding.eventsPreview.setTranslationX(binding.eventsPreview.getWidth());
      ...
      public void collapse() {
        ...
        binding
            .componentEvents
            .animate()
            .translationX(-binding.componentEvents.getWidth())
            .setDuration(150L)
            .alpha(0.0f)
            .start();
      }
      ...
      public void expand() {
        ...
        binding
            .eventsPreview
            .animate()
            .translationX(binding.eventsPreview.getWidth())
            .alpha(0.0f)
            .setDuration(150L)
            .start();
      ...
      private class AddedEventsAdapter extends ListAdapter<EventBean, EventViewHolder> {
        private static final DiffUtil.ItemCallback<EventBean> DIFF_CALLBACK =
            new DiffUtil.ItemCallback<>() {
              @Override
              public boolean areItemsTheSame(
                  @NonNull EventBean oldItem, @NonNull EventBean newItem) {
          ...
          holder.button.setClickListener(
              v -> {
                if (!mB.a()) {
                  ...
                  bB.a(
                          requireContext(),
                          xB.b().a(requireContext(), R.string.event_message_new_event),
                          0)
                      .show();
                  holder.button.onEventAdded();
                  if (listener != null) {
