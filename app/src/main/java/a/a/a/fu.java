...
public class fu extends qA implements View.OnClickListener {
  ...
  private final ActivityResultLauncher<Intent> openImageImportDetails =
          ...
          result -> {
            ...
            if (result.getResultCode() == Activity.RESULT_OK && data != null) {
              ...
              if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                importedImages =
                    data.getParcelableArrayListExtra("results", ProjectResourceBean.class);
              } else {
  ...
  public void importImages() {
    ...
    if (!selectedCollections.isEmpty()) {
      ...
      intent.putParcelableArrayListExtra(
          "project_images", ((ManageImageActivity) requireActivity()).m().d());
  ...
  private void onItemSelected() {
    ...
    if (count > 0) {
      btnImport.setText(
          xB.b().a(requireContext(), R.string.common_word_import_count, count).toUpperCase());
