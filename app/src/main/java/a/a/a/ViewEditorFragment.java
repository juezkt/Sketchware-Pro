...
public class ViewEditorFragment extends qA {
  ...
  private void initialize(ViewGroup viewGroup) {
    ...
    viewProperty.setOnPropertyListener(
        new Iw() {
          @Override
          public void a() {
    ...
    viewProperty.setOnPropertyValueChangedListener(
        viewBean -> {
          a(viewBean.id);
          viewProperty.e();
          invalidateOptionsMenu();
        });
    viewProperty.setOnEventClickListener(
        eventBean ->
    ...
    viewEditor.setOnWidgetSelectedListener(
        new cy() {
          @Override
          public void a() {
            n();
    ...
    viewEditor.setOnDraggingListener(
    ...
    if (o == null) {
      o =
          ObjectAnimator.ofFloat(
              viewProperty,
              View.TRANSLATION_Y,
              wB.a(requireActivity(), (float) viewProperty.getHeight()));
      o.setDuration(300L);
  ...
  public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
    ViewGroup viewGroup =
        (ViewGroup) layoutInflater.inflate(R.layout.fr_graphic_editor, parent, false);
