...
public class EventsHandler {
  ...
  public static final String CUSTOM_EVENTS_FILE_PATH =
      FileUtil.getExternalStorageDir() + "/.sketchware/data/system/events.json";
  public static final String CUSTOM_LISTENERE_FILE_PATH =
      FileUtil.getExternalStorageDir() + "/.sketchware/data/system/listeners.json";
   ...
   * @apiNote Custom Activity Events can be added by writing to the file /Internal
   *     storage/.sketchware/data/system/events.json and specifying an empty string for "var"
   */
  ...
  public static void addEvents(Gx gx, ArrayList<String> list) {
    ...
    for (int i = 0, cachedCustomEventsSize = cachedCustomEvents.size();
        i < cachedCustomEventsSize;
        i++) {
      HashMap<String, Object> customEvent = cachedCustomEvents.get(i);
      if (customEvent != null) {
        Object var = customEvent.get("var");
          ...
          if (gx.a((String) var)) {
            ...
            if (listener instanceof String) {
              ...
              SketchwareUtil.toastError(
                  "Found invalid listener data type in Custom Event #" + (i + 1));
            }
          }
        } else {
          SketchwareUtil.toastError("Found invalid var data type in Custom Event #" + (i + 1));
            ...
            if (listener instanceof String) {
              if (name.equals(listener)) {
                ...
                if (eventName instanceof String) {
                  ...
                  SketchwareUtil.toastError(
                      "Found invalid name data type in Custom Event #" + (i + 1));
                }
              }
            } else {
              SketchwareUtil.toastError(
            ...
            if (eventName instanceof String) {
              if (name.equals(eventName)) {
                ...
                if (icon instanceof String) {
                  try {
                    yield OldResourceIdMapper.getDrawableFromOldResourceId(
                        Integer.parseInt((String) icon));
                  } catch (NumberFormatException e) {
                    SketchwareUtil.toastError(
                        "Found invalid icon data type in Custom Event #" + (i + 1));
  ...
  public static String getDesc(String name) {
    return switch (name) {
      ...
      case "onPreExecute" ->
          "This method contains the code which is executed before the background processing"
              + " starts.";
      case "doInBackground" ->
            ...
            if (eventName instanceof String) {
              if (name.equals(eventName)) {
                ...
                if (description instanceof String) {
                  ...
                  SketchwareUtil.toastError(
                      "Found invalid description data type in Custom Event #" + (i + 1));
                }
              }
            } else {
              SketchwareUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
            ...
            if (eventName instanceof String) {
              if (name.equals(eventName)) {
                ...
                if (code instanceof String) {
                  ...
                  SketchwareUtil.toastError(
                      "Found invalid code data type in Custom Event #" + (i + 1));
                }
              }
            } else {
              SketchwareUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
  ...
  public static String getBlocks(String name) {
    return switch (name) {
      case "Import", "initializeLogic", "onSwipeRefreshLayout", " onLongClick", "onPreExecute" ->
          "";
            ...
            if (eventName instanceof String) {
              if (name.equals(eventName)) {
                ...
                if (parameters instanceof String) {
                  ...
                  SketchwareUtil.toastError(
                      "Found invalid parameters data type in Custom Event #" + (i + 1));
                }
              }
            } else {
              SketchwareUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
  ...
  public static String getSpec(String name, String event) {
    return switch (event) {
      ...
      case "onActivityResult" -> "OnActivityResult %d.requestCode %d.resultCode %m.intent.data";
      case "initializeLogic" -> "initializeLogic";
            ...
            if (eventName instanceof String) {
              if (event.equals(eventName)) {
                ...
                if (headerSpec instanceof String) {
                  ...
                  SketchwareUtil.toastError(
                      "Found invalid header spec data type in Custom Event #" + (i + 1));
                }
              }
            } else {
              SketchwareUtil.toastError("Found invalid name data type in Custom Event #" + (i + 1));
    ...
    return switch (name) {
      ...
      case "AsyncTaskClass" ->
          "private class "
              ...
              + "}";
      default -> {
        for (int i = 0, cachedCustomListenersSize = cachedCustomListeners.size();
            i < cachedCustomListenersSize;
            i++) {
