...
/**
 * Sample usage of CommandBlock: /*-JX4UA2y_f1OckjjvxWI.bQwRei-sLEsBmds7ArsRfi0xSFEP3Php97kjdMCs5ed
 * >void initialize(Bundle _savedInstanceState >2 >12 >0 >replace setSupportActionBar(_toolbar);
...
public class CommandBlock {
  ...
  private static void getCBs(
      ArrayList<HashMap<String, Object>> arr, String c, String sid, String eid) {
    ArrayList<String> a = new ArrayList<>(Arrays.asList(c.split("\n")));
    boolean b = false;
    int n = -1;
    for (int i = 0; i < a.size(); i++) {
  ...
  private static void aC(
      ArrayList<String> arr, ArrayList<HashMap<String, Object>> arr2, Pair<Integer, Integer> p) {
    String ref;
    int dis;
    int af;
    int be;
