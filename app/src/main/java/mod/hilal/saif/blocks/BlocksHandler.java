...
public class BlocksHandler {
  ...
  public static void builtInBlocks(ArrayList<HashMap<String, Object>> arrayList) {
    ...
    hashMap.put(
        "spec",
        "Java Command Block: reference %s distance %d frontend %d backend %d command %m.Command");
    ...
    hashMap.put(
        "spec",
        "XML Command Block: reference %s distance %d frontend %d backend %d command %m.Command xml"
            + " name %s.inputOnly");
    arrayList.add(hashMap);
    ...
    hashMap.put(
        "code",
        "RecyclerView.LayoutParams _lp = new RecyclerView.LayoutParams(ViewGroup.LayoutParams.%s,"
    ...
    hashMap.put(
        "spec",
        "CustomToast %s textColor %m.color textSize %d bgColor %m.color cornerRadius %d gravity"
            + " %m.gravity_t");
    arrayList.add(hashMap);
    ...
    hashMap.put(
        "spec",
        "CustomToastWithIcon %s textColor %m.color textSize %d bgColor %m.color cornerRadius %d"
            + " gravity %m.gravity_t Icon %m.resource");
    arrayList.add(hashMap);
    ...
    hashMap.put("palette", "-1");
    hashMap.put(
        "spec", "%m.menuitem add id %d title %s icon %m.resource showAsAction %m.menuaction");
    arrayList.add(hashMap);
    ...
    hashMap.put(
        "code",
        "%s.setImageResource(getResources().getIdentifier(%s, \"drawable\", getPackageName()));");
    hashMap.put("color", "#4A6CD4");
    hashMap.put("palette", "-1");
    ...
    hashMap.put(
        "code",
        "%s.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) {"
            + " this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)%s, %s));");
    hashMap.put("color", "#4A6CD4");
    hashMap.put("palette", "-1");
    ...
    hashMap.put(
        "code",
        "%s.setBackground(new GradientDrawable(GradientDrawable.Orientation.BR_TL, new int[]"
            + " {%s,%s}));");
    hashMap.put("color", "#4A6CD4");
    hashMap.put("palette", "-1");
    ...
    hashMap.put(
        "code",
        "%s.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int"
            + " c) { this.setStroke(a, b); this.setColor(c); return this; } }.getIns((int)%s, %s,"
            + " %s));");
    hashMap.put("color", "#4A6CD4");
    hashMap.put("palette", "-1");
    ...
    hashMap.put(
        "code",
        "%s.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int"
            + " c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return"
            + " this; } }.getIns((int)%s, (int)%s, %s, %s));");
    hashMap.put("color", "#4A6CD4");
    hashMap.put("palette", "-1");
    hashMap.put(
        "spec", "%m.view setCornerRadius %d stroke %d strokeColor %m.color bgColor %m.color");
    arrayList.add(hashMap);
    ...
    hashMap.put(
        ...
        "com.google.android.material.snackbar.Snackbar.make(%s, %s,"
            + " com.google.android.material.snackbar.Snackbar.LENGTH_SHORT).setAction(%s, new"
    ...
    hashMap.put(
        "code",
        "%2$s = new Gson().fromJson(%1$s, new TypeToken<ArrayList<String>>(){}.getType());");
    hashMap.put("color", "#5cb722");
    hashMap.put("palette", "-1");
    ...
    hashMap.put(
        "code",
        "%2$s = new Gson().fromJson(%1$s, new TypeToken<ArrayList<Double>>(){}.getType());");
    hashMap.put("color", "#5cb722");
    hashMap.put("palette", "-1");
    ...
    hashMap.put(
        ...
        "if (%1$s != null) {\r\n"
            + "%1$s.show(%2$s.this);\r\n"
            + "} else {\r\n"
            + "SketchwareUtil.showMessage(getApplicationContext(), \"Error: InterstitialAd %1$s"
    ...
    hashMap.put(
        "spec",
        "%m.interstitialad register fullscreen content callbacks (This Block isn't needed anymore,"
            + " please remove it)");
    arrayList.add(hashMap);
    ...
    hashMap.put(
        "spec",
        "%m.videoad register fullscreen content callbacks (This Block isn't needed anymore, please"
            + " remove it)");
    arrayList.add(hashMap);
