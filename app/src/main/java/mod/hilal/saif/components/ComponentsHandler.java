...
public class ComponentsHandler {
    ...
    for (int i = 0; i < cachedCustomComponents.size(); i++) {
      ...
      if (component != null) {
        ...
        if (typeName instanceof String) {
            ...
            if (id instanceof String) {
              try {
                ...
                SketchwareUtil.toastError(
                    "Invalid ID entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                break;
              }
            } else {
              SketchwareUtil.toastError(
          ...
          SketchwareUtil.toastError(
              "Invalid type name entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
        }
      } else {
          ...
          try {
            ...
            if (idInt == id) {
              ...
              if (componentTypeName instanceof String) {
                ...
                SketchwareUtil.toastError(
                    "Invalid type name entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                break;
              }
            }
          } catch (NumberFormatException e) {
            SketchwareUtil.toastError(
                "Invalid ID entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
          }
        } else {
          SketchwareUtil.toastError(
              "Invalid ID entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
          ...
          try {
            ...
            if (idInt == id) {
              ...
              if (componentName instanceof String) {
                ...
                SketchwareUtil.toastError(
                    "Invalid name entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                break;
              }
            }
          } catch (NumberFormatException e) {
            SketchwareUtil.toastError(
                "Invalid ID entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
          }
        } else {
          SketchwareUtil.toastError(
              "Invalid ID entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
              ...
              if (iconObject instanceof String) {
                try {
                  return OldResourceIdMapper.getDrawableFromOldResourceId(
                      Integer.parseInt((String) iconObject));
                } catch (NumberFormatException e) {
                  SketchwareUtil.toastError(
                      "Invalid icon entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                  break;
                }
              }
            }
          ...
          try {
            ...
            if (idInt == id) {
              ...
              if (componentDescription instanceof String) {
                ...
                SketchwareUtil.toastError(
                    "Invalid description entry for Custom Component #" + (i + 1),
                    Toast.LENGTH_LONG);
                break;
              }
            }
            ...
            try {
              ...
              if (componentIdInteger == id) {
                ...
                if (componentUrl instanceof String) {
                  ...
                  SketchwareUtil.toastError(
                      "Invalid URL entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
                  break;
                }
              }
            } catch (NumberFormatException e) {
          ...
          try {
            ...
            if (componentIdInteger == id) {
              ...
              if (componentBuildClass instanceof String) {
                ...
                SketchwareUtil.toastError(
                    "Invalid build class entry for Custom Component #" + (i + 1),
                    Toast.LENGTH_LONG);
                break;
              }
            }
  ...
  /**
   * Adds Custom Components to available Components section. Used at {@link
   * com.besome.sketch.editor.component.ComponentAddActivity#onPostCreate(Bundle)}.
   */
          ...
          try {
            ...
            if (componentIdInteger == id) {
              ...
              if (componentVarName instanceof String) {
                ...
                SketchwareUtil.toastError(
                    "Invalid variable name entry for Custom Component #" + (i + 1),
                    Toast.LENGTH_LONG);
                break;
              }
            }
  ...
  public static String c(String name) {
    ...
    for (int i = 0, customComponentsSize = cachedCustomComponents.size();
        i < customComponentsSize;
        i++) {
      HashMap<String, Object> component = cachedCustomComponents.get(i);
      if (component != null) {
        Object componentTypeName = component.get("typeName");
        ...
        if (componentTypeName instanceof String) {
          if (name.equals(componentTypeName)) {
            ...
            if (componentClass instanceof String) {
              ...
              SketchwareUtil.toastError(
                  "Invalid class entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
              break;
            }
          }
        } else {
          SketchwareUtil.toastError(
              "Invalid type name entry for Custom Component #" + (i + 1), Toast.LENGTH_LONG);
        }
      } else {
        SketchwareUtil.toastError("Invalid (null) Custom Component at position " + i);
      }
  ...
  /**
   * Used at {@link Lx#a(String, String, Lx.AccessModifier, String...)} to get Custom Components'
   * fields.
   */
  // √√
        ...
        if (componentName instanceof String) {
          if (name.equals(componentName)) {
            ...
            if (componentAdditionalVar instanceof String) {
              ...
              SketchwareUtil.toastError(
                  "Invalid additional variable entry at Custom Component #" + (i + 1),
                  Toast.LENGTH_LONG);
            }
          }
        } else {
          SketchwareUtil.toastError(
              "Invalid name entry at Custom Component #" + (i + 1), Toast.LENGTH_LONG);
        }
      } else {
        SketchwareUtil.toastError("Invalid (null) Custom Component at position " + i);
      }
        ...
        if (componentName instanceof String) {
          if (name.equals(componentName)) {
            ...
            if (componentDefineAdditionalVar instanceof String) {
              ...
              SketchwareUtil.toastError(
                  "Invalid additional variable entry in Custom Component #" + (i + 1),
                  Toast.LENGTH_LONG);
            }
          }
        } else {
        ...
        if (componentVarName instanceof String) {
          if (name.equals(componentVarName)) {
            ...
            if (componentImports instanceof String) {
              ...
              SketchwareUtil.toastError(
                  "Invalid imports entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
              break;
            }
          }
        } else {
          SketchwareUtil.toastError(
              "Invalid variable name entry in Custom Component #" + (i + 1), Toast.LENGTH_LONG);
        }
      } else {
        SketchwareUtil.toastError("Invalid (null) Custom Component at position " + i);
      }
  ...
  /**
   * @return List of Custom Components. Will never return null, but will warn the user about an
   *     invalid Custom Components JSON file.
   */
  ...
  public static Pair<Optional<String>, List<HashMap<String, Object>>> readComponents(
      String filePath) {
    String content = FileUtil.readFile(filePath);
    if (content.isEmpty() || content.equals("[]")) {
      return new Pair<>(
          Optional.of(Helper.getResString(R.string.common_message_selected_file_empty)),
    ...
    if (components == null || components.isEmpty() || !isValidComponentList(components)) {
      return new Pair<>(
          Optional.of(Helper.getResString(R.string.publish_message_dialog_invalid_json)),
          Collections.emptyList());
    }
