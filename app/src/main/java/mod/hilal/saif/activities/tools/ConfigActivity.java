...
public class ConfigActivity extends BaseAppCompatActivity {
  ...
  public static final File SETTINGS_FILE =
      new File(FileUtil.getExternalStorageDir(), ".sketchware/data/settings.json");
  ...
  public static final String SETTING_ROOT_AUTO_OPEN_AFTER_INSTALLING =
      "root-auto-open-after-installing";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // unfortunately, androidx.preference doesn't make it easy to support edge-to-edge layout
    // properly, so this will have to do
    Insetter.builder()
  ...
  public static String getStringSettingValueOrSetAndGet(
      String settingKey, String toReturnAndSetIfNotFound) {
  ...
  public static String getBackupFileName() {
    return DataStore.getInstance()
        .getString(
            SETTING_BACKUP_FILENAME,
            "$projectName v$versionName ($pkgName, $versionCode) $time(yyyy-MM-dd'T'HHmmss)");
  }
  ...
  private static HashMap<String, Object> readSettings() {
    ...
    if (SETTINGS_FILE.exists()) {
      ...
      try {
        settings =
            getGson().fromJson(FileUtil.readFile(SETTINGS_FILE.getAbsolutePath()), Helper.TYPE_MAP);
  ...
  public static class PreferenceFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
      ...
      backupDir.setOnPreferenceClickListener(
          preference -> {
            ...
            dialog.setOnShowListener(
                dialogInterface -> {
                  dialog
                      ...
                      .setOnClickListener(Helper.getDialogDismissListener(dialogInterface));
                  Button positiveButton = dialog.getButton(DialogInterface.BUTTON_POSITIVE);
                  positiveButton.setOnClickListener(
                      view -> {
                        getDataStore()
                            .putString(
                                SETTING_BACKUP_DIRECTORY, binding.inputText.getText().toString());
                        dialog.dismiss();
                      });
      ...
      installWithRoot.setOnPreferenceClickListener(
          preference -> {
      ...
      backupFilename.setOnPreferenceClickListener(
          preference -> {
            DialogCreateNewFileLayoutBinding binding =
                DialogCreateNewFileLayoutBinding.inflate(getLayoutInflater());
            binding.chipGroupTypes.setVisibility(View.GONE);
                ...
                new MaterialAlertDialogBuilder(requireContext())
                    ...
                    .setMessage(
                        "This defines how SWB backup files get named.\n"
                            ...
                            + "\n"
                            + "Additionally, you can format your own time like this using Java's"
                            + " date formatter syntax:\n"
                            + "$time(yyyy-MM-dd'T'HHmmss)\n")
                    .setNegativeButton(R.string.common_word_cancel, null)
                    .setPositiveButton(R.string.common_word_save, null)
                    .setNeutralButton(
                        R.string.common_word_reset,
                ...
                dialogInterface -> {
                  ...
                  positiveButton.setOnClickListener(
                      view -> {
                        getDataStore()
                            .putString(
                                SETTING_BACKUP_FILENAME, binding.inputText.getText().toString());
                        dialog.dismiss();
                      });
                  dialog
                      .getWindow()
  ...
  /**
   * An in-memory caching store for settings listed in {@link ConfigActivity}. Persists to {@link
   * #SETTINGS_FILE}.
   *
   * @see #persist()
   */
