...
public class AppSettings extends BaseAppCompatActivity {
                ...
                .setSingleChoiceItems(
                    ...
                    (actionDialog, which) -> {
                      new MaterialAlertDialogBuilder(this)
                          ...
                          .setPositiveButton(
                              R.string.common_word_delete,
                              (deleteConfirmationDialog, pressedButton) -> {
                      ...
                      switch (which) {
                        ...
                        case 1 ->
                            new MaterialAlertDialogBuilder(this)
                                ...
                                .setMessage(
                                    "Are you sure you want to delete this file permanently? This"
                                        + " cannot be undone.")
                                .setPositiveButton(
                                    R.string.common_word_delete,
                                    (deleteDialog, pressedButton) -> FileUtil.deleteFile(files[0]))
                                .setNegativeButton(R.string.common_word_cancel, null)
                                .show();
                      }
                      actionDialog.dismiss();
  ...
  private void setupPreferences() {
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_block,
            "Block manager",
            "Manage your own blocks to use in Logic Editor",
            new ActivityLauncher(new Intent(getApplicationContext(), BlocksManager.class))));
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_pull_down,
            "Block selector menu manager",
            "Manage your own block selector menus",
            openSettingsActivity(SettingsActivity.BLOCK_SELECTOR_MANAGER_FRAGMENT)));
    preferences.add(
        createPreference(
    ...
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_list,
            "Event manager",
            "Manage your own events",
            openSettingsActivity(SettingsActivity.EVENTS_MANAGER_FRAGMENT)));
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_box,
            "Local library manager",
            "Manage and download local libraries",
            new ActivityLauncher(
    ...
    preferences.add(
        createPreference(
            ...
            new ActivityLauncher(new Intent(getApplicationContext(), ConfigActivity.class))));
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_palette,
    ...
    preferences.add(
        createPreference(
            ...
            "Open Sketchware Pro's directory and edit files in it",
            v -> openWorkingDirectory()));
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_apk_document,
            "Sign an APK file with testkey",
            "Sign an already existing APK file with testkey and signature schemes up to V4",
            v -> signApkFileDialog()));
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_article,
            getString(R.string.design_drawer_menu_title_logcat_reader),
            getString(R.string.design_drawer_menu_subtitle_logcat_reader),
            new ActivityLauncher(new Intent(getApplicationContext(), LogReaderActivity.class))));
    preferences.add(
        createPreference(
            R.drawable.ic_mtrl_settings,
            getString(R.string.main_drawer_title_system_settings),
            "Auto-save and vibrations",
            new ActivityLauncher(
                new Intent(getApplicationContext(), SystemSettingActivity.class))));
  ...
  private LibraryItemView createPreference(
      int icon, String title, String desc, View.OnClickListener listener) {
  ...
  private void signApkFileDialog() {
    ...
    DialogSelectApkToSignBinding binding =
        DialogSelectApkToSignBinding.inflate(getLayoutInflater());
    ...
    binding.selectFile.setOnClickListener(
        v -> {
          ...
          FilePickerDialog dialog =
              new FilePickerDialog(this, properties, R.style.RoundedCornersDialog);
          dialog.setDialogSelectionListener(
              files -> {
    ...
    apkPathDialog.b(
        ...
        v -> {
          ...
          String output_apk_path =
              new File(
                      Environment.getExternalStorageDirectory(),
                      "sketchware/signed_apk/" + output_apk_file_name)
                  .getAbsolutePath();
          ...
          if (new File(output_apk_path).exists()) {
            ...
            confirmOverwrite.a(
                "An APK named "
                    ...
                    + " already exists at /sketchware/signed_apk/.  Overwrite it?");
            ...
            confirmOverwrite.b(
                ...
                view -> {
                  ...
                  signApkFileWithDialog(
                      input_apk_path, output_apk_path, true, null, null, null, null);
                });
  ...
  private void signApkFileWithDialog(
      String inputApkPath,
    ...
    AlertDialog building_dialog =
        new MaterialAlertDialogBuilder(this).setView(building_root).create();
    ...
    new Thread() {
      ...
      public void run() {
        ...
        ApkSigner.LogCallback callback =
            line -> runOnUiThread(() -> tv_log.setText(tv_log.getText().toString() + line));
            ...
            () -> {
              if (ApkSigner.LogCallback.errorCount.get() == 0) {
                ...
                SketchwareUtil.toast(
                    "Successfully saved signed APK to: /Internal storage/sketchware/signed_apk/"
