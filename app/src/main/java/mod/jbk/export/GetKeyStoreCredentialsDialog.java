...
public class GetKeyStoreCredentialsDialog {
  ...
  public GetKeyStoreCredentialsDialog(
      Activity activity, int iconResourceId, String title, String noticeText) {
  ...
  private void setupSpinner(Activity activity) {
    ...
    ArrayAdapter<String> adapter =
        new ArrayAdapter<>(activity, android.R.layout.simple_spinner_dropdown_item, dropdownItems);
    binding.actSigningMode.setAdapter(adapter);
    binding.actSigningMode.setOnItemClickListener(
  ...
  public interface CredentialsReceiver {
    /**
     * @param credentials The {@link Credentials} object made from user input. May be null. In that
     *     case, the user disabled signing the file.
     */
  ...
  public static class Credentials {
    ...
    /**
     * Constructs a credentials holder configured to sign with testkey, meaning that no key store,
     * aliases, and passwords were entered.
     */
     ...
     */
    public Credentials(
        String signingAlgorithm, String keyPassword, String keyAlias, String keyStorePassword) {
