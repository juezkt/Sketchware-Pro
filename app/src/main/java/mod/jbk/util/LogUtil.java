...
public class LogUtil {
  ...
  /**
   * Similar to {@link Log#d(String, String, Throwable)}, but to log to {@link System#out}, or while
   * compiling, /Internal storage/.sketchware/debug.txt
   */
  ...
  /**
   * Similar to {@link Log#w(String, String, Throwable)}, but to log to {@link System#out}, or while
   * compiling, /Internal storage/.sketchware/debug.txt
   */
  ...
  /**
   * Similar to {@link Log#e(String, String, Throwable)}, but to log to {@link System#out}, or while
   * compiling, * /Internal storage/.sketchware/debug.txt
   */
  ...
  public static void log(
      String tag,
      String prefixIfOneLiner,
      String logMessageIfMultipleLines,
