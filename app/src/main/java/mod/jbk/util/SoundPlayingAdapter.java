...
public abstract class SoundPlayingAdapter<VH extends SoundPlayingAdapter.ViewHolder>
              ...
              context.runOnUiThread(
                  () -> {
                    ...
                    if (holder != null) {
                      ...
                      holder
                          .getCurrentPosition()
                          .setText(String.format("%d:%02d", positionInS / 60, positionInS % 60));
                      holder
                          .getPlaybackProgress()
                          .setProgress(mediaPlayer.getCurrentPosition() / 100);
                    } else {
                      timer.cancel();
