...
public class BuiltInLibraries {
  public static final File EXTRACTED_COMPILE_ASSETS_PATH =
      new File(SketchApplication.getContext().getFilesDir(), "libs");
  public static final File EXTRACTED_BUILT_IN_LIBRARIES_PATH =
      new File(EXTRACTED_COMPILE_ASSETS_PATH, "libs");
  public static final File EXTRACTED_BUILT_IN_LIBRARY_DEX_FILES_PATH =
      new File(EXTRACTED_COMPILE_ASSETS_PATH, "dexs");

  // None final so that field values won't be optimized into code, and to allow easy changing of
  // library names due to that
  ...
  public static String ANDROIDX_RESOURCEINSPECTION_ANNOTATION =
      "resourceinspection-annotation-1.0.0";
  ...
  public static String PLAY_SERVICES_MEASUREMENT_SDK_API =
      "play-services-measurement-sdk-api-20.1.2";
  ...
  public static final BuiltInLibrary[] KNOWN_BUILT_IN_LIBRARIES = {
    new BuiltInLibrary(
        ...
        List.of(
            ...
            ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
            ANDROIDX_SAVEDSTATE,
            ANDROIDX_TRACING)),
    ...
    new BuiltInLibrary(
        ...
        List.of(
            ...
            ANDROIDX_EMOJI2,
            ANDROIDX_EMOJI2_VIEWS_HELPER,
            ANDROIDX_FRAGMENT,
            ANDROIDX_LIFECYCLE_RUNTIME,
            ANDROIDX_LIFECYCLE_VIEWMODEL,
            ANDROIDX_RESOURCEINSPECTION_ANNOTATION,
            ANDROIDX_SAVEDSTATE),
        "androidx.appcompat"),
    new BuiltInLibrary(
        ANDROIDX_APPCOMPAT_RESOURCES,
        List.of(
            ...
            ANDROIDX_VECTORDRAWABLE_ANIMATED),
    ...
    new BuiltInLibrary(
        ...
        List.of(
            ...
            ANDROIDX_CORE,
            ANDROIDX_INTERPOLATOR,
            GUAVA_LISTENABLEFUTURE),
        "androidx.browser"),
    ...
    new BuiltInLibrary(
        ANDROIDX_CONCURRENT_FUTURES, List.of(ANDROIDX_ANNOTATION, GUAVA_LISTENABLEFUTURE)),
    new BuiltInLibrary(
        ANDROIDX_CONSTRAINTLAYOUT,
        List.of(ANDROIDX_APPCOMPAT, ANDROIDX_CORE, ANDROIDX_CONSTRAINTLAYOUT_CORE),
        "androidx.constraintlayout.widget"),
    new BuiltInLibrary(ANDROIDX_CONSTRAINTLAYOUT_CORE),
    new BuiltInLibrary(
        ANDROIDX_COORDINATORLAYOUT,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_CUSTOMVIEW),
    ...
    new BuiltInLibrary(
        ANDROIDX_EMOJI2_VIEWS_HELPER, List.of(ANDROIDX_COLLECTION, ANDROIDX_CORE, ANDROIDX_EMOJI2)),
    ...
    new BuiltInLibrary(
        ...
        List.of(
            ...
            ANDROIDX_COLLECTION,
            ANDROIDX_CORE,
            ANDROIDX_LIFECYCLE_LIVEDATA_CORE,
            ANDROIDX_LIFECYCLE_VIEWMODEL,
            ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
            ANDROIDX_LOADER,
            ANDROIDX_SAVEDSTATE,
    ...
    new BuiltInLibrary(
        ...
        List.of(ANDROIDX_CORE_COMMON, ANDROIDX_CORE_RUNTIME, ANDROIDX_LIFECYCLE_LIVEDATA_CORE)),
    new BuiltInLibrary(
        ANDROIDX_LIFECYCLE_LIVEDATA_CORE,
        List.of(ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_CORE_COMMON, ANDROIDX_CORE_RUNTIME)),
    new BuiltInLibrary(
        ANDROIDX_LIFECYCLE_PROCESS, List.of(ANDROIDX_LIFECYCLE_RUNTIME, ANDROIDX_STARTUP_RUNTIME)),
    new BuiltInLibrary(
        ANDROIDX_LIFECYCLE_RUNTIME,
        List.of(
            ANDROIDX_ANNOTATION,
            ANDROIDX_CORE_COMMON,
    ...
    new BuiltInLibrary(
        ANDROIDX_LIFECYCLE_VIEWMODEL, List.of(ANDROIDX_ANNOTATION), "androidx.lifecycle.viewmodel"),
    new BuiltInLibrary(
        ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
        List.of(
            ANDROIDX_ANNOTATION,
    ...
    new BuiltInLibrary(
        ANDROIDX_MEDIA,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_VERSIONEDPARCELABLE),
        "androidx.media"),
    new BuiltInLibrary(ANDROIDX_MULTIDEX),
    new BuiltInLibrary(ANDROIDX_PRINT, List.of(ANDROIDX_ANNOTATION)),
    new BuiltInLibrary(
        ANDROIDX_RECYCLERVIEW,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_LEGACY_SUPPORT_CORE_UI),
    ...
    new BuiltInLibrary(
        ...
        List.of(
            ANDROIDX_ANNOTATION,
            ANDROIDX_CORE_RUNTIME,
            ANDROIDX_ROOM_COMMON,
            ANDROIDX_SQLITE_FRAMEWORK,
            ANDROIDX_SQLITE)),
    new BuiltInLibrary(
        ANDROIDX_SAVEDSTATE,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE_COMMON, ANDROIDX_LIFECYCLE_COMMON),
        "androidx.savedstate"),
    new BuiltInLibrary(
        ANDROIDX_SLIDINGPANELAYOUT,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_CUSTOMVIEW)),
    ...
    new BuiltInLibrary(
        ANDROIDX_STARTUP_RUNTIME,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_TRACING),
        "androidx.startup"),
    new BuiltInLibrary(
        ANDROIDX_SWIPEREFRESHLAYOUT,
        List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_INTERPOLATOR),
        "androidx.swiperefreshlayout"),
    new BuiltInLibrary(ANDROIDX_TRACING, List.of(ANDROIDX_ANNOTATION)),
    new BuiltInLibrary(
        ANDROIDX_TRANSITION, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE), "androidx.transition"),
    new BuiltInLibrary(
        ANDROIDX_VECTORDRAWABLE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION, ANDROIDX_CORE)),
    new BuiltInLibrary(
        ANDROIDX_VECTORDRAWABLE_ANIMATED,
        List.of(ANDROIDX_COLLECTION, ANDROIDX_INTERPOLATOR, ANDROIDX_VECTORDRAWABLE)),
    new BuiltInLibrary(
        ANDROIDX_VERSIONEDPARCELABLE, List.of(ANDROIDX_ANNOTATION, ANDROIDX_COLLECTION)),
    new BuiltInLibrary(
        ANDROIDX_VIEWPAGER, List.of(ANDROIDX_ANNOTATION, ANDROIDX_CORE, ANDROIDX_CUSTOMVIEW)),
    new BuiltInLibrary(
        ANDROIDX_VIEWPAGER2,
        List.of(
            ANDROIDX_ANNOTATION,
    ...
    new BuiltInLibrary(
        FIREBASE_AUTH_INTEROP,
        List.of(FIREBASE_COMMON, PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_TASKS)),
    new BuiltInLibrary(
        FIREBASE_COMMON, List.of(FIREBASE_COMPONENTS, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_TASKS)),
    ...
    new BuiltInLibrary(
        ...
        List.of(
            FIREBASE_COMMON,
            FIREBASE_MEASUREMENT_CONNECTOR,
            PLAY_SERVICES_BASE,
            PLAY_SERVICES_BASEMENT,
            PLAY_SERVICES_TASKS)),
    new BuiltInLibrary(
    ...
    new BuiltInLibrary(
        OTPVIEW,
        List.of(
            ANDROIDX_APPCOMPAT, ANDROIDX_CORE_KTX, ANDROIDX_CONSTRAINTLAYOUT, KOTLIN_STDLIB_JDK7),
        "affan.ahmad.otp"),
    new BuiltInLibrary(
        PATTERN_LOCK_VIEW,
        List.of(ANDROIDX_CORE, JETBRAINS_ANNOTATIONS),
        "com.andrognito.patternlockview"),
    new BuiltInLibrary(
        PLAY_SERVICES_ADS,
        List.of(
            PLAY_SERVICES_ADS_BASE,
            PLAY_SERVICES_ADS_IDENTIFIER,
            PLAY_SERVICES_ADS_LITE,
            PLAY_SERVICES_APPSET,
            PLAY_SERVICES_BASEMENT,
            PLAY_SERVICES_TASKS,
            ANDROIDX_BROWSER,
            ANDROIDX_COLLECTION,
    ...
    new BuiltInLibrary(
        ...
        List.of(
            PLAY_SERVICES_ADS_BASE,
            PLAY_SERVICES_BASEMENT,
            PLAY_SERVICES_MEASUREMENT_SDK_API,
            ANDROIDX_WORK_RUNTIME,
            UMP_USER_MESSAGING_PLATFORM),
        "com.google.android.gms.ads"),
    new BuiltInLibrary(
        PLAY_SERVICES_APPSET,
        List.of(PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, PLAY_SERVICES_TASKS)),
    new BuiltInLibrary(
        PLAY_SERVICES_AUTH,
        List.of(
            PLAY_SERVICES_AUTH_API_PHONE,
            PLAY_SERVICES_AUTH_BASE,
            PLAY_SERVICES_BASE,
            PLAY_SERVICES_BASEMENT,
            PLAY_SERVICES_TASKS,
            ANDROIDX_FRAGMENT,
    ...
    new BuiltInLibrary(
        PLAY_SERVICES_BASEMENT,
        List.of(ANDROIDX_COLLECTION, ANDROIDX_CORE, ANDROIDX_FRAGMENT),
    ...
    new BuiltInLibrary(
        ...
        List.of(
            PLAY_SERVICES_BASE,
            PLAY_SERVICES_BASEMENT,
            PLAY_SERVICES_PLACES_PLACEREPORT,
            PLAY_SERVICES_TASKS)),
    new BuiltInLibrary(
        PLAY_SERVICES_MAPS,
        List.of(PLAY_SERVICES_BASE, PLAY_SERVICES_BASEMENT, ANDROIDX_FRAGMENT),
        "com.google.android.gms.maps"),
    new BuiltInLibrary(PLAY_SERVICES_MEASUREMENT_BASE, List.of(PLAY_SERVICES_BASEMENT)),
    new BuiltInLibrary(
        PLAY_SERVICES_MEASUREMENT_SDK_API,
        List.of(PLAY_SERVICES_BASEMENT, PLAY_SERVICES_MEASUREMENT_BASE)),
    new BuiltInLibrary(PLAY_SERVICES_PLACES_PLACEREPORT, List.of(PLAY_SERVICES_BASEMENT)),
    new BuiltInLibrary(
        PLAY_SERVICES_STATS, List.of(PLAY_SERVICES_BASEMENT, ANDROIDX_LEGACY_SUPPORT_CORE_UTILS)),
    new BuiltInLibrary(PLAY_SERVICES_TASKS, List.of(PLAY_SERVICES_BASEMENT)),
    new BuiltInLibrary(
        UMP_USER_MESSAGING_PLATFORM,
        List.of(ANDROIDX_ANNOTATION, PLAY_SERVICES_ADS_IDENTIFIER, PLAY_SERVICES_BASEMENT)),
    new BuiltInLibrary(WAVE_SIDE_BAR, List.of(), "com.sayuti.lib"),
    new BuiltInLibrary(
        YOUTUBE_PLAYER,
        List.of(ANDROIDX_APPCOMPAT, ANDROIDX_RECYCLERVIEW, KOTLIN_STDLIB_JDK7),
  ...
  public static File getLibraryAssets(String libraryName) {
    ...
    if (library.hasAssets()) {
      ...
      throw new IllegalArgumentException(
          "Built-in library '" + libraryName + "' doesn't have any assets.");
    }
  }
  ...
  public static File getLibraryResources(String libraryName) {
    ...
    if (library.hasResources()) {
      ...
      throw new IllegalArgumentException(
          "Built-in library '" + libraryName + "' doesn't have any resources.");
    }
  }
  ...
  public static File getLibraryProguardConfiguration(String libraryName) {
    return new File(
        EXTRACTED_BUILT_IN_LIBRARIES_PATH, libraryName + File.separator + "proguard.txt");
  }
  ...
  public static void extractCompileAssets(@NonNull BuildProgressReceiver... progressReceivers) {
    if (!EXTRACTED_COMPILE_ASSETS_PATH.exists()) {
      if (!EXTRACTED_COMPILE_ASSETS_PATH.mkdirs()) {
        throw new RuntimeException(
            new IOException("Failed to create directory " + EXTRACTED_COMPILE_ASSETS_PATH));
      }
    }
    ...
    String dexsArchivePath =
        new File(BuiltInLibraries.EXTRACTED_COMPILE_ASSETS_PATH, dexsArchiveName).getAbsolutePath();
    String libsArchivePath =
        new File(BuiltInLibraries.EXTRACTED_COMPILE_ASSETS_PATH, libsArchiveName).getAbsolutePath();
    String testkeyArchivePath =
        new File(BuiltInLibraries.EXTRACTED_COMPILE_ASSETS_PATH, testkeyArchiveName)
            .getAbsolutePath();
    String dexsDirectoryPath =
        BuiltInLibraries.EXTRACTED_BUILT_IN_LIBRARY_DEX_FILES_PATH.getAbsolutePath();
    String libsDirectoryPath = BuiltInLibraries.EXTRACTED_BUILT_IN_LIBRARIES_PATH.getAbsolutePath();
    String testkeyDirectoryPath =
        new File(BuiltInLibraries.EXTRACTED_COMPILE_ASSETS_PATH, "testkey").getAbsolutePath();
  ...
  public static void maybeExtractAndroidJar(@NonNull BuildProgressReceiver... receivers) {
    ...
    String androidJarPath =
        new File(EXTRACTED_COMPILE_ASSETS_PATH, androidJarArchiveName).getAbsolutePath();
    if (ProjectBuilder.hasFileChanged(
        "libs" + File.separator + androidJarArchiveName, androidJarPath)) {
  ...
  public static void maybeExtractCoreLambdaStubsJar() {
    ...
    String coreLambdaStubsJarPath =
        new File(BuiltInLibraries.EXTRACTED_COMPILE_ASSETS_PATH, coreLambdaStubsJarName)
            .getAbsolutePath();
    ProjectBuilder.hasFileChanged(
        "libs" + File.separator + coreLambdaStubsJarName, coreLambdaStubsJarPath);
  }
  ...
  public static class BuiltInLibrary implements Parcelable {
    ...
    /**
     * @param packageName Can be <code>null</code> for no resources, though then {@link
     *     #BuiltInLibrary(String, List)} is advised.
     */
    ...
    public static final Creator<BuiltInLibrary> CREATOR =
        new Creator<>() {
          @Override
