...
public class CodeEditorLanguages {
  ...
  static {
    FileProviderRegistry.getInstance()
        .addFileProvider(new AssetsFileResolver(SketchApplication.getContext().getAssets()));
    ...
    for (String language : LANGUAGES) {
      ...
      builder.language(
          ...
          languageDefinitionBuilder -> {
            ...
            languageDefinitionBuilder.defaultScopeName(
                language.equals(LANGUAGES[1]) ? "text" : "source");
  ...
  public static Language loadTextMateLanguage(String scopeName) {
    ...
    try {
      ...
      LogUtil.e(
          TAG,
          "Failed to create language from scope name '"
              + scopeName
              + "', using empty one as default language",
          e);
