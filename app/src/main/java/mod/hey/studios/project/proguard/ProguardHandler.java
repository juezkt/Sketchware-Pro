...
public class ProguardHandler {
  ...
  public ProguardHandler(String sc_id) {
    ...
    fm_config_path =
        FileUtil.getExternalStorageDir() + "/.sketchware/data/" + sc_id + "/proguard_fm";
  ...
  private static String createAndroidRules() {
    String rulePath =
        FileUtil.getExternalStorageDir() + "/.sketchware/libs/android-proguard-rules.pro";
  ...
  private static String createDefaultRules(String sc_id) {
    String path =
        FileUtil.getExternalStorageDir() + "/.sketchware/data/" + sc_id + "/proguard-rules.pro";

    if (!FileUtil.isExistFile(path)) {
      FileUtil.writeFile(
          path, "-repackageclasses\n" + "-ignorewarnings\n" + "-dontwarn\n" + "-dontnote\n");
    }
