...
public class ProguardRulesDialog extends Dialog implements View.OnClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    codeEditor.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0, 1.0f));
  ...
  private void addControl() {
    ...
    layout.setPadding((int) getDip(0), (int) getDip(0), (int) getDip(0), (int) getDip(0));
    ...
    cancel.setLayoutParams(new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
    ((LayoutParams) cancel.getLayoutParams())
    ...
    save.setLayoutParams(new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1.0f));
    ((LayoutParams) save.getLayoutParams())
        .setMargins((int) getDip(8), (int) getDip(8), (int) getDip(8), (int) getDip(8));
