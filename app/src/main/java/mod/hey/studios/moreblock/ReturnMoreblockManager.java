...
public class ReturnMoreblockManager {
  ...
  public static void listMoreblocks(
      Iterator<Pair<String, String>> it, LogicEditorActivity logicEditorActivity) {
    while (it.hasNext()) {
      ...
      if (moreblockChar.contains("|")) {
        ...
        logicEditorActivity
            .a(getMbName(str), split[0], split[1], "definedFunc")
            .setTag(getMbName(str));
      } else {
