...
public class MoreblockImporterDialog extends aB {
  ...
  public MoreblockImporterDialog(
      Activity activity, ArrayList<MoreBlockCollectionBean> beanList, CallBack callback) {
    super(activity);
    ...
    b(
        activity.getString(R.string.common_word_select),
        v -> {
  ...
  private static class MoreBlockAdapter extends RecyclerView.Adapter<MoreBlockAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      ManageCollectionPopupImportMoreBlockListItemBinding binding =
          ManageCollectionPopupImportMoreBlockListItemBinding.inflate(
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      ...
      holder.binding.imgSelected.setVisibility(
