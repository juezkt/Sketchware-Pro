 ...
 *     <p>
 *     <p>
 *     <p>//do not use this source to modify this library, use the other workaround i sent.
 */
public class CodeEditorLayout extends LinearLayout implements TextWatcher {
  ...
  private static final double KEYBOARD_RATIO = 0.25;
  ...
  public void onCreateOptionsMenu(View v) {
    ...
    menu.add("Font size").setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
    ...
    menu.add("Pretty print").setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
            ...
            case "Pretty print":
              ...
              try {
                ...
                SketchwareUtil.toastError(
                    "Error: Your code contains incorrectly nested parentheses");
                break;
              }
    ...
    if (textView != null) {
      ...
      textView.setOnFocusChangeListener(
          (v, hasFocus) -> {
            ...
            if (!hasFocus) imm.hideSoftInputFromWindow(v.getWindowToken(), 0);
              ...
              new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                  if (updateHighlight != null) {
                    ...
                    boolean shown =
                        (((rootHeight - height) / (double) rootHeight) > KEYBOARD_RATIO);
  ...
  private void checkHighlight() {
    ...
    if (updateHighlight == null) updateHighlight = this::highlightText;
  ...
  private void highlightText() {
    ...
    if (textView.getSelectionStart() < start) textView.setSelection(first);

    if (textView.getSelectionStart() > end) textView.setSelection(last);
