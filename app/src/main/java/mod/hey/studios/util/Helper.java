...
public class Helper {
  ...
  public static final TypeToken<ArrayList<HashMap<String, Object>>> TYPE_MAP_LIST =
      new TypeToken<>() {};
  ...
  public static void fixFileprovider() {
    if (Build.VERSION.SDK_INT >= 24) {
      try {
        ...
        Log.e(
            "Helper",
            "An error occurred while trying to fix death on file URI exposure: " + e.getMessage(),
            e);
      }
    }
  }
  ...
  public static void addBasicTextChangedListener(
      TextInputEditText input, BasicTextChangedListener listener) {
  ...
  public static void applyRippleToToolbarView(View view) {
    ...
    view.setBackground(
        new RippleDrawable(
            new ColorStateList(
                new int[][] {new int[] {0}}, new int[] {Color.parseColor("#64b5f6")}),
            content,
            null));
  }
   ...
   */
  public static void applyRippleEffect(
      final View target, final int rippleColor, int standardColor) {
