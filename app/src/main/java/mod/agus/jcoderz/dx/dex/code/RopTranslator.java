...
public final class RopTranslator {
  ...
  /**
   * Translates a {@link mod.agus.jcoderz.dx.rop.code.RopMethod}. This may modify the given input.
   *
  ...
  public static DalvCode translate(
      ...
      int positionInfo,
      mod.agus.jcoderz.dx.rop.code.LocalVariableInfo locals,
      int paramSize,
   ...
   */
  private static mod.agus.jcoderz.dx.rop.code.RegisterSpecList getRegs(
   ...
   */
  private static mod.agus.jcoderz.dx.rop.code.RegisterSpecList getRegs(
      mod.agus.jcoderz.dx.rop.code.Insn insn, mod.agus.jcoderz.dx.rop.code.RegisterSpec resultReg) {
  ...
  private class TranslationVisitor implements mod.agus.jcoderz.dx.rop.code.Insn.Visitor {
        ...
        if (!paramsAreInOrder) {
          ...
          mod.agus.jcoderz.dx.rop.code.RegisterSpec source =
              mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
                  regCount - paramSize + param, dest.getType());
          di =
              new SimpleInsn(
                  opcode, pos, mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(dest, source));
          addOutput(di);
        }
      } else {
    ...
    public void visitInvokePolymorphicInsn(InvokePolymorphicInsn insn) {
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpecList regs = insn.getSources();
      mod.agus.jcoderz.dx.rop.cst.Constant[] constants =
          new mod.agus.jcoderz.dx.rop.cst.Constant[] {
            insn.getPolymorphicMethod(), insn.getCallSiteProto()
          };
    ...
    public void visitThrowingCstInsn(mod.agus.jcoderz.dx.rop.code.ThrowingCstInsn insn) {
      ...
      if (rop.isCallLike()) {
        ...
        if (opcode.getOpcode() == mod.agus.jcoderz.dx.io.Opcodes.INSTANCE_OF
            && previousDi != null) {
          ...
          if (prevOpcode == mod.agus.jcoderz.dx.io.Opcodes.MOVE_OBJECT
            ...
            if (di.getRegisters().size() > 0
                && previousDi.getRegisters().size() > 1
