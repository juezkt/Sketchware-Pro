...
abstract /*package*/ class MemberListParser {
  ...
  private final mod.agus.jcoderz.dx.rop.cst.CstType definer;
  ...
  public MemberListParser(
      DirectClassFile cf,
      mod.agus.jcoderz.dx.rop.cst.CstType definer,
      int offset,
   ...
   */
  protected abstract mod.agus.jcoderz.dx.cf.iface.Member set(
      int n, int accessFlags, mod.agus.jcoderz.dx.rop.cst.CstNat nat, AttributeList attributes);
  ...
  private void parse() {
    ...
    for (int i = 0; i < count; i++) {
      try {
        ...
        mod.agus.jcoderz.dx.rop.cst.CstString desc = (CstString) pool.get(descIdx);
        ...
        mod.agus.jcoderz.dx.rop.cst.CstNat nat = new CstNat(name, desc);
