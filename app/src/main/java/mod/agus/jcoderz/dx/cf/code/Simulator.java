...
public class Simulator {
   ...
   */
  private static mod.agus.jcoderz.dx.rop.type.Type requiredArrayTypeFor(
      mod.agus.jcoderz.dx.rop.type.Type impliedType,
        ...
        case ByteOps.IALOAD:
          {
            ...
            type =
                (requiredArrayType == mod.agus.jcoderz.dx.rop.type.Type.KNOWN_NULL)
                    ? mod.agus.jcoderz.dx.rop.type.Type.KNOWN_NULL
    ...
    public void visitConstant(
      ...
      switch (opcode) {
        ...
        case ByteOps.PUTSTATIC:
          {
            mod.agus.jcoderz.dx.rop.type.Type fieldType =
                ((mod.agus.jcoderz.dx.rop.cst.CstFieldRef) cst).getType();
        ...
        case ByteOps.INVOKESTATIC:
          {
            ...
            if (cst instanceof mod.agus.jcoderz.dx.rop.cst.CstMethodRef) {
              mod.agus.jcoderz.dx.rop.cst.CstMethodRef methodRef =
