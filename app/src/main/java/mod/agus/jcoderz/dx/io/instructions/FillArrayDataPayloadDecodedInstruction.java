...
public final class FillArrayDataPayloadDecodedInstruction
  ...
  private FillArrayDataPayloadDecodedInstruction(
      mod.agus.jcoderz.dx.io.instructions.InstructionCodec format,
      int opcode,
      Object data,
      int size,
      int elementWidth) {
  ...
  public FillArrayDataPayloadDecodedInstruction(
      mod.agus.jcoderz.dx.io.instructions.InstructionCodec format, int opcode, byte[] data) {
    this(format, opcode, data, data.length, 1);
  }

  /** Constructs an instance. */
  public FillArrayDataPayloadDecodedInstruction(
      mod.agus.jcoderz.dx.io.instructions.InstructionCodec format, int opcode, short[] data) {
    this(format, opcode, data, data.length, 2);
  }

  /** Constructs an instance. */
  public FillArrayDataPayloadDecodedInstruction(
      mod.agus.jcoderz.dx.io.instructions.InstructionCodec format, int opcode, int[] data) {
