...
public class IdenticalBlockCombiner {
   ...
   */
  private static boolean compareInsns(
      mod.agus.jcoderz.dx.rop.code.BasicBlock a, mod.agus.jcoderz.dx.rop.code.BasicBlock b) {
   ...
   */
  private void replaceSucc(
      mod.agus.jcoderz.dx.rop.code.BasicBlock block, int oldLabel, int newLabel) {
    ...
    mod.agus.jcoderz.dx.rop.code.BasicBlock newBB =
