...
public final class AnnotationsDirectoryItem extends mod.agus.jcoderz.dx.dex.file.OffsettedItem {
   ...
   */
  public void setClassAnnotations(
   ...
   * @param dexFile {@code non-null;} dex output
   */
  public void addFieldAnnotations(
      CstFieldRef field, Annotations annotations, mod.agus.jcoderz.dx.dex.file.DexFile dexFile) {
    if (fieldAnnotations == null) {
      fieldAnnotations = new ArrayList<mod.agus.jcoderz.dx.dex.file.FieldAnnotationStruct>();
    }

    fieldAnnotations.add(
        new mod.agus.jcoderz.dx.dex.file.FieldAnnotationStruct(
            field, new mod.agus.jcoderz.dx.dex.file.AnnotationSetItem(annotations, dexFile)));
  }
  ...
  public void addMethodAnnotations(
      CstMethodRef method, Annotations annotations, mod.agus.jcoderz.dx.dex.file.DexFile dexFile) {
    if (methodAnnotations == null) {
      methodAnnotations = new ArrayList<mod.agus.jcoderz.dx.dex.file.MethodAnnotationStruct>();
    }

    methodAnnotations.add(
        new mod.agus.jcoderz.dx.dex.file.MethodAnnotationStruct(
            method, new AnnotationSetItem(annotations, dexFile)));
  }
   ...
   * @param dexFile {@code non-null;} dex output
   */
  public void addParameterAnnotations(
      CstMethodRef method, AnnotationsList list, mod.agus.jcoderz.dx.dex.file.DexFile dexFile) {
    if (parameterAnnotations == null) {
      parameterAnnotations =
          new ArrayList<mod.agus.jcoderz.dx.dex.file.ParameterAnnotationStruct>();
    }

    parameterAnnotations.add(
        new mod.agus.jcoderz.dx.dex.file.ParameterAnnotationStruct(method, list, dexFile));
  }
