...
/**
 * Container for the set of {@link mod.agus.jcoderz.dx.dex.code.CodeAddress} instances associated
 * with the blocks of a particular method. Each block has a corresponding start address, end
 * address, and last instruction address.
 */
public final class BlockAddresses {
   ...
   */
  public mod.agus.jcoderz.dx.dex.code.CodeAddress getStart(
   ...
   * @return {@code non-null;} the appropriate instance
   */
  public mod.agus.jcoderz.dx.dex.code.CodeAddress getLast(
      mod.agus.jcoderz.dx.rop.code.BasicBlock block) {
   ...
   * @return {@code non-null;} the appropriate instance
   */
  public mod.agus.jcoderz.dx.dex.code.CodeAddress getEnd(
      mod.agus.jcoderz.dx.rop.code.BasicBlock block) {
