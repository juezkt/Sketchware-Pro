...
public class EscapeAnalysis {
   ...
   */
  private void processPhiUse(
      mod.agus.jcoderz.dx.ssa.SsaInsn use,
      EscapeSet escSet,
      ArrayList<mod.agus.jcoderz.dx.rop.code.RegisterSpec> regWorklist) {
  ...
  private void processUse(
    ...
    switch (useOpcode) {
      ...
      case mod.agus.jcoderz.dx.rop.code.RegOps.PUT_FIELD:
        ...
        if (putValue.getTypeBearer().getBasicType()
            != mod.agus.jcoderz.dx.rop.type.Type.BT_OBJECT) {
          break;
        }
        escSet.replaceableArray = false;
  ...
  private void scalarReplacement() {
    ...
    for (EscapeSet escSet : latticeValues) {
      ...
      HashSet<mod.agus.jcoderz.dx.ssa.SsaInsn> deletedInsns =
          new HashSet<mod.agus.jcoderz.dx.ssa.SsaInsn>();
  ...
  private void replaceDef(
      mod.agus.jcoderz.dx.ssa.SsaInsn def,
      mod.agus.jcoderz.dx.ssa.SsaInsn prev,
      int length,
      ArrayList<mod.agus.jcoderz.dx.rop.code.RegisterSpec> newRegs) {
    ...
    switch (use.getOpcode().getOpcode()) {
      case mod.agus.jcoderz.dx.rop.code.RegOps.AGET:
        ...
        if (index < length) {
          ...
          insertPlainInsnBefore(
              next,
              mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(source),
              result,
              mod.agus.jcoderz.dx.rop.code.RegOps.MOVE,
              null);
        } else {
      ...
      case mod.agus.jcoderz.dx.rop.code.RegOps.ARRAY_LENGTH:
        ...
        mod.agus.jcoderz.dx.rop.type.TypeBearer lengthReg =
            prev.getSources().get(0).getTypeBearer();
        ...
        for (int i = 0; i < length; i++) {
          mod.agus.jcoderz.dx.rop.code.RegisterSpec newFill =
              mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
                  newRegs.get(i).getReg(), (TypeBearer) constList.get(i));
          insertPlainInsnBefore(
              use,
              mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY,
              newFill,
  ...
  private void movePropagate() {
    for (int i = 0; i < ssaMeth.getRegCount(); i++) {
      ...
      mod.agus.jcoderz.dx.ssa.RegisterMapper mapper =
          new RegisterMapper() {
            @Override
            ...
            @Override
            public mod.agus.jcoderz.dx.rop.code.RegisterSpec map(
  ...
  private void run() {
    ssaMeth.forEachBlockDepthFirstDom(
        new mod.agus.jcoderz.dx.ssa.SsaBasicBlock.Visitor() {
          @Override
  ...
  private void insertExceptionThrow(
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec index,
      HashSet<mod.agus.jcoderz.dx.ssa.SsaInsn> deletedInsns) {
    ...
    insertThrowingInsnBefore(
        ...
        mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY,
        null,
        mod.agus.jcoderz.dx.rop.code.RegOps.NEW_INSTANCE,
        exception);
    ...
    insertPlainInsnBefore(
        ...
        mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY,
        newReg,
        mod.agus.jcoderz.dx.rop.code.RegOps.MOVE_RESULT_PSEUDO,
        null);
    ...
    mod.agus.jcoderz.dx.rop.cst.CstNat newNat =
        new CstNat(new mod.agus.jcoderz.dx.rop.cst.CstString("<init>"), new CstString("(I)V"));
    mod.agus.jcoderz.dx.rop.cst.CstMethodRef newRef = new CstMethodRef(exception, newNat);
    insertThrowingInsnBefore(
        newInsn2,
        mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(newReg, index),
        null,
        mod.agus.jcoderz.dx.rop.code.RegOps.INVOKE_DIRECT,
        newRef);
    ...
    insertThrowingInsnBefore(
        newInsn3,
        mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(newReg),
        null,
        mod.agus.jcoderz.dx.rop.code.RegOps.THROW,
        null);
  ...
  private void insertPlainInsnBefore(
      mod.agus.jcoderz.dx.ssa.SsaInsn insn,
      mod.agus.jcoderz.dx.rop.code.RegisterSpecList newSources,
      mod.agus.jcoderz.dx.rop.code.RegisterSpec newResult,
      int newOpcode,
