...
public final class Ropper {
  ...
  private class Subroutine {
    ...
    mod.agus.jcoderz.dx.util.IntList getSuccessors() {
      mod.agus.jcoderz.dx.util.IntList successors =
          new mod.agus.jcoderz.dx.util.IntList(callerBlocks.size());
   ...
   */
  public static mod.agus.jcoderz.dx.rop.code.RopMethod convert(
      ConcreteMethod method,
      mod.agus.jcoderz.dx.rop.code.TranslationAdvice advice,
      MethodList methods,
      mod.agus.jcoderz.dx.dex.DexOptions dexOptions) {
    try {
  ...
  private mod.agus.jcoderz.dx.rop.code.RegisterSpec getSynchReg() {
    ...
    return mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
        (reg < 1) ? 1 : reg, mod.agus.jcoderz.dx.rop.type.Type.OBJECT);
  }
  ...
  private mod.agus.jcoderz.dx.rop.code.BasicBlock labelToBlock(int label) {
    ...
    if (idx < 0) {
      throw new IllegalArgumentException("no such label " + mod.agus.jcoderz.dx.util.Hex.u2(label));
    }
  ...
  private void addBlock(
      mod.agus.jcoderz.dx.rop.code.BasicBlock block, mod.agus.jcoderz.dx.util.IntList subroutines) {
    if (block == null) {
   ...
   *     time
   */
  private boolean addOrReplaceBlock(
      mod.agus.jcoderz.dx.rop.code.BasicBlock block, mod.agus.jcoderz.dx.util.IntList subroutines) {
    if (block == null) {
      throw new NullPointerException("block == null");
    }
   ...
   *     time
   */
  private boolean addOrReplaceBlockNoDelete(
      mod.agus.jcoderz.dx.rop.code.BasicBlock block, mod.agus.jcoderz.dx.util.IntList subroutines) {
    if (block == null) {
      throw new NullPointerException("block == null");
    }
  ...
  private void removeBlockAndSpecialSuccessors(int idx) {
    ...
    for (int i = 0; i < sz; i++) {
      ...
      if (label >= minLabel) {
        ...
        if (idx < 0) {
          throw new RuntimeException("Invalid label " + mod.agus.jcoderz.dx.util.Hex.u2(label));
        }
        removeBlockAndSpecialSuccessors(idx);
      }
    }
  ...
  private void processBlock(ByteBlock block, Frame frame, int[] workSet) {
    ...
    if (synch || (catchSz != 0)) {
      ...
      for (int i = 0; i < catchSz; i++) {
        ...
        try {
          ...
          ex.addContext(
              "...while merging exception to block " + mod.agus.jcoderz.dx.util.Hex.u2(targ));
          throw ex;
        }
    ...
    /*extraBlockCount*/ ; extraBlockCount > 0; extraBlockCount--) {
      ...
      boolean needsGoto =
          extraInsn.getOpcode().getBranchingness() == mod.agus.jcoderz.dx.rop.code.Rop.BRANCH_NONE;
      mod.agus.jcoderz.dx.rop.code.InsnList il =
          new mod.agus.jcoderz.dx.rop.code.InsnList(needsGoto ? 2 : 1);
      ...
      mod.agus.jcoderz.dx.rop.code.BasicBlock bb =
          new mod.agus.jcoderz.dx.rop.code.BasicBlock(label, il, extraBlockSuccessors, primarySucc);
    ...
    if ((lastInsn == null)
      ...
      mod.agus.jcoderz.dx.rop.code.SourcePosition pos =
          (lastInsn == null)
  ...
  private void addSetupBlocks() {
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec result =
          (local == null)
              ...
              : mod.agus.jcoderz.dx.rop.code.RegisterSpec.makeLocalOptional(
                  at, one, local.getLocalItem());

      mod.agus.jcoderz.dx.rop.code.Insn insn =
          new mod.agus.jcoderz.dx.rop.code.PlainCstInsn(
              mod.agus.jcoderz.dx.rop.code.Rops.opMoveParam(one),
              pos,
              result,
              mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY,
    ...
    mod.agus.jcoderz.dx.rop.code.BasicBlock bb =
        new mod.agus.jcoderz.dx.rop.code.BasicBlock(
            getSpecialLabel(PARAM_ASSIGNMENT),
            insns,
            mod.agus.jcoderz.dx.util.IntList.makeImmutable(label),
            label);
    ...
    if (synch) {
      ...
      if (isStatic()) {
        insn =
            new ThrowingCstInsn(
                mod.agus.jcoderz.dx.rop.code.Rops.CONST_OBJECT,
                pos,
                mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY,
      ...
      bb =
          new mod.agus.jcoderz.dx.rop.code.BasicBlock(
              label, insns, mod.agus.jcoderz.dx.util.IntList.makeImmutable(label2), label2);
      addBlock(bb, mod.agus.jcoderz.dx.util.IntList.EMPTY);
      ...
      if (isStatic()) {
        insns.set(
            0,
            new mod.agus.jcoderz.dx.rop.code.PlainInsn(
                mod.agus.jcoderz.dx.rop.code.Rops.opMoveResultPseudo(synchReg),
                pos,
                synchReg,
                mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY));
      }
      ...
      insn =
          new mod.agus.jcoderz.dx.rop.code.ThrowingInsn(
      ...
      bb =
          new mod.agus.jcoderz.dx.rop.code.BasicBlock(
              label2, insns, mod.agus.jcoderz.dx.util.IntList.makeImmutable(0), 0);
      addBlock(bb, mod.agus.jcoderz.dx.util.IntList.EMPTY);
    }
  }
  ...
  private void addReturnBlock() {
    ...
    if (isSynchronized()) {
      ...
      mod.agus.jcoderz.dx.rop.code.BasicBlock bb =
          new mod.agus.jcoderz.dx.rop.code.BasicBlock(
              label, insns, mod.agus.jcoderz.dx.util.IntList.makeImmutable(nextLabel), nextLabel);
      addBlock(bb, mod.agus.jcoderz.dx.util.IntList.EMPTY);
    ...
    if (sourceTypes.size() == 0) {
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec source =
          mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(0, sourceTypes.getType(0));
      sources = mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(source);
    }

    mod.agus.jcoderz.dx.rop.code.Insn insn =
        new mod.agus.jcoderz.dx.rop.code.PlainInsn(returnOp, returnPos, null, sources);
    insns.set(0, insn);
    insns.setImmutable();

    mod.agus.jcoderz.dx.rop.code.BasicBlock bb =
        new mod.agus.jcoderz.dx.rop.code.BasicBlock(
            label, insns, mod.agus.jcoderz.dx.util.IntList.EMPTY, -1);
    addBlock(bb, mod.agus.jcoderz.dx.util.IntList.EMPTY);
  }
  ...
  private void addSynchExceptionHandlerBlock() {
    ...
    mod.agus.jcoderz.dx.rop.code.SourcePosition pos = method.makeSourcePosistion(0);
    mod.agus.jcoderz.dx.rop.code.RegisterSpec exReg =
        mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
            0, mod.agus.jcoderz.dx.rop.type.Type.THROWABLE);
    mod.agus.jcoderz.dx.rop.code.BasicBlock bb;
    mod.agus.jcoderz.dx.rop.code.Insn insn;
    ...
    insn =
        new mod.agus.jcoderz.dx.rop.code.PlainInsn(
            mod.agus.jcoderz.dx.rop.code.Rops.opMoveException(Type.THROWABLE),
            pos,
            exReg,
            mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY);
    insns.set(0, insn);
    ...
    bb =
        new mod.agus.jcoderz.dx.rop.code.BasicBlock(
            getSpecialLabel(SYNCH_CATCH_1),
            insns,
            mod.agus.jcoderz.dx.util.IntList.makeImmutable(label2),
            label2);
    addBlock(bb, mod.agus.jcoderz.dx.util.IntList.EMPTY);
    ...
    insn =
        new ThrowingInsn(
            mod.agus.jcoderz.dx.rop.code.Rops.THROW,
            pos,
    ...
    bb =
        new mod.agus.jcoderz.dx.rop.code.BasicBlock(
            label2, insns, mod.agus.jcoderz.dx.util.IntList.EMPTY, -1);
    addBlock(bb, mod.agus.jcoderz.dx.util.IntList.EMPTY);
  }
    ...
    for (int i = 0; i < len; i++) {
      ...
      if (catches != null) {
        for (ExceptionHandlerSetup one : catches.getSetups()) {
          ...
          mod.agus.jcoderz.dx.rop.code.Insn insn =
              new mod.agus.jcoderz.dx.rop.code.PlainInsn(
                  mod.agus.jcoderz.dx.rop.code.Rops.opMoveException(one.getCaughtType()),
                  pos,
          ...
          insn =
              new PlainInsn(
                  mod.agus.jcoderz.dx.rop.code.Rops.GOTO, pos, null, RegisterSpecList.EMPTY);
          il.set(1, insn);
          il.setImmutable();

          mod.agus.jcoderz.dx.rop.code.BasicBlock bb =
              new mod.agus.jcoderz.dx.rop.code.BasicBlock(
                  one.getLabel(), il, mod.agus.jcoderz.dx.util.IntList.makeImmutable(i), i);
  ...
  private void inlineSubroutines() {
    final mod.agus.jcoderz.dx.util.IntList reachableSubroutineCallerLabels =
        new mod.agus.jcoderz.dx.util.IntList(4);
  ...
  private void deleteUnreachableBlocks() {
    final mod.agus.jcoderz.dx.util.IntList reachableLabels =
        new mod.agus.jcoderz.dx.util.IntList(result.size());
  ...
  private class SubroutineInliner {
    ...
    SubroutineInliner(
        final LabelAllocator labelAllocator,
        ArrayList<mod.agus.jcoderz.dx.util.IntList> labelToSubroutines) {
    ...
    private void copyBlock(int origLabel, int newLabel) {
      ...
      if (isSubroutineCaller(origBlock)) {
        ...
        successors =
            mod.agus.jcoderz.dx.util.IntList.makeImmutable(
                mapOrAllocateLabel(origSuccessors.get(0)), origSuccessors.get(1));
   ...
   */
  private mod.agus.jcoderz.dx.rop.code.InsnList filterMoveReturnAddressInsns(
      mod.agus.jcoderz.dx.rop.code.InsnList insns) {
    int sz;
    int newSz = 0;
  ...
  private void forEachNonSubBlockDepthFirst(
      int firstLabel, mod.agus.jcoderz.dx.rop.code.BasicBlock.Visitor v) {
