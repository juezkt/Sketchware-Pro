...
public final class EncodedMethod extends EncodedMember implements Comparable<EncodedMethod> {
  ...
  private final mod.agus.jcoderz.dx.rop.cst.CstMethodRef method;
  ...
  public EncodedMethod(
      mod.agus.jcoderz.dx.rop.cst.CstMethodRef method,
      int accessFlags,
      DalvCode code,
      TypeList throwsList) {
    super(accessFlags);
    ...
    if (code == null) {
      ...
      boolean isStatic = (accessFlags & mod.agus.jcoderz.dx.rop.code.AccessFlags.ACC_STATIC) != 0;
  ...
  public int encode(DexFile file, AnnotatedOutput out, int lastIndex, int dumpSeq) {
    ...
    if (out.annotates()) {
      ...
      out.annotate(
          ...
          "    method_idx:   " + mod.agus.jcoderz.dx.util.Hex.u4(methodIdx));
      out.annotate(
