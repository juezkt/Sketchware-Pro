...
public final class ClassDataItem extends OffsettedItem {
  ...
  public ArrayList<mod.agus.jcoderz.dx.dex.file.EncodedMethod> getMethods() {
    ...
    ArrayList<mod.agus.jcoderz.dx.dex.file.EncodedMethod> result =
        new ArrayList<mod.agus.jcoderz.dx.dex.file.EncodedMethod>(sz);
   ...
   */
  private static void encodeSize(
      mod.agus.jcoderz.dx.dex.file.DexFile file, AnnotatedOutput out, String label, int size) {
    if (out.annotates()) {
  ...
  private static void encodeList(
      mod.agus.jcoderz.dx.dex.file.DexFile file,
      AnnotatedOutput out,
      String label,
