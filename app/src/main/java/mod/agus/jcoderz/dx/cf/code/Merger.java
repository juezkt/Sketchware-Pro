...
public final class Merger {
   ...
   */
  public static mod.agus.jcoderz.dx.cf.code.OneLocalsArray mergeLocals(
      mod.agus.jcoderz.dx.cf.code.OneLocalsArray locals1,
   ...
   */
  public static mod.agus.jcoderz.dx.cf.code.ExecutionStack mergeStack(
      mod.agus.jcoderz.dx.cf.code.ExecutionStack stack1,
   ...
   */
  public static mod.agus.jcoderz.dx.rop.type.TypeBearer mergeType(
      mod.agus.jcoderz.dx.rop.type.TypeBearer ft1, mod.agus.jcoderz.dx.rop.type.TypeBearer ft2) {
      ...
      if (type1 == type2) {
        ...
        if (type1 == mod.agus.jcoderz.dx.rop.type.Type.KNOWN_NULL) {
          ...
          mod.agus.jcoderz.dx.rop.type.TypeBearer componentUnion =
              mergeType(type1.getComponentType(), type2.getComponentType());
  ...
  public static boolean isPossiblyAssignableFrom(
      mod.agus.jcoderz.dx.rop.type.TypeBearer supertypeBearer, TypeBearer subtypeBearer) {
    ...
    if ((superBt != mod.agus.jcoderz.dx.rop.type.Type.BT_OBJECT)
        || (subBt != mod.agus.jcoderz.dx.rop.type.Type.BT_OBJECT)) {
      /*
