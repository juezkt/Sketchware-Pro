...
public final class Annotation extends MutabilityControl implements Comparable<Annotation>, ToHuman {
  ...
  private final mod.agus.jcoderz.dx.rop.annotation.AnnotationVisibility visibility;

  /**
   * {@code non-null;} map from names to {@link mod.agus.jcoderz.dx.rop.annotation.NameValuePair}
   * instances
   */
  private final TreeMap<
          mod.agus.jcoderz.dx.rop.cst.CstString, mod.agus.jcoderz.dx.rop.annotation.NameValuePair>
      elements;
  ...
  public Annotation(
    ...
    this.elements =
        new TreeMap<
            mod.agus.jcoderz.dx.rop.cst.CstString,
            mod.agus.jcoderz.dx.rop.annotation.NameValuePair>();
  }
  ...
  public int compareTo(Annotation other) {
    ...
    Iterator<mod.agus.jcoderz.dx.rop.annotation.NameValuePair> thisIter =
        elements.values().iterator();
    Iterator<mod.agus.jcoderz.dx.rop.annotation.NameValuePair> otherIter =
        other.elements.values().iterator();

    while (thisIter.hasNext() && otherIter.hasNext()) {
      mod.agus.jcoderz.dx.rop.annotation.NameValuePair thisOne = thisIter.next();
      mod.agus.jcoderz.dx.rop.annotation.NameValuePair otherOne = otherIter.next();
  ...
  public String toHuman() {
    ...
    boolean first = true;
    for (mod.agus.jcoderz.dx.rop.annotation.NameValuePair pair : elements.values()) {
      if (first) {
        first = false;
      } else {
        sb.append(", ");
   ...
   */
  public void put(mod.agus.jcoderz.dx.rop.annotation.NameValuePair pair) {
    throwIfImmutable();
   ...
   */
  public void add(mod.agus.jcoderz.dx.rop.annotation.NameValuePair pair) {
    throwIfImmutable();
