...
public final class HighRegisterPrefix extends VariableSizeInsn {
  ...
  /** {@inheritDoc} */
  @Override
  public mod.agus.jcoderz.dx.dex.code.DalvInsn withRegisters(
      mod.agus.jcoderz.dx.rop.code.RegisterSpecList registers) {
   ...
   */
  private static SimpleInsn moveInsnFor(
      mod.agus.jcoderz.dx.rop.code.RegisterSpec src, int destIndex) {
