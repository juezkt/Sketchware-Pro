 ...
 */
public abstract class FixedSizeInsn extends mod.agus.jcoderz.dx.dex.code.DalvInsn {
  /**
   ...
   * may be passed as {@link mod.agus.jcoderz.dx.rop.code.RegisterSpecList#EMPTY}.
   *
