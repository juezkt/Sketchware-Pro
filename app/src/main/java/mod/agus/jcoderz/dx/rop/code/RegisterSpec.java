...
public final class RegisterSpec implements TypeBearer, ToHuman, Comparable<RegisterSpec> {
  ...
  /**
   * Helper for {@link #equals} and {@link RegisterSpec.ForComparison#equals}, which actually does
   * the test.
   *
  ...
  /**
   * Helper for {@link #hashCode} and {@link RegisterSpec.ForComparison#hashCode}, which actually
  ...
  private String toString0(boolean human) {
    ...
    if (justType != type) {
      sb.append("=");
      if (human && (type instanceof mod.agus.jcoderz.dx.rop.cst.CstString)) {
