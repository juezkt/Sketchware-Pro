...
/**
 * Static method that turns {@code byte[]}s containing Java classfiles into {@link
 * mod.agus.jcoderz.dx.dex.file.ClassDefItem} instances.
 */
public class CfTranslator {
   ...
   * mod.agus.jcoderz.dx.dex.file.ClassDefItem}.
   *
   ...
   */
  public static mod.agus.jcoderz.dx.dex.file.ClassDefItem translate(
      mod.agus.jcoderz.dx.command.dexer.DxContext context,
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      byte[] bytes,
      mod.agus.jcoderz.dx.dex.cf.CfOptions cfOptions,
   ...
   * @return {@code non-null;} the translated class
   */
  private static mod.agus.jcoderz.dx.dex.file.ClassDefItem translate0(
      mod.agus.jcoderz.dx.command.dexer.DxContext context,
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      byte[] bytes,
      mod.agus.jcoderz.dx.dex.cf.CfOptions cfOptions,
    ...
    int classAccessFlags =
        cf.getAccessFlags() & ~mod.agus.jcoderz.dx.rop.code.AccessFlags.ACC_SUPER;
    ...
    mod.agus.jcoderz.dx.dex.file.ClassDefItem out =
        new mod.agus.jcoderz.dx.dex.file.ClassDefItem(
   ...
   */
  private static mod.agus.jcoderz.dx.rop.cst.TypedConstant coerceConstant(
      TypedConstant constant, mod.agus.jcoderz.dx.rop.type.Type type) {
      ...
      try {
        ...
        if (isNative || isAbstract) {
          ...
          mod.agus.jcoderz.dx.rop.code.RopMethod rmeth =
              Ropper.convert(concrete, advice, methods, dexOptions);
  ...
  private static void updateDexStatistics(
      ...
      mod.agus.jcoderz.dx.rop.code.RopMethod optRmeth,
