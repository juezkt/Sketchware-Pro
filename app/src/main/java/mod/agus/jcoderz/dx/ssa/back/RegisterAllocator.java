...
public abstract class RegisterAllocator {
  ...
  protected final mod.agus.jcoderz.dx.ssa.back.InterferenceGraph interference;
   ...
   */
  protected final mod.agus.jcoderz.dx.rop.code.RegisterSpec getDefinitionSpecForSsaReg(int reg) {
    SsaInsn definition = ssaMeth.getDefinitionForRegister(reg);
   ...
   */
  protected final mod.agus.jcoderz.dx.rop.code.RegisterSpec insertMoveBefore(
      SsaInsn insn, mod.agus.jcoderz.dx.rop.code.RegisterSpec reg) {
    ...
    mod.agus.jcoderz.dx.rop.code.RegisterSpec newRegSpec =
        RegisterSpec.make(ssaMeth.makeNewSsaReg(), reg.getTypeBearer());
    ...
    SsaInsn toAdd =
        SsaInsn.makeFromRop(
            new PlainInsn(
                ...
                newRegSpec,
                mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(reg)),
            block);
