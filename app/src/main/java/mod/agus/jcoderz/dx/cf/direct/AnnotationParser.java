...
public final class AnnotationParser {
   ...
   * @return {@code non-null;} the list of annotations read from the attribute data
   */
  private mod.agus.jcoderz.dx.rop.annotation.Annotations parseAnnotations(
      mod.agus.jcoderz.dx.rop.annotation.AnnotationVisibility visibility) throws IOException {
   ...
   */
  private mod.agus.jcoderz.dx.rop.annotation.Annotation parseAnnotation(
      mod.agus.jcoderz.dx.rop.annotation.AnnotationVisibility visibility) throws IOException {
    requireLength(4);

    int typeIndex = input.readUnsignedShort();
    int numElements = input.readUnsignedShort();
    mod.agus.jcoderz.dx.rop.cst.CstString typeString =
        (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(typeIndex);
    mod.agus.jcoderz.dx.rop.cst.CstType type =
        new mod.agus.jcoderz.dx.rop.cst.CstType(
            mod.agus.jcoderz.dx.rop.type.Type.intern(typeString.getString()));
    ...
    mod.agus.jcoderz.dx.rop.annotation.Annotation annotation =
        new mod.agus.jcoderz.dx.rop.annotation.Annotation(type, visibility);
  ...
  private mod.agus.jcoderz.dx.rop.annotation.NameValuePair parseElement() throws IOException {
    ...
    mod.agus.jcoderz.dx.rop.cst.CstString elementName =
        (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(elementNameIndex);
  ...
  private mod.agus.jcoderz.dx.rop.cst.Constant parseValue() throws IOException {
    ...
    if (observer != null) {
      mod.agus.jcoderz.dx.rop.cst.CstString humanTag =
          new mod.agus.jcoderz.dx.rop.cst.CstString(Character.toString((char) tag));
    ...
    switch (tag) {
      case 'B':
        {
          mod.agus.jcoderz.dx.rop.cst.CstInteger value =
              (mod.agus.jcoderz.dx.rop.cst.CstInteger) parseConstant();
      ...
      case 'c':
        {
          ...
          mod.agus.jcoderz.dx.rop.cst.CstString value =
              (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(classInfoIndex);
      ...
      case 'e':
        {
          ...
          mod.agus.jcoderz.dx.rop.cst.CstString typeName =
              (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(typeNameIndex);
          mod.agus.jcoderz.dx.rop.cst.CstString constName =
              (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(constNameIndex);
      ...
      case '[':
        {
          ...
          mod.agus.jcoderz.dx.rop.cst.CstArray.List list =
              new mod.agus.jcoderz.dx.rop.cst.CstArray.List(numValues);
      ...
      default:
        {
          throw new mod.agus.jcoderz.dx.cf.iface.ParseException(
              "unknown annotation tag: " + Hex.u1(tag));
        }
    }
  }
  ...
  private mod.agus.jcoderz.dx.rop.cst.Constant parseConstant() throws IOException {
    ...
    if (observer != null) {
      String human =
          (value instanceof mod.agus.jcoderz.dx.rop.cst.CstString)
