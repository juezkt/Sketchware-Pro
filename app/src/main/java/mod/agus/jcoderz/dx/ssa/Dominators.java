...
public final class Dominators {
   ...
   */
  private Dominators(
      mod.agus.jcoderz.dx.ssa.SsaMethod meth,
      mod.agus.jcoderz.dx.ssa.DomFront.DomInfo[] domInfos,
      boolean postdom) {
    this.meth = meth;
  ...
  private void compress(mod.agus.jcoderz.dx.ssa.SsaBasicBlock in) {
    ...
    if (ancestorbbInfo.ancestor != null) {
      ArrayList<mod.agus.jcoderz.dx.ssa.SsaBasicBlock> worklist =
          new ArrayList<mod.agus.jcoderz.dx.ssa.SsaBasicBlock>();
      HashSet<mod.agus.jcoderz.dx.ssa.SsaBasicBlock> visited =
          new HashSet<mod.agus.jcoderz.dx.ssa.SsaBasicBlock>();
      worklist.add(in);
   ...
   */
  private void run() {
    mod.agus.jcoderz.dx.ssa.SsaBasicBlock root =
        postdom ? meth.getExitBlock() : meth.getEntryBlock();
  ...
  private class DfsWalker implements mod.agus.jcoderz.dx.ssa.SsaBasicBlock.Visitor {
    ...
    public void visitBlock(
        mod.agus.jcoderz.dx.ssa.SsaBasicBlock v, mod.agus.jcoderz.dx.ssa.SsaBasicBlock parent) {
