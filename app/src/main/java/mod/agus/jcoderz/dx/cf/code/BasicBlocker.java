...
public final class BasicBlocker implements mod.agus.jcoderz.dx.cf.code.BytecodeArray.Visitor {
      ...
      case mod.agus.jcoderz.dx.cf.code.ByteOps.IREM:
        {
           ...
           */
          visitCommon(offset, length, true);
          if ((type == mod.agus.jcoderz.dx.rop.type.Type.INT)
              || (type == mod.agus.jcoderz.dx.rop.type.Type.LONG)) {
            visitThrowing(offset, length, true);
          }
          break;
        }
  ...
  public void visitConstant(
    ...
    if (cst instanceof CstMemberRef
        || cst instanceof mod.agus.jcoderz.dx.rop.cst.CstType
  ...
  private ByteBlockList getBlockList() {
    ...
    mod.agus.jcoderz.dx.cf.code.ByteBlock[] bbs =
        new mod.agus.jcoderz.dx.cf.code.ByteBlock[bytes.size()];
    int count = 0;
