...
public final class FieldIdsSection extends MemberIdsSection {
  /**
   * {@code non-null;} map from field constants to {@link mod.agus.jcoderz.dx.dex.file.FieldIdItem}
   * instances
   */
  private final TreeMap<
          mod.agus.jcoderz.dx.rop.cst.CstFieldRef, mod.agus.jcoderz.dx.dex.file.FieldIdItem>
      fieldIds;
   ...
   */
  public synchronized mod.agus.jcoderz.dx.dex.file.FieldIdItem intern(
      mod.agus.jcoderz.dx.rop.cst.CstFieldRef field) {
    if (field == null) {
