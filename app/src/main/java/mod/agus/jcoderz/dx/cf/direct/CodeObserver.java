...
public class CodeObserver implements BytecodeArray.Visitor {
  ...
  public void visitLocal(int opcode, int offset, int length, int idx, Type type, int value) {
    String idxStr =
        (length <= 3) ? mod.agus.jcoderz.dx.util.Hex.u1(idx) : mod.agus.jcoderz.dx.util.Hex.u2(idx);
    ...
    if (opcode == mod.agus.jcoderz.dx.cf.code.ByteOps.IINC) {
      valueStr =
          ", #"
              + ((length <= 3)
                  ? mod.agus.jcoderz.dx.util.Hex.s1(value)
                  : mod.agus.jcoderz.dx.util.Hex.s2(value));
    }
  ...
  public void visitBranch(int opcode, int offset, int length, int target) {
    String targetStr =
        (length <= 3)
            ? mod.agus.jcoderz.dx.util.Hex.u2(target)
            : mod.agus.jcoderz.dx.util.Hex.u4(target);
