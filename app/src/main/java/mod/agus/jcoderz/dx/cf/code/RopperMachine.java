...
/*package*/ final class RopperMachine extends ValueAwareMachine {
  ...
  private static final mod.agus.jcoderz.dx.rop.cst.CstType ARRAY_REFLECT_TYPE =
      new mod.agus.jcoderz.dx.rop.cst.CstType(
          mod.agus.jcoderz.dx.rop.type.Type.internClassName("java/lang/reflect/Array"));
  ...
  private static final mod.agus.jcoderz.dx.rop.cst.CstMethodRef MULTIANEWARRAY_METHOD =
      new mod.agus.jcoderz.dx.rop.cst.CstMethodRef(
          ARRAY_REFLECT_TYPE,
          new CstNat(
              new mod.agus.jcoderz.dx.rop.cst.CstString("newInstance"),
  ...
  public void run(Frame frame, int offset, int opcode) {
    ...
    mod.agus.jcoderz.dx.rop.code.RegisterSpec localTarget =
        getLocalTarget(opcode == mod.agus.jcoderz.dx.cf.code.ByteOps.ISTORE);
    ...
    if (destCount == 0) {
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec[] scratchRegs =
          new mod.agus.jcoderz.dx.rop.code.RegisterSpec[sourceCount];
      ...
      for (int i = 0; i < sourceCount; i++) {
        ...
        insns.add(
            new mod.agus.jcoderz.dx.rop.code.PlainInsn(
                mod.agus.jcoderz.dx.rop.code.Rops.opMove(type), pos, scratch, src));
      ...
      for (int pattern = getAuxInt(); pattern != 0; pattern >>= 4) {
        ...
        insns.add(
            new mod.agus.jcoderz.dx.rop.code.PlainInsn(
                mod.agus.jcoderz.dx.rop.code.Rops.opMove(type),
                pos,
    ...
    mod.agus.jcoderz.dx.rop.type.TypeBearer destType =
        (dest != null) ? dest : mod.agus.jcoderz.dx.rop.type.Type.VOID;
    ...
    if (opcode == mod.agus.jcoderz.dx.cf.code.ByteOps.MULTIANEWARRAY) {
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec dimsReg =
          mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
              dest.getNextReg(), mod.agus.jcoderz.dx.rop.type.Type.INT_ARRAY);
      rop =
          mod.agus.jcoderz.dx.rop.code.Rops.opFilledNewArray(
              mod.agus.jcoderz.dx.rop.type.Type.INT_ARRAY, sourceCount);
      insn =
          new mod.agus.jcoderz.dx.rop.code.ThrowingCstInsn(
              rop, pos, sources, catches, mod.agus.jcoderz.dx.rop.cst.CstType.INT_ARRAY);
      insns.add(insn);

      // Add a move-result for the new-filled-array
      rop =
          mod.agus.jcoderz.dx.rop.code.Rops.opMoveResult(
              mod.agus.jcoderz.dx.rop.type.Type.INT_ARRAY);
      insn =
          new mod.agus.jcoderz.dx.rop.code.PlainInsn(
              rop, pos, dimsReg, mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY);
      insns.add(insn);
       ...
       */
      mod.agus.jcoderz.dx.rop.type.Type componentType =
          ((mod.agus.jcoderz.dx.rop.cst.CstType) cst).getClassType();
      for (int i = 0; i < sourceCount; i++) {
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec classReg =
          mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
              dest.getReg(), mod.agus.jcoderz.dx.rop.type.Type.CLASS);
      ...
      insn =
          new mod.agus.jcoderz.dx.rop.code.PlainInsn(
              rop, pos, classReg, mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY);
      insns.add(insn);
      ...
      mod.agus.jcoderz.dx.rop.code.RegisterSpec objectReg =
          mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(
              dest.getReg(), mod.agus.jcoderz.dx.rop.type.Type.OBJECT);

      insn =
          new mod.agus.jcoderz.dx.rop.code.ThrowingCstInsn(
              mod.agus.jcoderz.dx.rop.code.Rops.opInvokeStatic(
                  MULTIANEWARRAY_METHOD.getPrototype()),
              pos,
              mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(classReg, dimsReg),
              catches,
      ...
      rop =
          mod.agus.jcoderz.dx.rop.code.Rops.opMoveResult(
              MULTIANEWARRAY_METHOD.getPrototype().getReturnType());
      insn =
          new mod.agus.jcoderz.dx.rop.code.PlainInsn(
              rop, pos, objectReg, mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY);
      insns.add(insn);
    ...
    if (dest != null && rop.isCallLike()) {
      ...
      if (rop.getOpcode() == mod.agus.jcoderz.dx.rop.code.RegOps.INVOKE_CUSTOM) {
        ...
        returnType =
            ((mod.agus.jcoderz.dx.rop.cst.CstMethodRef) cst).getPrototype().getReturnType();
      }
      moveResult =
          new mod.agus.jcoderz.dx.rop.code.PlainInsn(
              mod.agus.jcoderz.dx.rop.code.Rops.opMoveResult(returnType),
              pos,
              dest,
              mod.agus.jcoderz.dx.rop.code.RegisterSpecList.EMPTY);
      ...
      if ((lastType.isConstant() || firstType.isConstant())
        ...
        if (lastType.isConstant()) {
          ...
          if (rop.getOpcode() == mod.agus.jcoderz.dx.rop.code.RegOps.SUB) {
            ...
            mod.agus.jcoderz.dx.rop.cst.CstInteger cstInt =
                (mod.agus.jcoderz.dx.rop.cst.CstInteger) lastType;
    ...
    if (initValues != null) {
      ...
      insn =
          new FillArrayDataInsn(
              ...
              pos,
              mod.agus.jcoderz.dx.rop.code.RegisterSpecList.make(moveResult.getResult()),
              initValues,
              cst);
      insns.add(insn);
    }
    ...
    if (localIndex >= 0) {
      ...
      for (int i = 0; i < count; i++) {
        mod.agus.jcoderz.dx.rop.code.RegisterSpec spec =
            mod.agus.jcoderz.dx.rop.code.RegisterSpec.make(regAt, arg(i));
        sources.set(i, spec);
   ...
   */
  private void updateReturnOp(
      mod.agus.jcoderz.dx.rop.code.Rop op, mod.agus.jcoderz.dx.rop.code.SourcePosition pos) {
    if (op == null) {
  ...
  private int jopToRopOpcode(int jop, mod.agus.jcoderz.dx.rop.cst.Constant cst) {
    switch (jop) {
      ...
      case mod.agus.jcoderz.dx.cf.code.ByteOps.INVOKEVIRTUAL:
        {
          mod.agus.jcoderz.dx.rop.cst.CstMethodRef ref =
