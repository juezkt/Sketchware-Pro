...
/**
 * A section of a {@code .dex} file which consists of a sequence of {@link
 * mod.agus.jcoderz.dx.dex.file.OffsettedItem} objects, which may each be of a different concrete
 * class and/or size.
 *
...
public final class MixedItemSection extends Section {
  ...
  private static final Comparator<mod.agus.jcoderz.dx.dex.file.OffsettedItem> TYPE_SORTER =
      new Comparator<mod.agus.jcoderz.dx.dex.file.OffsettedItem>() {
        @Override
        public int compare(
            mod.agus.jcoderz.dx.dex.file.OffsettedItem item1,
            mod.agus.jcoderz.dx.dex.file.OffsettedItem item2) {
  ...
  private final HashMap<
          mod.agus.jcoderz.dx.dex.file.OffsettedItem, mod.agus.jcoderz.dx.dex.file.OffsettedItem>
      interns;
   ...
   */
  public MixedItemSection(
      String name, mod.agus.jcoderz.dx.dex.file.DexFile file, int alignment, SortType sort) {
  ...
  public int getAbsoluteItemOffset(Item item) {
    mod.agus.jcoderz.dx.dex.file.OffsettedItem oi =
        (mod.agus.jcoderz.dx.dex.file.OffsettedItem) item;
   ...
   * mod.agus.jcoderz.dx.dex.file.OffsettedItem#place} on each item. If an item does not know its
   * write size before the call to {@code place}, it is that call which is responsible for setting
   * the write size. This method may only be called once per instance; subsequent calls will throw
   * an exception.
   */
