...
public final class TypeIdsSection extends UniformItemSection {
   ...
   */
  private final TreeMap<mod.agus.jcoderz.dx.rop.type.Type, mod.agus.jcoderz.dx.dex.file.TypeIdItem>
      typeIds;
  ...
  public TypeIdsSection(DexFile file) {
    ...
    typeIds =
        new TreeMap<mod.agus.jcoderz.dx.rop.type.Type, mod.agus.jcoderz.dx.dex.file.TypeIdItem>();
  }
   ...
   */
  public synchronized mod.agus.jcoderz.dx.dex.file.TypeIdItem intern(
      mod.agus.jcoderz.dx.rop.type.Type type) {
    if (type == null) {
    ...
    if (result == null) {
      result =
          new mod.agus.jcoderz.dx.dex.file.TypeIdItem(
              new mod.agus.jcoderz.dx.rop.cst.CstType(type));
