...
public final class DebugInfoEncoder {
  ...
  public DebugInfoEncoder(
      mod.agus.jcoderz.dx.dex.code.PositionList positions,
      mod.agus.jcoderz.dx.dex.code.LocalList locals,
      DexFile file,
      int codeSize,
      int regSize,
      boolean isStatic,
  ...
  private void emitHeader(
      ArrayList<mod.agus.jcoderz.dx.dex.code.PositionList.Entry> sortedPositions,
      ArrayList<mod.agus.jcoderz.dx.dex.code.LocalList.Entry> methodArgs)
      throws IOException {
      ...
      if (annotate) {
        ...
        annotate(
            ...
            "parameter "
                + parameterName
                + " "
                + mod.agus.jcoderz.dx.rop.code.RegisterSpec.PREFIX
                + curParam);
      }
  ...
  private ArrayList<mod.agus.jcoderz.dx.dex.code.PositionList.Entry> buildSortedPositions() {
    ...
    Collections.sort(
        result,
        new Comparator<mod.agus.jcoderz.dx.dex.code.PositionList.Entry>() {
          @Override
          public int compare(
              mod.agus.jcoderz.dx.dex.code.PositionList.Entry a,
              mod.agus.jcoderz.dx.dex.code.PositionList.Entry b) {
  ...
  private ArrayList<mod.agus.jcoderz.dx.dex.code.LocalList.Entry> extractMethodArguments() {
    ...
    Collections.sort(
        result,
        new Comparator<mod.agus.jcoderz.dx.dex.code.LocalList.Entry>() {
          @Override
          public int compare(
              mod.agus.jcoderz.dx.dex.code.LocalList.Entry a,
              mod.agus.jcoderz.dx.dex.code.LocalList.Entry b) {
  ...
  /**
   * Emits a {@link mod.agus.jcoderz.dx.dex.file.DebugInfoConstants#DBG_RESTART_LOCAL
   * DBG_RESTART_LOCAL} sequence.
   *
  ...
  /**
   * Emits a {@link mod.agus.jcoderz.dx.dex.file.DebugInfoConstants#DBG_START_LOCAL DBG_START_LOCAL}
   * or {@link mod.agus.jcoderz.dx.dex.file.DebugInfoConstants#DBG_START_LOCAL_EXTENDED
  ...
  /**
   * Emits a {@link mod.agus.jcoderz.dx.dex.file.DebugInfoConstants#DBG_END_LOCAL DBG_END_LOCAL}
   * sequence.
   *
  ...
  /**
   * Emits an {@link mod.agus.jcoderz.dx.dex.file.DebugInfoConstants#DBG_ADVANCE_LINE
   * DBG_ADVANCE_LINE} sequence.
   *
