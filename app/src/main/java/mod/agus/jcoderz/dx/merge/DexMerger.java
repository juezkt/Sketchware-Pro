...
public final class DexMerger {
  ...
  public DexMerger(
      ...
      mod.agus.jcoderz.dx.command.dexer.DxContext context)
      throws IOException {
  ...
  abstract class IdMerger<T extends Comparable<T>> {
    ...
    private List<UnsortedValue> readUnsortedValues(
        Dex source, mod.agus.jcoderz.dx.merge.IndexMap indexMap) {
    ...
    abstract void updateIndex(
        int offset, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int oldIndex, int newIndex);
    ...
    class UnsortedValue implements Comparable<UnsortedValue> {
      ...
      UnsortedValue(
          Dex source, mod.agus.jcoderz.dx.merge.IndexMap indexMap, T value, int index, int offset) {
        this.source = source;
  ...
  private void mergeStringIds() {
    new IdMerger<String>(idsDefsOut) {
      ...
      @Override
      String read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void mergeTypeIds() {
    new IdMerger<Integer>(idsDefsOut) {
      ...
      @Override
      Integer read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void mergeTypeLists() {
    new IdMerger<TypeList>(typeListOut) {
      ...
      @Override
      TypeList read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void mergeProtoIds() {
    new IdMerger<ProtoId>(idsDefsOut) {
      ...
      @Override
      ProtoId read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void mergeFieldIds() {
    new IdMerger<FieldId>(idsDefsOut) {
      ...
      @Override
      FieldId read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void mergeMethodIds() {
    new IdMerger<MethodId>(idsDefsOut) {
      ...
      @Override
      MethodId read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void mergeAnnotations() {
    new IdMerger<Annotation>(annotationOut) {
      ...
      @Override
      Annotation read(Dex.Section in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, int index) {
  ...
  private void readSortableTypes(
      SortableType[] sortableTypes, Dex buffer, mod.agus.jcoderz.dx.merge.IndexMap indexMap) {
  ...
  private void transformClassDef(
      Dex in, ClassDef classDef, mod.agus.jcoderz.dx.merge.IndexMap indexMap) {
  ...
  private void transformAnnotationSet(
      mod.agus.jcoderz.dx.merge.IndexMap indexMap, Dex.Section setIn) {
  ...
  private void transformAnnotationSetRefList(
      mod.agus.jcoderz.dx.merge.IndexMap indexMap, Dex.Section refListIn) {
  ...
  private void transformClassData(
      Dex in, ClassData classData, mod.agus.jcoderz.dx.merge.IndexMap indexMap) {
  ...
  private void transformFields(
      mod.agus.jcoderz.dx.merge.IndexMap indexMap, ClassData.Field[] fields) {
  ...
  private void transformMethods(
      Dex in, mod.agus.jcoderz.dx.merge.IndexMap indexMap, ClassData.Method[] methods) {
  ...
  private int[] transformCatchHandlers(
      mod.agus.jcoderz.dx.merge.IndexMap indexMap, Code.CatchHandler[] catchHandlers) {
  ...
  private void transformEncodedCatchHandler(
      Code.CatchHandler catchHandler, mod.agus.jcoderz.dx.merge.IndexMap indexMap) {
