...
/*package*/ class AttributeTranslator {
   ...
   */
  public static mod.agus.jcoderz.dx.rop.type.TypeList getExceptions(
      mod.agus.jcoderz.dx.cf.iface.Method method) {
    mod.agus.jcoderz.dx.cf.iface.AttributeList attribs = method.getAttributes();
    mod.agus.jcoderz.dx.cf.attrib.AttExceptions exceptions =
        (mod.agus.jcoderz.dx.cf.attrib.AttExceptions)
   ...
   * combines both visible and invisible annotations into a single result set and also adds in a
   * system annotation for the {@code Signature} attribute if present.
   *
   * @param attribs {@code non-null;} the attributes list to search in
   * @return {@code non-null;} the set of annotations, which may be empty
   */
  public static mod.agus.jcoderz.dx.rop.annotation.Annotations getAnnotations(
      mod.agus.jcoderz.dx.cf.iface.AttributeList attribs) {
    ...
    mod.agus.jcoderz.dx.rop.annotation.Annotation sourceDebugExtension =
        getSourceDebugExtension(attribs);
   ...
   * @return {@code non-null;} the set of annotations, which may be empty
   */
  public static mod.agus.jcoderz.dx.rop.annotation.Annotations getClassAnnotations(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf, CfOptions args) {
    ...
    mod.agus.jcoderz.dx.rop.annotation.Annotation enclosingMethod =
        translateEnclosingMethod(attribs);
    ...
    try {
      ...
      if (innerClassAnnotations != null) {
        result =
            mod.agus.jcoderz.dx.rop.annotation.Annotations.combine(result, innerClassAnnotations);
      }
   ...
   * @return {@code non-null;} the set of annotations, which may be empty
   */
  public static mod.agus.jcoderz.dx.rop.annotation.Annotations getMethodAnnotations(
      mod.agus.jcoderz.dx.cf.iface.Method method) {
   ...
   * @return {@code non-null;} the set of annotations, which may be empty
   */
  private static mod.agus.jcoderz.dx.rop.annotation.Annotations getAnnotations0(
      mod.agus.jcoderz.dx.cf.iface.AttributeList attribs) {
    ...
    return mod.agus.jcoderz.dx.rop.annotation.Annotations.combine(
        visible.getAnnotations(), invisible.getAnnotations());
  }

  /**
   * Gets the {@code Signature} attribute out of a given {@link
   * mod.agus.jcoderz.dx.cf.iface.AttributeList}, if any, translating it to an annotation.
   *
   * @param attribs {@code non-null;} the attributes list to search in
   * @return {@code null-ok;} the converted {@code Signature} annotation, if there was an attribute
   *     to translate
   */
  private static mod.agus.jcoderz.dx.rop.annotation.Annotation getSignature(
      mod.agus.jcoderz.dx.cf.iface.AttributeList attribs) {
    mod.agus.jcoderz.dx.cf.attrib.AttSignature signature =
        (mod.agus.jcoderz.dx.cf.attrib.AttSignature) attribs.findFirst(AttSignature.ATTRIBUTE_NAME);
  ...
  private static mod.agus.jcoderz.dx.rop.annotation.Annotation getSourceDebugExtension(
      mod.agus.jcoderz.dx.cf.iface.AttributeList attribs) {
    mod.agus.jcoderz.dx.cf.attrib.AttSourceDebugExtension extension =
        (mod.agus.jcoderz.dx.cf.attrib.AttSourceDebugExtension)
  ...
  /**
   * Gets the {@code EnclosingMethod} attribute out of a given {@link
   * mod.agus.jcoderz.dx.cf.iface.AttributeList}, if any, translating it to an annotation. If the
   * class really has an enclosing method, this returns an {@code EnclosingMethod} annotation; if
   * not, this returns an {@code EnclosingClass} annotation.
   *
   * @param attribs {@code non-null;} the attributes list to search in
   ...
   */
  private static mod.agus.jcoderz.dx.rop.annotation.Annotation translateEnclosingMethod(
      mod.agus.jcoderz.dx.cf.iface.AttributeList attribs) {
    mod.agus.jcoderz.dx.cf.attrib.AttEnclosingMethod enclosingMethod =
        (mod.agus.jcoderz.dx.cf.attrib.AttEnclosingMethod)
  ...
  /**
   * Gets the {@code InnerClasses} attribute out of a given {@link
   * mod.agus.jcoderz.dx.cf.iface.AttributeList}, if any, translating it to one or more of an {@code
   * InnerClass}, {@code EnclosingClass}, or {@code MemberClasses} annotation.
   *
   ...
   *     translate
   */
  private static mod.agus.jcoderz.dx.rop.annotation.Annotations translateInnerClasses(
      mod.agus.jcoderz.dx.rop.cst.CstType thisClass,
      mod.agus.jcoderz.dx.cf.iface.AttributeList attribs,
      boolean needEnclosingClass) {
    mod.agus.jcoderz.dx.cf.attrib.AttInnerClasses innerClasses =
        (mod.agus.jcoderz.dx.cf.attrib.AttInnerClasses)
   ...
   */
  public static mod.agus.jcoderz.dx.rop.annotation.AnnotationsList getParameterAnnotations(
      mod.agus.jcoderz.dx.cf.iface.Method method) {
    mod.agus.jcoderz.dx.cf.iface.AttributeList attribs = method.getAttributes();
   ...
   */
  private static mod.agus.jcoderz.dx.rop.annotation.Annotation translateAnnotationDefaults(
      DirectClassFile cf) {
    ...
    for (int i = 0; i < sz; i++) {
      ...
      mod.agus.jcoderz.dx.cf.attrib.AttAnnotationDefault oneDefault =
          (mod.agus.jcoderz.dx.cf.attrib.AttAnnotationDefault)
              attribs.findFirst(AttAnnotationDefault.ATTRIBUTE_NAME);

      if (oneDefault != null) {
        mod.agus.jcoderz.dx.rop.annotation.NameValuePair pair =
            new NameValuePair(one.getNat().getName(), oneDefault.getValue());
        result.add(pair);
        any = true;
      }
    }
