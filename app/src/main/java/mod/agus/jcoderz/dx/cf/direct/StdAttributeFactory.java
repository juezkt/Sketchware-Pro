...
/**
 * Standard subclass of {@link mod.agus.jcoderz.dx.cf.direct.AttributeFactory}, which knows how to
 * parse all the standard attribute types.
 */
public class StdAttributeFactory extends AttributeFactory {
  ...
  /** {@inheritDoc} */
  @Override
  protected mod.agus.jcoderz.dx.cf.iface.Attribute parse0(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int context,
      String name,
      int offset,
      int length,
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute annotationDefault(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute bootstrapMethods(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    if (observer != null) {
      observer.parsed(
          bytes, offset, 2, "num_boostrap_methods: " + mod.agus.jcoderz.dx.util.Hex.u2(numMethods));
    }

    offset += 2;
    length -= 2;

    mod.agus.jcoderz.dx.cf.code.BootstrapMethodsList methods =
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute code(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    if (observer != null) {
      observer.parsed(bytes, offset, 2, "max_stack: " + mod.agus.jcoderz.dx.util.Hex.u2(maxStack));
      observer.parsed(
          bytes, offset + 2, 2, "max_locals: " + mod.agus.jcoderz.dx.util.Hex.u2(maxLocals));
      observer.parsed(
          bytes, offset + 4, 4, "code_length: " + mod.agus.jcoderz.dx.util.Hex.u4(codeLength));
    }
    ...
    mod.agus.jcoderz.dx.cf.code.BytecodeArray code =
        new BytecodeArray(bytes.slice(codeOffset, codeOffset + codeLength), pool);
    if (observer != null) {
    ...
    mod.agus.jcoderz.dx.cf.code.ByteCatchList catches =
    ...
    if (observer != null) {
      observer.parsed(
          ...
          offset,
          2,
          "exception_table_length: " + mod.agus.jcoderz.dx.util.Hex.u2(exceptionTableLength));
    }
    ...
    for (int i = 0; i < exceptionTableLength; i++) {
      ...
      mod.agus.jcoderz.dx.rop.cst.CstType catchType =
          (mod.agus.jcoderz.dx.rop.cst.CstType) pool.get0Ok(catchTypeIdx);
      ...
      if (observer != null) {
        observer.parsed(
            ...
            offset,
            8,
            mod.agus.jcoderz.dx.util.Hex.u2(startPc)
                + ".."
                + mod.agus.jcoderz.dx.util.Hex.u2(endPc)
                + " -> "
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute constantValue(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute deprecated(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute enclosingMethod(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    if (observer != null) {
      ...
      observer.parsed(
          ...
          offset + 2,
          2,
          "method: " + mod.agus.jcoderz.dx.cf.direct.DirectClassFile.stringOrNone(method));
    }
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute exceptions(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    if (observer != null) {
      observer.parsed(
          bytes, offset, 2, "number_of_exceptions: " + mod.agus.jcoderz.dx.util.Hex.u2(count));
    }
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute innerClasses(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    if (observer != null) {
      observer.parsed(
          bytes, offset, 2, "number_of_classes: " + mod.agus.jcoderz.dx.util.Hex.u2(count));
    }
    ...
    for (int i = 0; i < count; i++) {
      ...
      mod.agus.jcoderz.dx.rop.cst.CstType innerClass =
          (mod.agus.jcoderz.dx.rop.cst.CstType) pool.get(innerClassIdx);
      mod.agus.jcoderz.dx.rop.cst.CstType outerClass =
          (mod.agus.jcoderz.dx.rop.cst.CstType) pool.get0Ok(outerClassIdx);
      mod.agus.jcoderz.dx.rop.cst.CstString name =
          (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get0Ok(nameIdx);
      ...
      if (observer != null) {
        ...
        observer.parsed(
            ...
            offset + 4,
            2,
            "  name: " + mod.agus.jcoderz.dx.cf.direct.DirectClassFile.stringOrNone(name));
        observer.parsed(
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute lineNumberTable(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    if (observer != null) {
      observer.parsed(
          bytes, offset, 2, "line_number_table_length: " + mod.agus.jcoderz.dx.util.Hex.u2(count));
    }
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (observer != null) {
        observer.parsed(
            bytes, offset, 4, mod.agus.jcoderz.dx.util.Hex.u2(startPc) + " " + lineNumber);
      }
      offset += 4;
    }
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute localVariableTable(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    mod.agus.jcoderz.dx.cf.code.LocalVariableList list =
        parseLocalVariables(
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute localVariableTypeTable(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
   ...
   */
  private mod.agus.jcoderz.dx.cf.code.LocalVariableList parseLocalVariables(
      mod.agus.jcoderz.dx.util.ByteArray bytes,
    ...
    try {
      for (int i = 0; i < count; i++) {
        ...
        mod.agus.jcoderz.dx.rop.cst.CstString name =
            (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(nameIdx);
        mod.agus.jcoderz.dx.rop.cst.CstString type =
            (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(typeIdx);
        ...
        if (observer != null) {
          observer.parsed(
              ...
              mod.agus.jcoderz.dx.util.Hex.u2(startPc)
                  ...
                  + " "
                  + mod.agus.jcoderz.dx.util.Hex.u2(index)
                  + " "
                  + name.toHuman()
                  + " "
                  + type.toHuman());
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute runtimeInvisibleAnnotations(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute runtimeVisibleAnnotations(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    Annotations annotations =
        ap.parseAnnotationAttribute(
            mod.agus.jcoderz.dx.rop.annotation.AnnotationVisibility.RUNTIME);

    return new AttRuntimeVisibleAnnotations(annotations, length);
  }

  /** Parses a {@code RuntimeInvisibleParameterAnnotations} attribute. */
  private mod.agus.jcoderz.dx.cf.iface.Attribute runtimeInvisibleParameterAnnotations(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute runtimeVisibleParameterAnnotations(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute signature(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    ...
    mod.agus.jcoderz.dx.rop.cst.ConstantPool pool = cf.getConstantPool();
    int idx = bytes.getUnsignedShort(offset);
    mod.agus.jcoderz.dx.rop.cst.CstString cst =
        (mod.agus.jcoderz.dx.rop.cst.CstString) pool.get(idx);
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute sourceDebugExtension(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
    mod.agus.jcoderz.dx.util.ByteArray bytes = cf.getBytes().slice(offset, offset + length);
    mod.agus.jcoderz.dx.rop.cst.CstString smapString =
        new mod.agus.jcoderz.dx.rop.cst.CstString(bytes);
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute sourceFile(
      mod.agus.jcoderz.dx.cf.direct.DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private mod.agus.jcoderz.dx.cf.iface.Attribute synthetic(
      DirectClassFile cf,
      int offset,
      int length,
      mod.agus.jcoderz.dx.cf.iface.ParseObserver observer) {
  ...
  private static Attribute throwBadLength(int expected) {
    throw new mod.agus.jcoderz.dx.cf.iface.ParseException(
        "bad attribute length; expected length " + mod.agus.jcoderz.dx.util.Hex.u4(expected));
  }

  private mod.agus.jcoderz.dx.cf.code.BootstrapMethodsList parseBootstrapMethods(
      ByteArray bytes,
    ...
    for (int methodIndex = 0; methodIndex < numMethods; ++methodIndex) {
      ...
      if (observer != null) {
        observer.parsed(
            ...
            offset,
            2,
            "bootstrap_method_ref: " + mod.agus.jcoderz.dx.util.Hex.u2(methodRef));
        observer.parsed(
            bytes,
            offset + 2,
            2,
      ...
      mod.agus.jcoderz.dx.cf.code.BootstrapMethodArgumentsList arguments =
          new BootstrapMethodArgumentsList(numArguments);
