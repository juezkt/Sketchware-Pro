...
public class Main {
  ...
  private mod.agus.jcoderz.dx.dex.file.ClassDefItem translateClass(
      byte[] bytes, DirectClassFile cf) {
    try {
  ...
  public static class Arguments {
    ...
    /**
     * Produce the smallest possible main dex. Ignored unless multiDex is true and mainDexListFile
  ...
  private class DirectClassFileConsumer implements Callable<Boolean> {
    ...
    private Boolean call(DirectClassFile cf) {
      ...
      Future<mod.agus.jcoderz.dx.dex.file.ClassDefItem> cdif =
