...
public class SCCP {
   ...
   */
  private mod.agus.jcoderz.dx.rop.cst.Constant simulateMath(
      mod.agus.jcoderz.dx.ssa.SsaInsn insn, int resultType) {
  ...
  private void simulateStmt(mod.agus.jcoderz.dx.ssa.SsaInsn insn) {
    ...
    if (result == null) {
      ...
      if (opcode == mod.agus.jcoderz.dx.rop.code.RegOps.DIV
          || opcode == mod.agus.jcoderz.dx.rop.code.RegOps.REM) {
