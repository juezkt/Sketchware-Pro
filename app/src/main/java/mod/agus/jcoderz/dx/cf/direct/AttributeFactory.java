...
/**
 * Factory capable of instantiating various {@link mod.agus.jcoderz.dx.cf.iface.Attribute}
 * subclasses depending on the context and name.
 */
public class AttributeFactory {
   ...
   * @return {@code non-null;} an appropriately-constructed {@link
   *     mod.agus.jcoderz.dx.cf.iface.Attribute}
   */
  public final mod.agus.jcoderz.dx.cf.iface.Attribute parse(
      DirectClassFile cf,
      int context,
      int offset,
    ...
    mod.agus.jcoderz.dx.rop.cst.CstString name = null;
    ...
    try {
      ...
      if (observer != null) {
        ...
        observer.parsed(bytes, offset + 2, 4, "length: " + mod.agus.jcoderz.dx.util.Hex.u4(length));
      }
   ...
   * mod.agus.jcoderz.dx.cf.attrib.RawAttribute}. Subclasses are expected to override this to do
   * something better in most cases.
   *
   * @param cf {@code non-null;} class file to parse from
   * @param context context to parse in; one of the {@code CTX_*} constants
