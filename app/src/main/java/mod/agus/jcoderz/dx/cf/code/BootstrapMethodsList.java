...
/**
 * List of bootstrap method entries, which are the contents of {@code BootstrapMethods} attributes.
 */
public class BootstrapMethodsList extends FixedSizeList {
  ...
  public void set(
      int n,
      mod.agus.jcoderz.dx.rop.cst.CstType declaringClass,
      mod.agus.jcoderz.dx.rop.cst.CstMethodHandle bootstrapMethodHandle,
  ...
  public static class Item {
    ...
    private final mod.agus.jcoderz.dx.rop.cst.CstMethodHandle bootstrapMethodHandle;
    private final mod.agus.jcoderz.dx.rop.cst.CstType declaringClass;
