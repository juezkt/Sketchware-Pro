...
public class InvokePolymorphicInsn extends mod.agus.jcoderz.dx.rop.code.Insn {
  ...
  private static mod.agus.jcoderz.dx.rop.cst.CstMethodRef makePolymorphicMethod(
      final mod.agus.jcoderz.dx.rop.cst.CstMethodRef callSiteMethod) {
    ...
    if (definingClass.equals(mod.agus.jcoderz.dx.rop.cst.CstType.METHOD_HANDLE)) {
      if (methodName.equals("invoke") || methodName.equals("invokeExact")) {
        mod.agus.jcoderz.dx.rop.cst.CstNat cstNat =
            new mod.agus.jcoderz.dx.rop.cst.CstNat(cstMethodName, DEFAULT_DESCRIPTOR);
    ...
    if (definingClass.equals(CstType.VAR_HANDLE)) {
      switch (methodName) {
        ...
        case "setVolatile":
          {
            mod.agus.jcoderz.dx.rop.cst.CstNat cstNat =
                new mod.agus.jcoderz.dx.rop.cst.CstNat(cstMethodName, VARHANDLE_SET_DESCRIPTOR);
            return new mod.agus.jcoderz.dx.rop.cst.CstMethodRef(definingClass, cstNat);
          }
        case "compareAndSet":
        ...
        case "weakCompareAndSetRelease":
          {
            mod.agus.jcoderz.dx.rop.cst.CstNat cstNat =
                new CstNat(cstMethodName, VARHANDLE_COMPARE_AND_SET_DESCRIPTOR);
            return new mod.agus.jcoderz.dx.rop.cst.CstMethodRef(definingClass, cstNat);
          }
        default:
          break;
  ...
  private static mod.agus.jcoderz.dx.rop.cst.CstProtoRef makeCallSiteProto(
      final CstMethodRef callSiteMethod) {
