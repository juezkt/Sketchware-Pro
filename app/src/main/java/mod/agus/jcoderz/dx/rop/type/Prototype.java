...
public final class Prototype implements Comparable<Prototype> {
  ...
  public static Prototype fromDescriptor(String descriptor) {
    ...
    mod.agus.jcoderz.dx.rop.type.Type returnType =
        mod.agus.jcoderz.dx.rop.type.Type.internReturnType(descriptor.substring(at));
    mod.agus.jcoderz.dx.rop.type.StdTypeList parameterTypes =
        new mod.agus.jcoderz.dx.rop.type.StdTypeList(paramCount);
  ...
  public static Prototype intern(
      String descriptor,
      mod.agus.jcoderz.dx.rop.type.Type definer,
      boolean isStatic,
      boolean isInit) {
   ...
   * between the two lists (if any) is that all "intlike" types (see {@link
   * mod.agus.jcoderz.dx.rop.type.Type#isIntlike}) are replaced by {@link
  ...
  public mod.agus.jcoderz.dx.rop.type.StdTypeList getParameterFrameTypes() {
    if (parameterFrameTypes == null) {
      ...
      mod.agus.jcoderz.dx.rop.type.StdTypeList list =
          new mod.agus.jcoderz.dx.rop.type.StdTypeList(sz);
      boolean any = false;
      for (int i = 0; i < sz; i++) {
