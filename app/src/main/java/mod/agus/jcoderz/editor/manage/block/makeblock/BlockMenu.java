...
/**
 * Helper used in {@link com.besome.sketch.editor.LogicEditorActivity} to get menus for custom Menus
 * defined in {@link mod.hilal.saif.activities.tools.BlockSelectorActivity}.
 */
      ...
      try {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
          ...
          if (jSONObject.getString("name").equals(name)) {
            result =
                new Pair<>(
                    jSONObject.getString("title"), jsonarrayToArr(jSONObject.getJSONArray("data")));
            break;
          }
        }
