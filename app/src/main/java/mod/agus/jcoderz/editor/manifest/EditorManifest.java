...
/**
 * A helper class to add various elements to AndroidManifest.xml if components have been added, for
 * example the OneSignal component.
 */
public class EditorManifest {
  ...
  public static void writeDefFCM(XmlBuilder applicationTag) {
    ...
    firebaseMessagingServiceTag.addAttribute(
    ...
    firebaseInstanceIdReceiverTag.addAttribute(
  ...
  public static void manifestOneSignal(
      XmlBuilder applicationTag, String packageName, HashMap<String, ArrayList<String>> hashMap) {
    if (!hashMap.isEmpty()) {
    ...
    notificationOpenedReceiverTag.addAttribute(
    ...
    gcmIntentJobServiceTag.addAttribute(
    ...
    notificationRestoreServiceTag.addAttribute(
    ...
    upgradeReceiverIntentFilterActionTag.addAttribute(
