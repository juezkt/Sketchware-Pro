...
public class ManageEvent {
  ...
  public static int d(String str) {
    return switch (str) {
      ...
      case "onPatternLockCleared",
              "onPatternLockProgress",
              "onPatternLockStarted",
              "onPatternLockComplete" ->
          R.drawable.ic_mtrl_pattern;
  ...
  public static String e(String eventName) {
    return switch (eventName) {
      ...
      case "onUpdateProfileComplete",
              ...
              "onDateChanged",
              "onDeleteUserComplete",
              "onNavigationItemSelected",
              "onDateSet",
              "onCompletion",
              "onPatternLockCleared",
              "onQueryTextChanged",
              "onUpdateEmailComplete",
              "onError",
              "onPageScrolled",
  ...
  public static String f(String targetId, String eventName, String eventLogic) {
    ...
    final String setAdFullScreenContentCallback =
        targetId.isEmpty()
            ? "\r\n"
            : targetId
                + " = _param1;\r\n"
                + targetId
                + ".setFullScreenContentCallback(_"
                + targetId
    ...
    return switch (eventName) {
      ...
      case "onScrolled" ->
          "@Override\r\n"
              + "public void onScroll(AbsListView abs, int _firstVisibleItem, int"
              + " _visibleItemCount, int _totalItemCount) {\r\n"
              + eventLogic
              + "\r\n"
              + "}";
      case "onDateChanged" ->
      ...
      case "onSuccessLink" ->
          "@Override\r\n"
              ...
              + "final String _link = _pendingDynamicLinkData != null ?"
              + " _pendingDynamicLinkData.getLink().toString() : \"\";\r\n"
              + eventLogic
              + "\r\n"
              + "}";
      case "onPatternLockCleared" ->
      ...
      case "onPageScrolled" ->
          "@Override\r\n"
              + "public void onPageScrolled(int _position, float _positionOffset, int"
              + " _positionOffsetPixels) {\r\n"
              + eventLogic
              + "\r\n"
              + "}";
      ...
      case "onQueryTextSubmit" ->
          "@Override\r\n"
              ...
              + "return true;\r\n"
              + "}";
      case "FBAdsBanner_onError", "FBAdsInterstitial_onError" ->
          "@Override\r\n"
              + "public void onError(Ad ad, AdError adError) {\r\n"
              + "final String _errorMsg = adError.getErrorMessage() != null ?"
      ...
      case "onCodeSent" ->
          "@Override\r\n"
              ...
              + " PhoneAuthProvider.ForceResendingToken _token) {\r\n"
              + eventLogic
              + "\r\n"
              + "}";
      case "onTimeChanged" ->
  ...
  /**
   * @return Code of extra listeners, used in {@link a.a.a.Lx#getListenerCode(String, String,
   *     String)}
   */
  public static String g(String listenerName, String targetId, String listenerLogic) {
    return switch (listenerName) {
      ...
      case "authsignInWithPhoneAuth" ->
          targetId
              + "_phoneAuthListener = new OnCompleteListener<AuthResult>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "FragmentStatePagerAdapter" -> {
        ...
        yield "public class "
            ...
            + "public "
            + className
            + "(Context context, FragmentManager manager) {\r\n"
            + "super(manager);\r\n"
      ...
      case "OnTimeSetListener" ->
          targetId
              + "_listener = new TimePickerDialog.OnTimeSetListener() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "OnFailureListener" ->
          targetId
              + "_onFailureLink = new OnFailureListener() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "authUpdatePasswordComplete" ->
          targetId
              + "_updatePasswordListener = new OnCompleteListener<Void>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "OnSuccessListener" ->
          targetId
              + "_onSuccessLink = new OnSuccessListener<PendingDynamicLinkData>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "OnGridItemClickListener" ->
      ...
      case "authDeleteUserComplete" ->
          targetId
              + "_deleteUserListener = new OnCompleteListener<Void>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "authUpdateProfileComplete" ->
          targetId
              + "_updateProfileListener = new OnCompleteListener<Void>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "OnPageChangeListener" ->
      ...
      case "authEmailVerificationSent" ->
          targetId
              + "_emailVerificationSentListener = new OnCompleteListener<Void>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "authUpdateEmailComplete" ->
          targetId
              + "_updateEmailListener = new OnCompleteListener<Void>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "OnPreparedListener" ->
      ...
      case "OnLetterSelectedListener" ->
          targetId
              + ".setOnLetterSelectedListener(new WaveSideBar.OnLetterSelectedListener() {\r\n"
              + listenerLogic
              + "\r\n"
              + "});";
      case "FBAdsInterstitial_InterstitialAdListener" ->
      ...
      case "OnDateChangeListener" ->
          "Calendar _calendar = Calendar.getInstance();\r\n"
              + targetId
              + ".init(_calendar.get(Calendar.YEAR), _calendar.get(Calendar.MONTH), "
      ...
      case "OnCompleteListenerFCM" ->
          targetId
              + "_onCompleteListener = new OnCompleteListener<InstanceIdResult>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "PatternLockViewListener" ->
          targetId
              + ".addPatternLockListener(new PatternLockViewListener() {\r\n"
              + listenerLogic
              + "\r\n"
              + "});";
      case "FBAdsBanner_AdListener" ->
          targetId + "_AdListener = new AdListener() {\r\n" + listenerLogic + "\r\n" + "};";
      case "OnGridItemLongClickListener" ->
          targetId
      ...
      case "googleSignInListener" ->
          targetId
              + "_googleSignInListener = new OnCompleteListener<AuthResult>() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "interstitialAdLoadCallback" ->
          "_"
              + targetId
              + "_interstitial_ad_load_callback = new InterstitialAdLoadCallback() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "fullScreenContentCallback" ->
          "_"
              + targetId
              + "_full_screen_content_callback = new FullScreenContentCallback() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "bannerAdViewListener" ->
          targetId + ".setAdListener(new AdListener() {\r\n" + listenerLogic + "\r\n" + "});";
      case "rewardedAdLoadCallback" ->
          "_"
              + targetId
              + "_rewarded_ad_load_callback = new RewardedAdLoadCallback() {\r\n"
              + listenerLogic
              + "\r\n"
              + "};";
      case "onUserEarnedRewardListener" ->
          "_"
              + targetId
              + "_on_user_earned_reward_listener = new OnUserEarnedRewardListener() {\r\n"
  ...
  public static String h(String eventName) {
    return switch (eventName) {
      ...
      case "onTabSelected", "onTabReselected", "onTabAdded", "onTabUnselected", "onFragmentAdded" ->
          "%d.position";
    ...
    return switch (eventName) {
      ...
      case "onScrolled" ->
          "When "
              ...
              + " "
              + eventName
              + " %d.firstVisibleItem %d.visibleItemCount %d.totalItemCount";
      ...
      case "onPageScrolled" ->
          "When "
              ...
              + " "
              + eventName
              + " %d.position %d.positionOffset %d.positionOffsetPixels";
      ...
      case "FBAdsBanner_onAdClicked",
              "FBAdsBanner_onAdLoaded",
              "FBAdsBanner_onLoggingImpression",
              "FBAdsInterstitial_onAdClicked",
              "FBAdsInterstitial_onAdLoaded",
              "FBAdsInterstitial_onLoggingImpression",
      ...
      case "FBAdsInterstitial_onError", "FBAdsBanner_onError" -> targetId + ": onError %s.errorMsg";
      ...
      case "onUserEarnedReward" -> targetId + ": " + eventName + " %d.rewardAmount %s.rewardType";
      case "onInterstitialAdLoaded", "onBannerAdLoaded" -> targetId + ": onAdLoaded";
      case "onAdDismissedFullScreenContent", "onAdShowedFullScreenContent", "onRewardAdLoaded" ->
          targetId + ": " + eventName;
