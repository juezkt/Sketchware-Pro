  ...
  public static int getViewTypeResId(int id) {
    return switch (id) {
      ...
      case VIEW_TYPE_WIDGET_AUTOCOMPLETETEXTVIEW,
              VIEW_TYPE_WIDGET_MULTIAUTOCOMPLETETEXTVIEW,
              VIEW_TYPE_LAYOUT_TEXTINPUTLAYOUT ->
          R.drawable.ic_mtrl_edittext;
      ...
      case VIEW_TYPE_WIDGET_ANALOGCLOCK,
              VIEW_TYPE_WIDGET_TIMEPICKER,
              VIEW_TYPE_WIDGET_DIGITALCLOCK ->
          R.drawable.ic_mtrl_time;
