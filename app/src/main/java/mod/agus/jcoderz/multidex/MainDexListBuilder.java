 ...
 * suitable as content of the file argument --main-dex-list of dx.
 */
public class MainDexListBuilder {
  ...
  /**
   * By default we force all classes annotated with runtime annotation to be kept in the main dex
   * list. This option disable the workaround, limiting the index pressure in the main dex but
   * exposing to the Dalvik resolution bug. The resolution bug occurs when accessing annotations of
   * a class that is not in the main dex and one of the annotations as an enum parameter.
   *
