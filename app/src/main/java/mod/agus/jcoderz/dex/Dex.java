...
public final class Dex {
  ...
  private final mod.agus.jcoderz.dex.TableOfContents tableOfContents =
      new mod.agus.jcoderz.dex.TableOfContents();
  ...
  public int descriptorIndexFromTypeIndex(int typeIndex) {
    ...
    int position =
        tableOfContents.typeIds.off + (mod.agus.jcoderz.dex.SizeOf.TYPE_ID_ITEM * typeIndex);
  ...
  public final class Section implements ByteInput, ByteOutput {
    ...
    public mod.agus.jcoderz.dex.MethodId readMethodId() {
      ...
      int nameIndex = readInt();
      return new mod.agus.jcoderz.dex.MethodId(
          Dex.this, declaringClassIndex, protoIndex, nameIndex);
    }
    ...
    public mod.agus.jcoderz.dex.ProtoId readProtoId() {
      ...
      return new mod.agus.jcoderz.dex.ProtoId(
          Dex.this, shortyIndex, returnTypeIndex, parametersOffset);
    }
    ...
    public mod.agus.jcoderz.dex.ClassDef readClassDef() {
      ...
      return new mod.agus.jcoderz.dex.ClassDef(
          Dex.this,
          offset,
          type,
          accessFlags,
    ...
    private mod.agus.jcoderz.dex.ClassData readClassData() {
      ...
      return new mod.agus.jcoderz.dex.ClassData(
    ...
    private mod.agus.jcoderz.dex.ClassData.Field[] readFields(int count) {
      mod.agus.jcoderz.dex.ClassData.Field[] result =
          new mod.agus.jcoderz.dex.ClassData.Field[count];
      int fieldIndex = 0;
    ...
    private mod.agus.jcoderz.dex.ClassData.Method[] readMethods(int count) {
      mod.agus.jcoderz.dex.ClassData.Method[] result =
          new mod.agus.jcoderz.dex.ClassData.Method[count];
      int methodIndex = 0;
      for (int i = 0; i < count; i++) {
    ...
    public mod.agus.jcoderz.dex.Annotation readAnnotation() {
      ...
      new mod.agus.jcoderz.dex.EncodedValueReader(
              this, mod.agus.jcoderz.dex.EncodedValueReader.ENCODED_ANNOTATION)
          .skipValue();
      return new Annotation(
          Dex.this, visibility, new mod.agus.jcoderz.dex.EncodedValue(getBytesFrom(start)));
    }

    public mod.agus.jcoderz.dex.EncodedValue readEncodedArray() {
      int start = data.position();
      new mod.agus.jcoderz.dex.EncodedValueReader(this, EncodedValueReader.ENCODED_ARRAY)
          .skipValue();
  ...
  private final class StringTable extends AbstractList<String> implements RandomAccess {
    ...
    public String get(int index) {
      ...
      return open(tableOfContents.stringIds.off
              + (index * mod.agus.jcoderz.dex.SizeOf.STRING_ID_ITEM))
          .readString();
    }
  ...
  private final class ProtoIdTable extends AbstractList<mod.agus.jcoderz.dex.ProtoId>
      implements RandomAccess {
    @Override
    public ProtoId get(int index) {
      checkBounds(index, tableOfContents.protoIds.size);
      return open(tableOfContents.protoIds.off
              + (mod.agus.jcoderz.dex.SizeOf.PROTO_ID_ITEM * index))
          .readProtoId();
    }
  ...
  private final class FieldIdTable extends AbstractList<mod.agus.jcoderz.dex.FieldId>
      implements RandomAccess {
    @Override
    public FieldId get(int index) {
      checkBounds(index, tableOfContents.fieldIds.size);
      return open(tableOfContents.fieldIds.off
              + (mod.agus.jcoderz.dex.SizeOf.MEMBER_ID_ITEM * index))
          .readFieldId();
    }
  ...
  private final class MethodIdTable extends AbstractList<mod.agus.jcoderz.dex.MethodId>
      implements RandomAccess {
    @Override
