    ...
    if (intent != null) {
      ...
      var dialog =
          new MaterialAlertDialogBuilder(this)
              ...
              .setNeutralButton(
                  "Show error",
                  null) // null to set proper onClick listeners later without dismissing the
                        // AlertDialog
              .show();
              ...
              v -> {
                ...
                String deviceInfo =
                    "Sketchware Pro "
                        ...
                        + ")\n"
                        + "base.apk size: "
                        + Formatter.formatFileSize(this, fileSizeInBytes)
                        + " ("
                        + fileSizeInBytes
                        + " B)\n"
                        + "Locale: "
                        + GB.g(getApplicationContext())
                        + "\n"
                        + "SDK version: "
                ...
                ClipData clip =
                    ClipData.newPlainText("error", deviceInfo + "\n\n```\n" + error + "\n```");
