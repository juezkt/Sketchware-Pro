...
public class NewKeyStoreActivity extends BaseAppCompatActivity implements OnClickListener {
  ...
  private void showDoneDialog(boolean success, String password) {
    ...
    if (success) {
      ...
      dialog.a(
          Helper.getResString(R.string.myprojects_sign_apk_dialog_complete_create_certificate));
    } else {
      dialog.a(R.drawable.error_96_yellow);
      dialog.a(
          Helper.getResString(R.string.myprojects_sign_apk_error_failed_create_new_certificate));
    }
    ...
    if (passwordValidator.b() && passwordConfirmValidator.b()) {
      ...
      if (!text.equals(passwordConfirm.getText().toString())) {
        bB.b(
                ...
                Helper.getResString(R.string.myprojects_sign_apk_incorrect_password),
                0)
            .show();
        password.setText("");
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    getSupportActionBar()
        .setTitle(
            Helper.getResString(
                R.string.myprojects_sign_apk_new_certificate_title_new_certificate));
    ...
    ((TextView) findViewById(R.id.tv_cert_title))
        .setText(
            Helper.getResString(R.string.myprojects_sign_apk_new_certificate_title_certificate));
