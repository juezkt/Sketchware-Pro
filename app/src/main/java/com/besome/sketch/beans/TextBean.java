...
public class TextBean extends nA implements Parcelable {
  ...
  @Expose public int hintColor;
  @Expose public String resHintColor;
  @Expose public int imeOption;
  @Expose public int inputType;
  @Expose public int line;
  @Expose public int singleLine;
  @Expose public String text;
  @Expose public int textColor;
  @Expose public String resTextColor;
  @Expose public String textFont;
  @Expose public int textSize;
  @Expose public int textType;
  ...
  public boolean isEqual(TextBean textBean) {
    ...
    if (textSize != textBean.textSize
        || textColor != textBean.textColor
        || textType != textBean.textType
        || resTextColor != textBean.resTextColor
        || resHintColor != textBean.resTextColor) { // new
      return false;
    }
    ...
    return hintColor == textBean.hintColor
            && singleLine == textBean.singleLine
            && line == textBean.line
            && inputType == textBean.inputType
            && imeOption == textBean.imeOption
