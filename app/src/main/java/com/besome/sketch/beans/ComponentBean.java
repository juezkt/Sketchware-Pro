...
public class ComponentBean extends CollapsibleBean implements Parcelable {
  public static final Parcelable.Creator<ComponentBean> CREATOR =
  ...
  public Gx classInfo;
  @Expose public String componentId;
  @Expose public String param1;
  @Expose public String param2;
  @Expose public String param3;
  @Expose public int type;

  /**
   * Constructs a Component without <code>componentId</code>, <code>param1</code>, <code>param2
   * </code>, <code>param3</code>
   */
  ...
  public static String getComponentDocsUrlByTypeName(int type) {
    return switch (type) {
      ...
      case COMPONENT_TYPE_CALENDAR -> "https://docs.sketchware.io/docs/component-calendar.html";
      case COMPONENT_TYPE_VIBRATOR -> "https://docs.sketchware.io/docs/component-vibrator.html";
      ...
      case COMPONENT_TYPE_SOUNDPOOL -> "https://docs.sketchware.io/docs/component-soundpool.html";
      case COMPONENT_TYPE_OBJECTANIMATOR ->
          "https://docs.sketchware.io/docs/component-object-animator.html";
      case COMPONENT_TYPE_GYROSCOPE -> "https://docs.sketchware.io/docs/component-gyroscope.html";
      ...
      case COMPONENT_TYPE_INTERSTITIAL_AD,
              COMPONENT_TYPE_REQUEST_NETWORK,
              COMPONENT_TYPE_TEXT_TO_SPEECH,
              COMPONENT_TYPE_SPEECH_TO_TEXT,
              COMPONENT_TYPE_BLUETOOTH_CONNECT,
              COMPONENT_TYPE_LOCATION_MANAGER ->
          // sad :c
          "";
  ...
  public static int getDescStrResource(int type) {
    return switch (type) {
      ...
      case COMPONENT_TYPE_FIREBASE -> R.string.design_library_firebase_description_about_firebase;
      ...
      case COMPONENT_TYPE_BLUETOOTH_CONNECT -> R.string.component_description_bluetooth_connect;
      ...
      case COMPONENT_TYPE_DATE_PICKER_DIALOG -> R.string.component_description_date_picker_dialog;
      case COMPONENT_TYPE_TIME_PICKER_DIALOG -> R.string.component_description_time_picker_dialog;
      ...
      case COMPONENT_TYPE_FIREBASE_AUTH_GOOGLE_LOGIN -> R.string.component_description_fb_google;
