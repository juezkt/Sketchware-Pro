...
public class LayoutBean extends nA implements Parcelable {
  public static final Parcelable.Creator<LayoutBean> CREATOR =
  ...
  @Expose public String backgroundResColor;
  @Expose public String backgroundResource;
  @Expose public int borderColor;
  @Expose public int gravity;
  @Expose public int height;
  @Expose public int layoutGravity;
  @Expose public int marginBottom;
  @Expose public int marginLeft;
  @Expose public int marginRight;
  @Expose public int marginTop;
  @Expose public int orientation;
  @Expose public int paddingBottom;
  @Expose public int paddingLeft;
  @Expose public int paddingRight;
  @Expose public int paddingTop;
  @Expose public int weight;
  @Expose public int weightSum;
