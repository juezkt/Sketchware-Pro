...
public class ProjectFileBean extends SelectableBean implements Parcelable {
  public static final Creator<ProjectFileBean> CREATOR =
      new Creator<>() {
        @Override
  ...
  @Expose public int fileType;
  @Expose public int keyboardSetting;
  @Expose @ActivityOption public int options = OPTION_ACTIVITY_SHIFT;
  @Expose public int orientation;
  public String presetName;
  @Expose @Deprecated public int theme = THEME_NONE;
  ...
  public ProjectFileBean(
      int fileType,
      String filename,
      int orientation,
      int keyboardSetting,
      @ActivityOption int options) {
    this.fileType = fileType;
    fileName = filename;
  ...
  public String getDrawersJavaName() {
    return fileType != THEME_FULLSCREEN
        ? ""
        : !fileName.contains("_drawer_")
            ? ""
