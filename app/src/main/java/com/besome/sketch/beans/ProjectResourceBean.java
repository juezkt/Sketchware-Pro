...
public class ProjectResourceBean extends SelectableBean implements Parcelable {
  public static final Parcelable.Creator<ProjectResourceBean> CREATOR =
  ...
  @Expose public String resFullName;
  @Expose public String resName;

  @Expose public int resType;
  public int rotate;
  ...
  public ProjectResourceBean clone() {
    ProjectResourceBean projectResourceBean =
        new ProjectResourceBean(resType, resName, resFullName);
