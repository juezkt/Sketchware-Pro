...
public class DesignDrawer extends LinearLayout implements View.OnClickListener {
  ...
  private DrawerItem addDrawerItem(int tag, int iconResId, int titleResId, int descriptionResId) {
    ...
    drawerItem.setContent(
        iconResId,
        Helper.getResString(drawerItem, titleResId),
        Helper.getResString(drawerItem, descriptionResId));
  ...
  private void initialize(Context context) {
    ...
    binding.tvTitleConfiguration.setText(
        Helper.getResString(binding.tvTitleConfiguration, R.string.design_drawer_menu_title));
    binding.tvTitleGlobal.setText(
        Helper.getResString(binding.tvTitleGlobal, R.string.design_drawer_menu_bottom_title));
    ...
    addLayoutMenu(
        ...
        R.string.design_drawer_menu_title_xml_command,
        R.string.design_drawer_menu_description_xml_command);

    addLayoutMenu(
        22,
        R.drawable.ic_mtrl_article,
        R.string.design_drawer_menu_title_logcat_reader,
