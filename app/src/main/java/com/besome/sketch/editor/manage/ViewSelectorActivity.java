...
public class ViewSelectorActivity extends BaseAppCompatActivity {
  ...
  private int getViewIcon(int i) {
    ...
    return getApplicationContext()
        .getResources()
        .getIdentifier("activity_" + replace, "drawable", getApplicationContext().getPackageName());
  }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    binding.optionsSelector.check(
        selectedTab == TAB_ACTIVITY ? R.id.option_view : R.id.option_custom_view);
    ...
    binding.listXml.addOnScrollListener(
    ...
    var onSurface =
        MaterialColors.getColor(
            binding.optionsSelector, com.google.android.material.R.attr.colorOnSurface);
    binding.optionsSelector.addOnButtonCheckedListener(
        (group, checkedId, isChecked) -> {
          if (isChecked) {
            ...
            viewSelectorAdapter.notifyDataSetChanged();
            binding.emptyMessage.setVisibility(
                viewSelectorAdapter.getItemCount() == 0 ? View.VISIBLE : View.GONE);
          }
        });
    binding.createNewView.setOnClickListener(
        v -> {
          if (!mB.a()) {
  ...
  private class ViewSelectorAdapter extends RecyclerView.Adapter<ViewSelectorAdapter.ViewHolder> {
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
      ...
      public ViewHolder(@NonNull FileSelectorPopupSelectXmlActivityItemBinding binding) {
        ...
        itemBinding.cardView.setOnClickListener(
            v -> {
              if (!mB.a()) {
                ...
                hC hC = jC.b(sc_id);
                ArrayList<ProjectFileBean> list =
                    switch (selectedTab) {
        ...
        itemBinding.actionContainer.setOnClickListener(
            v -> {
        ...
        itemBinding.imgPresetSetting.setOnClickListener(
            v -> {
              if (!mB.a()) {
                selectedItem = getLayoutPosition();
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
      ...
      viewHolder.itemBinding.cardView.setStrokeColor(
          ContextCompat.getColor(ViewSelectorActivity.this, R.color.transparent));
      ...
      if (selectedTab == TAB_ACTIVITY) {
        ...
        if (currentXml.equals(xmlName)) {
          viewHolder.itemBinding.cardView.setStrokeColor(
              ContextCompat.getColor(ViewSelectorActivity.this, R.color.scolor_dark_yellow_01));
