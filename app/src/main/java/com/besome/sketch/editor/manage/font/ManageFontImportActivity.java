...
public class ManageFontImportActivity extends BaseAppCompatActivity
  ...
  private void showPreview(int position) {
    ...
    binding.textFont.setText(
        xB.b()
            .a(getApplicationContext(), R.string.design_manager_font_description_example_sentence));
  }
  ...
  private boolean n() {
    ...
    if (!duplicateNames.isEmpty()) {
      ...
      bB.a(
              ...
              xB.b().a(getApplicationContext(), R.string.common_message_name_unavailable)
                  + "\n["
                  + names
                  + "]",
              bB.TOAST_WARNING)
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    binding.tvSendbtn.setText(
        xB.b().a(getApplicationContext(), R.string.common_word_import).toUpperCase());
    binding.tvSendbtn.setOnClickListener(this);
    binding.tvSamename.setText(
        xB.b().a(getApplicationContext(), R.string.design_manager_font_title_apply_same_naming));
    ...
    nameValidator =
        new QB(
            getApplicationContext(),
            binding.edInput.getTextInputLayout(),
            uq.b,
            getReservedProjectImageNames(),
            getReservedSelectedCollectionNames());
    binding.chkSamename.setOnCheckedChangeListener(
    ...
    btnDecide.setText(
        xB.b().a(getApplicationContext(), R.string.design_manager_change_name_button));
    ...
    if (!duplicateCollections.isEmpty()) {
      bB.b(
              ...
              xB.b()
                  .a(
                      getApplicationContext(),
                      R.string.design_manager_message_collection_name_conflict),
              1)
          .show();
    } else {
      bB.a(
              ...
              xB.b()
                  .a(
                      getApplicationContext(),
                      R.string.design_manager_message_collection_name_no_conflict),
              0)
          .show();
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      return new ViewHolder(
          LayoutInflater.from(parent.getContext())
              .inflate(R.layout.manage_import_list_item, parent, false));
    }
