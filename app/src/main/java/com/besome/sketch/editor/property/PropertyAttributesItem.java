                  ...
                  (d, w) -> {
                    ...
                    if (RELATIVE_IDS.contains(attr)) {
                      new MaterialAlertDialogBuilder(getContext())
                          ...
                          .setAdapter(
                              new ArrayAdapter<>(
                                  getContext(), android.R.layout.simple_list_item_1, ids),
                              (d2, w2) -> {
                                var id = ids.get(w2);
                                if (new CircularDependencyDetector(beans, bean)
                                    .isLegalAttribute(id, attr)) {
                                  value.put(attr, id);
        ...
        itemView.setOnClickListener(
            v -> {
              ...
              new MaterialAlertDialogBuilder(getContext())
                  ...
                  .setAdapter(
                      new ArrayAdapter<>(
                          getContext(), android.R.layout.simple_list_item_1, filteredIds),
                      (d, w) -> {
