...
public class ItemSignInButton extends AppCompatButton implements sy {
  ...
  public enum ColorScheme {
    DARK(
        0xFFFFFFFF, R.drawable.item_button_signin_dark, R.drawable.item_button_signin_dark_ic_only),
    LIGHT(
        0x80000000,
        R.drawable.item_button_signin_light,
        R.drawable.item_button_signin_light_ic_only);
