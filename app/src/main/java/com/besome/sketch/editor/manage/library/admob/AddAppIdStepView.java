...
public class AddAppIdStepView extends LinearLayout implements Uu, View.OnClickListener {
  ...
  public boolean isValid() {
    if (!isEmpty(binding.textId.getText().toString())) {
      ...
      bB.a(
              getContext(),
              Helper.getResString(R.string.design_library_admob_setting_message_add_app_id),
              1)
          .show();
      return false;
    }
  ...
  private void showAddAppIdDialog() {
    ...
    ManageLibrarySettingAdmobAppIdAddBinding addBinding =
        ManageLibrarySettingAdmobAppIdAddBinding.inflate(dialog.getLayoutInflater());
