...
public class ManageSoundImportActivity extends BaseAppCompatActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    tv_samename.setText(
        xB.b().a(getApplicationContext(), R.string.design_manager_sound_title_apply_same_naming));
    adapter = new ItemAdapter();
    RecyclerView recycler_list = findViewById(R.id.recycler_list);
    recycler_list.setAdapter(adapter);
    recycler_list.setLayoutManager(
    ...
    nameValidator =
        new QB(
            ...
            ed_input.getTextInputLayout(),
            uq.b,
            getReservedProjectSoundNames(),
            getReservedSelectedCollectionNames());
    chk_samename = findViewById(R.id.chk_samename);
    chk_samename.setOnCheckedChangeListener(
  ...
  private void loadSoundEmbeddedPicture(String filePath, ImageView target, int position)
      throws IOException {
