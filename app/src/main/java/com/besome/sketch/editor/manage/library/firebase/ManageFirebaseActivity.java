...
public class ManageFirebaseActivity extends BaseAppCompatActivity implements View.OnClickListener {
  ...
  private void openDoc() {
    try {
      ...
      intent.setData(
          Uri.parse(
              "https://sketchware-pro.vercel.app/docs/components/Firebase/connect-to-firebase"));
  ...
  private void configureLibraryDialog() {
    ...
    dialog.a(
        Helper.getResString(
            R.string.design_library_firebase_dialog_description_confirm_uncheck_firebase));
    ...
    if (id == R.id.btn_console) {
      ...
      if (libSwitch.isChecked() || !firebaseLibraryBean.data.isEmpty()) {
        ...
        SketchwareUtil.toast(
            "Configure Firebase settings first, either by importing google-services.json, "
                + "or by manually entering the project's details.",
            Toast.LENGTH_LONG);
      }
    }
  }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    getSupportActionBar()
        .setTitle(Helper.getResString(R.string.design_library_firebase_title_firebase_manager));
    ...
    ((TextView) findViewById(R.id.tv_enable))
        .setText(Helper.getResString(R.string.design_library_settings_title_enabled));
    ((TextView) findViewById(R.id.tv_title_project_id))
        .setText(Helper.getResString(R.string.design_library_firebase_title_project_id));
    ((TextView) findViewById(R.id.tv_title_app_id))
        .setText(Helper.getResString(R.string.design_library_firebase_title_app_id));
    ((TextView) findViewById(R.id.tv_title_api_key))
        .setText(Helper.getResString(R.string.design_library_firebase_title_api_key));
    ((TextView) findViewById(R.id.tv_title_storage_url))
        .setText(Helper.getResString(R.string.design_library_firebase_title_storage_bucket_url));
    ...
    btnConsole.setText(
        Helper.getResString(R.string.design_library_firebase_button_goto_firebase_console));
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    menu.add(Menu.NONE, Menu.NONE, Menu.NONE, "Help")
        .setIcon(AppCompatResources.getDrawable(this, R.drawable.ic_mtrl_help))
        .setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
    menu.add(Menu.NONE, Menu.NONE, Menu.NONE, "Config")
  ...
  private void showImportJsonDialog() {
    ...
    pickerDialog.setDialogSelectionListener(
        selections -> {
  ...
  private void parseDataFromGoogleServicesJson(String _data) {
    ...
    Matcher storageBucketMatcher =
        Pattern.compile(storageBucketRegex, Pattern.MULTILINE).matcher(_data);
    ...
    notFoundLog.append(
        "The google-services.json file you selected does not contain the following"
            + " configurations:\n");
    ...
    if (rtdbMatcher.find()) {
      configureImportFirebaseConfigFromJson(
          realtime_db, rtdbMatcher.group(1).replace("https://", ""));
    } else {
