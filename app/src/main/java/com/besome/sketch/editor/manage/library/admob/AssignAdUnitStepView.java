...
public class AssignAdUnitStepView extends LinearLayout implements Uu, OnClickListener {
  ...
  private void setAdUnit(int position) {
    ...
    dialog.a(rootView);
    dialog.b(
        Helper.getResString(R.string.common_word_select),
        v -> {
  ...
  private void initialize(Context context) {
    ...
    ((TextView) findViewById(R.id.tv_banner_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_banner));
    ((TextView) findViewById(R.id.tv_banner_name_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_ad_name) + " : ");
    ((TextView) findViewById(R.id.tv_banner_id_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_ad_unit_id) + " : ");
    ((TextView) findViewById(R.id.tv_inter_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_interstitial));
    ((TextView) findViewById(R.id.tv_inter_name_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_ad_name) + " : ");
    ((TextView) findViewById(R.id.tv_inter_id_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_ad_unit_id) + " : ");
    ((TextView) findViewById(R.id.tv_reward_name_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_ad_name) + " : ");
    ((TextView) findViewById(R.id.tv_reward_id_title))
        .setText(Helper.getResString(R.string.design_library_admob_title_ad_unit_id) + " : ");
  ...
  public boolean isValid() {
    if (!bannerAdUnitId.isEmpty() && !interstitialAdUnitId.isEmpty()) {
      ...
      bB.a(
              getContext(),
              Helper.getResString(R.string.design_library_admob_message_select_ad_unit),
              1)
          .show();
      return false;
    }
