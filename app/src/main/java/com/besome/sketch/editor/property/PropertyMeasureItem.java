...
public class PropertyMeasureItem extends RelativeLayout implements View.OnClickListener {
  ...
  private void showDialog() {
    ...
    PropertyPopupMeasurementBinding binding =
        PropertyPopupMeasurementBinding.inflate(LayoutInflater.from(getContext()));
    ...
    binding.rgWidthHeight.setOnCheckedChangeListener(
        (group, checkedId) -> {
