...
public class ManageGoogleMapActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    if (GB.h(getApplicationContext())) {
      try {
        Uri documentationUrl =
            Uri.parse("https://developers.google.com/maps/documentation/android-sdk/signup");
      ...
      bB.a(getApplicationContext(), Helper.getResString(R.string.common_message_check_network), 0)
          .show();
    }
  }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    ((TextView) findViewById(R.id.tv_api_key))
        .setText(Helper.getResString(R.string.design_library_google_map_title_api_key));
    ((TextView) findViewById(R.id.tv_desc))
        .setText(
            Helper.getResString(R.string.design_library_google_maps_description_operate_normally));
    ((TextView) findViewById(R.id.tv_enable))
        .setText(Helper.getResString(R.string.design_library_settings_title_enabled));
    Button btnImport = findViewById(R.id.btn_import);
    btnImport.setText(
        Helper.getResString(R.string.design_library_button_import_from_other_project));
