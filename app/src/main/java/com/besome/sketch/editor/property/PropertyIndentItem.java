...
public class PropertyIndentItem extends RelativeLayout implements View.OnClickListener {
  ...
  private void showDialog() {
    ...
    PropertyPopupInputIndentBinding binding =
        PropertyPopupInputIndentBinding.inflate(LayoutInflater.from(getContext()));
    View view = binding.getRoot();

    binding.tiAll.setHint(
        String.format(
            Helper.getResString(R.string.property_enter_value), propertyType.toLowerCase()));
    ...
    binding.chkPtyAll.setOnClickListener(
        v -> {
    ...
    binding.etAll.addTextChangedListener(
        new TextWatcher() {
          @Override
