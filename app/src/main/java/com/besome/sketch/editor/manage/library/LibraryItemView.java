...
public class LibraryItemView extends FrameLayout {
  ...
  public void setData(ProjectLibraryBean projectLibraryBean) {
    ...
    title.setText(
        xB.b().a(getContext(), ProjectLibraryBean.getLibraryResName(projectLibraryBean.libType)));
    description.setText(
        xB.b().a(getContext(), ProjectLibraryBean.getLibraryResDesc(projectLibraryBean.libType)));
