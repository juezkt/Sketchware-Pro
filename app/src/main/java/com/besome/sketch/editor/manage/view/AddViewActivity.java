...
public class AddViewActivity extends BaseAppCompatActivity {
        ...
        if (featureItem.isEnabled) {
          ...
          if (featureToolbar) {
            binding
                .previewToolbar
                .animate()
                .translationY((float) (-binding.previewStatusbar.getMeasuredHeight()))
                .start();
          } else {
  ...
  private void slideOutPreviewToolbar() {
    binding
        ...
        .translationY(
            (float)
                (-(binding.previewStatusbar.getMeasuredHeight()
                    + binding.previewToolbar.getMeasuredHeight())))
        .start();
  }
  ...
  private void initItem(int option) {
    featureToolbar =
        (option & ProjectFileBean.OPTION_ACTIVITY_TOOLBAR)
            == ProjectFileBean.OPTION_ACTIVITY_TOOLBAR;
    featureStatusBar =
        (option & ProjectFileBean.OPTION_ACTIVITY_FULLSCREEN)
            != ProjectFileBean.OPTION_ACTIVITY_FULLSCREEN;
    featureFab =
        (option & ProjectFileBean.OPTION_ACTIVITY_FAB) == ProjectFileBean.OPTION_ACTIVITY_FAB;
    featureDrawer =
        (option & ProjectFileBean.OPTION_ACTIVITY_DRAWER) == ProjectFileBean.OPTION_ACTIVITY_DRAWER;
  }

  private void initializeItems() {
    featureItems = new ArrayList<>();
    featureItems.add(
        new FeatureItem(0, R.drawable.ic_statusbar_color_48dp, "StatusBar", featureStatusBar));
    featureItems.add(
        new FeatureItem(1, R.drawable.ic_toolbar_color_48dp, "Toolbar", featureToolbar));
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    binding.keyboardSettingsSelector.addOnButtonCheckedListener(
    ...
    binding.btnSave.setOnClickListener(
        v -> {
          ...
          if (265 == requestCode) {
            ...
            projectFileBean.keyboardSetting =
            ...
            bB.a(
                    ...
                    xB.b()
                        .a(
                            getApplicationContext(),
                            R.string.design_manager_message_edit_complete,
                            new Object[0]),
                    bB.TOAST_NORMAL)
                .show();
            finish();
            ...
            bB.a(
                    ...
                    xB.b()
                        .a(
                            getApplicationContext(),
                            R.string.design_manager_message_add_complete,
                            new Object[0]),
                    bB.TOAST_NORMAL)
                .show();
            finish();
    ...
    if (requestCode == 265) {
      ...
      binding.screenOrientationSelector.check(
          binding.screenOrientationSelector.getChildAt(projectFileBean.orientation).getId());
      binding.keyboardSettingsSelector.check(
          binding.keyboardSettingsSelector.getChildAt(projectFileBean.keyboardSetting).getId());
