...
public class AddSoundCollectionActivity extends BaseDialogActivity implements View.OnClickListener {
  ...
  public void onCreate(Bundle bundle) {
    ...
    binding.seek.setOnSeekBarChangeListener(
  ...
  private void p() {
    Intent intent =
        new Intent(
            "android.intent.action.GET_CONTENT", MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    intent.setType("audio/*");
    startActivityForResult(
        Intent.createChooser(intent, xB.b().a(this, R.string.common_word_choose)), 218);
  }
    ...
    if (a(M)) {
      if (!u) {
        ...
        ProjectResourceBean projectResourceBean =
            new ProjectResourceBean(ProjectResourceBean.PROJECT_RES_TYPE_FILE, obj, a);
        ...
        try {
          ...
          bB.a(
                  this,
                  xB.b().a(getApplicationContext(), R.string.design_manager_message_add_complete),
                  1)
              .show();
        } catch (Exception e) {
        ...
        bB.a(
                this,
                xB.b().a(getApplicationContext(), R.string.design_manager_message_edit_complete),
                1)
            .show();
      }
      finish();
