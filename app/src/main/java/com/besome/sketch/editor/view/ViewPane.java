...
public class ViewPane extends RelativeLayout {
  ...
  private void initTextView() {
    ...
    highlightedTextView.setLayoutParams(
  ...
  private void updateItemView(View view, ViewBean viewBean) {
    ...
    if (viewBean.id.charAt(0) == '_') {
      ...
      if (viewBean.getClassInfo().b("FloatingActionButton")
          && (imageBean = viewBean.image) != null
          && (str = imageBean.resName) != null
          && !str.isEmpty()) {
        try {
          ...
          ((FloatingActionButton) view)
              .setImageBitmap(
                  Bitmap.createScaledBitmap(
                      decodeFile,
                      decodeFile.getWidth() * round,
                      decodeFile.getHeight() * round,
                      true));
    ...
    if (backgroundResource != null) {
      try {
        if (resourcesManager.h(backgroundResource)
            == ProjectResourceBean.PROJECT_RES_TYPE_RESOURCE) {
          view.setBackgroundResource(
              getContext()
                  .getResources()
                  .getIdentifier(
                      viewBean.layout.backgroundResource,
                      "drawable",
          ...
          if (backgroundRes.endsWith(".9.png")) {
            ...
            if (NinePatch.isNinePatchChunk(ninePatchChunk)) {
              view.setBackground(
                  new NinePatchDrawable(
                      getResources(), decodedBitmap, ninePatchChunk, new Rect(), null));
            } else {
            ...
            view.setBackground(
                new BitmapDrawable(
                    ...
                    Bitmap.createScaledBitmap(
                        decodeFile2,
                        decodeFile2.getWidth() * round2,
                        decodeFile2.getHeight() * round2,
                        true)));
          }
        }
      } catch (Exception e) {
    ...
    if (classInfo.a("ImageView")) {
      if (resourcesManager.h(viewBean.image.resName)
          == ProjectResourceBean.PROJECT_RES_TYPE_RESOURCE) {
        ((ImageView) view)
            .setImageResource(
                getContext()
                    .getResources()
                    .getIdentifier(
                        viewBean.image.resName, "drawable", getContext().getPackageName()));
        ...
        try {
          ...
          if (file.exists()) {
            ...
            if (imagelocation.endsWith(".xml")) {
              ...
              svgUtils.loadScaledSvgIntoImageView(
                  (ImageView) view, fpu.getSvgFullPath(sc_id, viewBean.image.resName), round3);
            } else {
              ...
              ((ImageView) view)
                  .setImageBitmap(
                      Bitmap.createScaledBitmap(
                          decodeFile3,
                          decodeFile3.getWidth() * round3,
                          decodeFile3.getHeight() * round3,
                          true));
            }
          } else {
  ...
  public View addFab(ViewBean viewBean) {
    ...
    itemFloatingActionButton.setLayoutParams(
  ...
  private void a(ViewBean view, ItemLinearLayout linearLayout) {
    ...
    for (int i = 0; i < linearLayout.getChildCount(); i++) {
      ...
      if (child != null
          && child.getTag() != null
          && (view == null || view.id == null || !child.getTag().equals(view.id))
        ...
        if (linearLayout.getOrientation() == LinearLayout.VERTICAL) {
          if (verticalGravity == Gravity.CENTER_VERTICAL) {
            ...
            if (i == 0) {
              ...
              addViewInfo(
                  new Rect(parentLeft, paddingTop, parentWidth + parentLeft, childTopY),
                  linearLayout,
                  0,
            ...
            paddingTop = (int) ((topMargin + childHeight + bottomMargin) * scaleY) + childTopY;
            ...
            final int childBottomY =
                (int) ((childHeight + topMargin + bottomMargin) * scaleY) + paddingTop;
            paddingLeft = parentRect.left;
            childRect.left = paddingLeft;
            childRect.top = paddingTop;
            childRect.right = parentWidth + paddingLeft;
          ...
          if (horizontalGravity == Gravity.CENTER_HORIZONTAL) {
            if (i == 0) {
              ...
              addViewInfo(
                  new Rect(paddingLeft, parentTop, childStartX, parentHeight + parentTop),
                  linearLayout,
                  0,
                  calculateViewDepth(linearLayout) + 1);
            ...
            childRect.top = paddingTop;
            childRect.right =
                (int) ((childWidth + leftMargin + rightMargin) * scaleX) + paddingLeft;
        ...
        addViewInfo(childRect, linearLayout, childIndex, calculateViewDepth(linearLayout) + 1);
  ...
  private void addDroppableForViewGroup(ViewBean viewBean, ViewGroup viewGroup) {
    ...
    for (int i = 0; i < viewGroup.getChildCount(); i++) {
      ...
      if (childAt != null
          && childAt.getTag() != null
          && ((viewBean == null || viewBean.id == null || !childAt.getTag().equals(viewBean.id))
  ...
  private void updateLayout(View view, ViewBean viewBean) {
    ...
    if (viewBean.id.equals("root")) {
      ...
      view.setPadding(
          layoutBean2.paddingLeft,
          layoutBean2.paddingTop,
          layoutBean2.paddingRight,
          layoutBean2.paddingBottom);
      view.setLayoutParams(layoutParams);
      ...
      view.setPadding(
          layoutBean3.paddingLeft,
          layoutBean3.paddingTop,
          layoutBean3.paddingRight,
          layoutBean3.paddingBottom);
      ...
      view.setPadding(
          layoutBean4.paddingLeft,
          layoutBean4.paddingTop,
          layoutBean4.paddingRight,
          layoutBean4.paddingBottom);
      int layoutGravity = viewBean.layout.layoutGravity;
  ...
  private void updateRelative(View view, InjectAttributeHandler handler) {
    ...
    if (parent.containsKey("android:layout_alignBaseline")) {
      setRelativeRule(
          view, parent.get("android:layout_alignBaseline"), RelativeLayout.ALIGN_BASELINE);
  ...
  private void updateTextView(TextView textView, ViewBean viewBean) {
    ...
    if (textFont != null && !textFont.isEmpty()) {
      if (textFont.startsWith("@font/")) {
        ...
        String textFontPath = new ResourceUtil(sc_id, "font").getResourcePathFromName(textFont);
        textView.setTypeface(
            textFontPath != null && !textFontPath.isEmpty() && new File(textFontPath).exists()
  ...
  private void updateCardView(ItemCardView cardView, InjectAttributeHandler handler) {
    ...
    cardView.setBackgroundColor(
        PropertiesUtil.isHexColor(cardBackgroundColor)
            ? PropertiesUtil.parseColor(cardBackgroundColor)
            : bean.layout.backgroundColor);
    ...
    cardView.setUseCompatPadding(
        Boolean.parseBoolean(TextUtils.isEmpty(compatPadding) ? "false" : compatPadding));
    cardView.setStrokeWidth(PropertiesUtil.resolveSize(strokeWidth, 0));
    cardView.setStrokeColor(
        PropertiesUtil.isHexColor(strokeColor)
            ? PropertiesUtil.parseColor(strokeColor)
            : Color.WHITE);
  }

  private void updateCircleImageView(
      ItemCircleImageView imageView, InjectAttributeHandler handler) {
    ...
    imageView.setBorderColor(
        PropertiesUtil.isHexColor(borderColor)
            ? PropertiesUtil.parseColor(borderColor)
            : 0xff008dcd);
    imageView.setCircleBackgroundColor(
        PropertiesUtil.isHexColor(backgroundColor)
            ? PropertiesUtil.parseColor(backgroundColor)
            : 0xff008dcd);
    imageView.setBorderWidth(PropertiesUtil.resolveSize(borderWidth, 3));
    imageView.setBorderOverlay(
        Boolean.parseBoolean(TextUtils.isEmpty(borderOverlay) ? "false" : borderOverlay));
  }
  ...
  private void updateTabLayout(ItemTabLayout tabLayout, InjectAttributeHandler handler) {
    ...
    tabLayout.setSelectedTabIndicatorColor(
        PropertiesUtil.isHexColor(indicatorColor)
            ? PropertiesUtil.parseColor(indicatorColor)
            : 0xffffc107);
    int tabTextColor =
        PropertiesUtil.isHexColor(textColor) ? PropertiesUtil.parseColor(textColor) : 0xff57beee;
    int tabSelectedTextColor =
        PropertiesUtil.isHexColor(selectedTextColor)
            ? PropertiesUtil.parseColor(selectedTextColor)
            : Color.WHITE;
    tabLayout.setTabTextColors(tabTextColor, tabSelectedTextColor);
  }

  private void updateMaterialButton(
      ItemMaterialButton materialButton, InjectAttributeHandler handler) {
