...
public class ComponentAddActivity extends BaseDialogActivity implements View.OnClickListener {
    ...
    switch (componentType) {
      case ComponentBean.COMPONENT_TYPE_SHAREDPREF:
        ...
        jC.a(sc_id)
            .a(
                ...
                componentType,
                componentId,
                binding.edInputFilename.getText().toString());
        break;
      ...
      case ComponentBean.COMPONENT_TYPE_FIREBASE_STORAGE:
        ...
        if (jC.c(sc_id).d().useYn.equals(ProjectLibraryBean.LIB_USE_N)) {
          bB.b(
                  this,
                  Helper.getResString(R.string.design_library_guide_setup_first),
                  bB.TOAST_WARNING)
              .show();
          return false;
        }
        jC.a(sc_id)
            .a(
                ...
                componentType,
                componentId,
                binding.edInputFirebasePath.getText().toString());
        break;
      ...
      case ComponentBean.COMPONENT_TYPE_FIREBASE_AUTH:
        if (jC.c(sc_id).d().useYn.equals(ProjectLibraryBean.LIB_USE_N)) {
          ...
          bB.b(
                  this,
                  Helper.getResString(R.string.design_library_firebase_guide_setup_first),
                  bB.TOAST_WARNING)
              .show();
          return false;
        } else {
      ...
      case ComponentBean.COMPONENT_TYPE_REWARDED_VIDEO_AD:
        if (jC.c(sc_id).b().useYn.equals(ProjectLibraryBean.LIB_USE_N)) {
          bB.b(
                  this,
                  Helper.getResString(R.string.design_library_admob_component_setup_first),
                  bB.TOAST_WARNING)
              .show();
          return false;
        }
      ...
      case ComponentBean.COMPONENT_TYPE_FILE_PICKER:
        if (binding.edInputFilePicker.getText().toString().isEmpty()
            || !componentMimeTypeValidator.b()) {
          return false;
        }
        jC.a(sc_id)
            .a(
                ...
                componentType,
                componentId,
                binding.edInputFilePicker.getText().toString());
        break;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    binding.docsButton.setText(
        Helper.getResString(R.string.component_add_docs_button_title_go_to_docs));
    ...
    componentNameValidator =
        new ZB(this, binding.tiInput, uq.b, uq.a(), jC.a(sc_id).a(projectFileBean));
    componentFileNameValidator =
        new SB(
            this,
            binding.tiInputFilename,
            1 /* minimum amount of characters in input */,
            20 /* maximum amount of characters in input */);
    componentFirebasePathValidator =
        new SB(
            this,
            binding.tiInputFirebasePath,
            0 /* minimum amount of characters in input */,
            100 /* maximum amount of characters in input */);
    componentMimeTypeValidator =
        new SB(
            this,
            binding.tiInputFilePicker,
            1 /* minimum amount of characters in input */,
            50 /* maximum amount of characters in input */);
    binding.tvDescFirebasePath.setText(
        Helper.getResString(R.string.design_library_firebase_guide_path_example));
    binding.tvDescFilePicker.setText(
        Helper.getResString(R.string.component_description_file_picker_guide_mime_type_example));
    binding.tiInput.setHint(Helper.getResString(R.string.component_hint_enter_name));
    binding.tiInputFilename.setHint(
        Helper.getResString(R.string.component_file_hint_enter_file_name));
    binding.tiInputFirebasePath.setHint(
        Helper.getResString(R.string.design_library_firebase_hint_enter_data_location));
    binding.tiInputFilePicker.setHint(
        Helper.getResString(R.string.component_file_picker_hint_mime_type));
    w = new HashMap<>();
    binding.imgBack.setOnClickListener(this);
    binding.addButton.setOnClickListener(
        new DebouncedClickListener() {
          @Override
          protected void onDebouncedClick(View v) {
            if (checks()) {
              bB.a(
                      ComponentAddActivity.this,
                      Helper.getResString(R.string.component_message_component_block_added),
                      bB.TOAST_WARNING)
                  .show();
    ...
    binding.tiInputFilePicker.setEndIconOnClickListener(
        v -> showFilePickerMimeTypeSelectionDialog());
  }
  ...
  public void onClick(View view) {
    ...
    if (id == R.id.img_back) {
      ...
      if (!mB.a()) {
        String componentDocsUrlByTypeName =
            ComponentBean.getComponentDocsUrlByTypeName(
                componentList.get(componentsAdapter.layoutPosition).type);
        if (componentDocsUrlByTypeName.isEmpty()) {
          bB.a(
                  getApplicationContext(),
                  Helper.getResString(R.string.component_add_message_docs_updated_soon),
                  bB.TOAST_NORMAL)
              .show();
          return;
        }
  ...
  private void showFilePickerMimeTypeSelectionDialog() {
    ...
    new MaterialAlertDialogBuilder(this)
        ...
        .setSingleChoiceItems(
            mimeTypeLabels.toArray(new String[0]),
            selectedMime.get(),
            (dialog, which) -> selectedChoice.set(which))
        .setPositiveButton(
            R.string.common_word_select,
            (dialog, which) -> {
          ...
          .setListener(
              new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                  y = false;
                  x = false;
                  Helper.setViewsVisibility(
                      true,
                      binding.layoutDescription,
                      binding.tvDescription,
                      binding.imgBack,
                      binding.layoutImgIcon);
                  binding.componentList.setVisibility(View.VISIBLE);
                  binding.tvComponentTitle.setText(
                      Helper.getResString(R.string.component_title_add_component));
                  componentsAdapter.notifyDataSetChanged();
                }
              })
          .start();
  ...
  private void s() {
    ...
    Helper.setViewsVisibility(
        ...
        binding.tvWarning,
        binding.tiInputFilename,
        binding.tvDescFirebasePath,
        binding.tvDescFilePicker,
        binding.tiInputFirebasePath,
        binding.tiInputFilePicker);
    ...
    binding.tvComponentTitle.setText(
        ComponentBean.getComponentName(getApplicationContext(), componentBean.type));
  ...
  public final void t() {
    ...
    dialog.b(
        Helper.getResString(R.string.common_word_ok),
        v -> {
          if (!mB.a()) {
            Intent intent = new Intent(Intent.ACTION_VIEW);
    ...
    dialog.a(
        Helper.getResString(R.string.common_word_cancel), Helper.getDialogDismissListener(dialog));
    dialog.show();
  }
  ...
  private class ComponentsAdapter extends RecyclerView.Adapter<ComponentsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      String componentName =
          ComponentBean.getComponentName(getApplicationContext(), componentList.get(position).type);
      ...
      holder.itemIcon.setImageResource(
          ComponentBean.getIconResource(componentList.get(position).type));
      if (!x) {
        return;
      }
      if (position == layoutPosition) {
        ...
        if (pair == null) return;
        holder.itemName.animate().setDuration(100).alpha(LayoutParams.FLEX_GROW_DEFAULT).start();
        holder
            .itemView
            .animate()
            .setStartDelay(300)
      ...
      holder.itemView.animate().alpha(LayoutParams.FLEX_GROW_DEFAULT).start();
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      ...
      itemView.setLayoutParams(
          new FlexboxLayoutManager.LayoutParams(lengthAndWidth, lengthAndWidth));
        ...
        if (!y) {
          ...
          w.put(
              ...
              new Pair<>(
                  i,
                  (int)
                      (((float) (itemViewLocationInWindow[1] - recyclerViewLocationInWindow[1]))
                          - wB.a(getApplicationContext(), 16.0f))));
