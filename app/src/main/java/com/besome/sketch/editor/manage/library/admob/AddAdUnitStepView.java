...
public class AddAdUnitStepView extends LinearLayout implements Uu, OnClickListener {
  ...
  private void createAdUnit() {
    ...
    tiName.setHint(
        Helper.getResString(R.string.design_library_admob_dialog_add_adunit_hint_adunit_name));
    ...
    tiAdUnitId.setHint(
        Helper.getResString(R.string.design_library_admob_dialog_add_adunit_hint_adunit_id));
  ...
  private void deleteAdUnit(int position) {
    ...
    dialog.b(
        ...
        v -> {
          ...
          bB.a(getContext(), Helper.getResString(R.string.common_message_complete_delete), 0)
              .show();
          dialog.dismiss();
        });
    dialog.a(
  ...
  private void initialize(Context context) {
    ...
    addManually.setText(
        Helper.getResString(R.string.design_library_admob_button_manual_add_to_adunit));

    RecyclerView listAdUnit = findViewById(R.id.list_ad_unit);
    listAdUnit.setLayoutManager(
  ...
  public boolean isValid() {
    if (!adUnitBeanArrayList.isEmpty()) {
      ...
      bB.a(
              getContext(),
              Helper.getResString(R.string.design_library_admob_setting_message_add_ad_unit),
              1)
          .show();
      return false;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      return new ViewHolder(
          LayoutInflater.from(parent.getContext())
              .inflate(R.layout.manage_library_setting_admob_adunit_item, parent, false));
    }
