...
public class AddFontCollectionActivity extends BaseDialogActivity implements View.OnClickListener {
  ...
  public void onCreate(Bundle bundle) {
    ...
    fontValidator =
        new WB2(this, binding.tiInput, uq.b, getExistingFontNames(), projectResourceBean.resName);
    binding.edInput.setText(projectResourceBean.resName);
    binding.fontPreviewTxt.setTypeface(
        Typeface.createFromFile(getFontFilePath(projectResourceBean)));
