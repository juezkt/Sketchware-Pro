...
public class CollapsibleEventLayout extends CollapsibleLayout<CollapsibleButton> {
  ...
  protected List<CollapsibleButton> initializeButtons(@NonNull Context context) {
    CollapsibleButton reset =
        CollapsibleButton.create(context, 0, R.drawable.ic_mtrl_reset, R.string.common_word_reset);

    delete =
        CollapsibleButton.create(
            context, 1, R.drawable.ic_mtrl_delete, R.string.common_word_delete);
    ...
    addToCollection =
        CollapsibleButton.create(
            context, 2, R.drawable.ic_mtrl_bookmark, R.string.logic_list_menu_add_to_collection);
