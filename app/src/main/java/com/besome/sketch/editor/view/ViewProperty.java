...
public class ViewProperty extends LinearLayout implements Kw {
  ...
  public void setOnPropertyValueChangedListener(Lw onPropertyValueChangedListener) {
    ...
    viewPropertyItems.setOnPropertyValueChangedListener(
        viewBean -> {
    ...
    if (showAllHider == null) {
      showAllHider =
          ObjectAnimator.ofFloat(
              layoutPropertySeeAll, View.TRANSLATION_Y, wB.a(getContext(), 84.0f));
  ...
  private void showSaveToCollectionDialog() {
    ...
    ((TextView) view.findViewById(R.id.tv_favorites_guide))
        .setText(Helper.getResString(R.string.view_widget_favorites_save_guide_new));
          ...
          if (!mB.a() && validator.b()) {
            ...
            ArrayList<ViewBean> viewBeans =
                jC.a(sc_id)
                    .b(
                        ...
                        projectActivityViews.get(idsAdapter.getSelectedItemPosition()));
            for (ViewBean viewBean : viewBeans) {
              ...
              if (backgroundResource != null
                  && !backgroundResource.equals("NONE")
                  && jC.d(sc_id).l(backgroundResource)
                  && !Op.g().b(backgroundResource)) {
                try {
              ...
              if (resName != null
                  && !resName.equals("default_image")
                  && !resName.equals("NONE")
                  && jC.d(sc_id).l(resName)
                  && !Op.g().b(resName)) {
                try {
  ...
  private void initialize(Context context) {
    ...
    hcvProperty.setOnScrollChangedListener(
    ...
    spnWidget.setOnItemSelectedListener(
  ...
  private static class ViewIdsAdapter extends BaseAdapter {
    ...
    private ViewIdSpinnerItem getSpinnerItem(
        int position, View convertView, boolean isSelected, boolean isDropDownView) {
  ...
  private class SeeAllPropertiesFloatingItem extends LinearLayout implements View.OnClickListener {
    ...
    private void configure(int imageResId, int propertyNameResId) {
      ...
      propertyMenuItem.setCardBackgroundColor(
          MaterialColors.getColor(this, R.attr.colorPrimaryContainer));
      icon.setImageResource(imageResId);
      icon.setColorFilter(
          MaterialColors.getColor(this, R.attr.colorOnPrimaryContainer), PorterDuff.Mode.SRC_ATOP);
