...
public class ManageCompatActivity extends BaseAppCompatActivity implements View.OnClickListener {
  ...
  private void configureLibraryDialog() {
    ...
    dialog.a(
        Helper.getResString(R.string.design_library_message_confirm_uncheck_appcompat_and_design));
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    binding.tvWarning.setText(
        Helper.getResString(R.string.design_library_message_slow_down_compilation_time));
    configure();
  }
}
