...
public class ShowWidgetCollectionActivity extends BaseAppCompatActivity
    ...
    scrollView.setLayoutParams(
        new LinearLayout.LayoutParams(
            ...
            getResources().getDisplayMetrics().heightPixels
                - GB.a(e)
                - GB.f(e)
                - actionContainer.getMeasuredHeight()));
  ...
  public void onClick(View v) {
    ...
    if (id == R.id.img_back) {
      ...
      bB.a(
              ...
              getTranslatedString(R.string.design_manager_message_edit_complete),
              bB.TOAST_NORMAL)
          .show();
      finish();
    }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    getSupportActionBar()
        .setTitle(getTranslatedString(R.string.design_manager_widget_title_actionbar_title));
