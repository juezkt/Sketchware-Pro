...
public class ComponentEventButton extends LinearLayout {
  ...
  public void onEventAdded() {
    ...
    icon.setColorFilter(
        MaterialColors.getColor(name, com.google.android.material.R.attr.colorSecondary));
  }
  ...
  public void onEventAvailableToAdd() {
    ...
    icon.setColorFilter(
        MaterialColors.getColor(name, com.google.android.material.R.attr.colorOutlineVariant));
  }
