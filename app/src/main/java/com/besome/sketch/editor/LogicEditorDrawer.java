...
public class LogicEditorDrawer extends LinearLayout {
  ...
  private void initialize(Context context) {
    ...
    ((TextView) findViewById(R.id.tv_block_collection))
        .setText(Helper.getResString(R.string.logic_editor_title_block_collection));
  ...
  public View a(String str, ArrayList<BlockBean> arrayList) {
    ...
    if (!arrayList.isEmpty()) {
      ...
      collectionBlock =
          new Us(
              getContext(), blockBean.type, blockBean.typeName, blockBean.opCode, str, arrayList);
      favorite.addView(collectionBlock);
      View view = new View(getContext());
      view.setLayoutParams(new LinearLayout.LayoutParams(1, (int) getDip(8)));
