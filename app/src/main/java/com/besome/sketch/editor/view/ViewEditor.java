...
public class ViewEditor extends RelativeLayout
  ...
  public static void shakeView(View view) {
    ObjectAnimator.ofFloat(view, "translationX", 0, 35, -35, 35, -35, 25, -25, 12, -12, 0)
        .setDuration(200)
        .start();
  }
  ...
  private void animateUpDown() {
    ...
    animatorTranslateX =
        ObjectAnimator.ofFloat(deleteView, "TranslationY", deleteView.getHeight() * 2);
  ...
  private void addPaletteGroupItems() {
    ...
    basicPalette.setOnClickListener(
        v -> {
          showPaletteWidget();
    ...
    favoritePalette.setOnClickListener(
        v -> {
          showPaletteFavorite();
    ...
    paletteWidget
        ...
        .withEndAction(
            () -> {
              ...
              paletteFavorite.animate().alpha(1f).setDuration(100).start();
            })
        .start();
  }
    ...
    paletteFavorite
        ...
        .withEndAction(
            () -> {
              ...
              paletteWidget.animate().alpha(1f).setDuration(100).start();
            })
        .start();
  }
  ...
  public boolean onTouch(View view, MotionEvent motionEvent) {
    ...
    if (view == viewPane) {
      ...
      if (actionMasked != MotionEvent.ACTION_MOVE) {
        ...
        if (Math.abs(u - motionEvent.getRawX()) >= scaledTouchSlop
            || Math.abs(v - motionEvent.getRawY()) >= scaledTouchSlop) {
          r = null;
          handler.removeCallbacks(ea);
          return true;
        }
        ...
        if (b(motionEvent.getRawX(), motionEvent.getRawY())) {
          ...
          int width =
              isNotIcon
                  ? r.getWidth()
                  : (r instanceof IconLinearHorizontal ? ViewGroup.LayoutParams.MATCH_PARENT : I);
          int height =
              isNotIcon
                  ? r.getHeight()
                  : (r instanceof IconLinearVertical ? ViewGroup.LayoutParams.MATCH_PARENT : J);
          viewPane.updateView(
              (int) motionEvent.getRawX(), (int) motionEvent.getRawY(), width, height);
        } else {
      ...
      if (dummyView.getAllow()) {
        ...
        if (r instanceof uy uyVar) {
              ...
              try {
                oBVar.a(
                    wq.a()
                        ...
                        + File.separator
                        + a2.resFullName,
                    wq.g() + File.separator + a + File.separator + a2.resFullName);
              } catch (Exception e) {
                e.printStackTrace();
              }
              jC.d(a).b.add(a2);
              ...
              try {
                oBVar.a(
                    wq.a()
                        ...
                        + File.separator
                        + a3.resFullName,
                    wq.g() + File.separator + a + File.separator + a3.resFullName);
              } catch (Exception e2) {
                e2.printStackTrace();
              }
              jC.d(a).b.add(a3);
          ...
          if (areImagesAdded) {
            bB.a(
                    getContext(),
                    xB.b().a(getContext(), R.string.view_widget_favorites_image_auto_added),
                    bB.TOAST_NORMAL)
                .show();
          }
  ...
  private void initialize(Context context) {
    ...
    paletteWidget.cardView.setOnClickListener(
        view -> widgetsCreatorManager.showWidgetsCreatorDialog(-1));
  }
    ...
    if (isViewAnIconBase(r)) {
      if (r instanceof uy uyVar) {
        ...
        if (isAdViewUsed && !draggingListener.isAdmobEnabled()) {
          bB.b(
                  getContext(),
                  xB.b().a(getContext(), R.string.design_library_guide_setup_first),
                  bB.TOAST_NORMAL)
              .show();
          return;
        }
  ...
  private boolean b(float f, float f2) {
    ...
    return f > locationOnScreen[0]
        && f < locationOnScreen[0] + (viewPane.getWidth() * viewPane.getScaleX())
        && f2 > locationOnScreen[1]
        && f2 < locationOnScreen[1] + (viewPane.getHeight() * viewPane.getScaleY());
  }
  ...
  private void deleteWidgetFromCollection(String str) {
    ...
    dialog.b(
        xB.b().a(getContext(), R.string.common_word_delete),
        v -> {
          Rp.h().a(str, true);
    ...
    dialog.a(
        xB.b().a(getContext(), R.string.common_word_cancel),
  ...
  private void b(boolean z, boolean isCustomWidget) {
    if (isCustomWidget) {
      deleteIcon.setImageDrawable(
          AppCompatResources.getDrawable(getContext(), R.drawable.ic_mtrl_edit));
      deleteText.setText("Drag here to see the Actions");
    } else if (z) {
      deleteIcon.setImageDrawable(
          AppCompatResources.getDrawable(getContext(), R.drawable.ic_mtrl_delete));
  ...
  private void a() {
    ...
    int var8 =
        displayHeight - statusBarHeight - toolBarHeight - (int) (f * 48.0F) - (int) (f * 48.0F);
    if (screenType == 0 && da) {
      var8 -= (int) (f * 56.0F);
    }

    float var11 =
        Math.min((float) var9 / (float) displayWidth, (float) var8 / (float) displayHeight);
    float var3 =
        Math.min(
            (float) (var9 - var4 * 2) / (float) displayWidth,
            (float) (var8 - var5 * 2) / (float) displayHeight);
  ...
  public final String a(ViewBean bean) {
    int i = bean.type;
    String b2 =
        !bean.isCustomWidget ? wq.b(i) : widgetsCreatorManager.generateCustomWidgetId(bean.convert);
  ...
  private boolean a(float x, float y) {
    ...
    return x > locationOnScreen[0]
        && x < locationOnScreen[0] + deleteView.getWidth()
        && y > locationOnScreen[1]
        && y < (locationOnScreen[1] + deleteView.getHeight());
  }
  ...
  private void rippleRound(View view, int focus, int pressed, double round) {
    ...
    RippleDrawable RE =
        new RippleDrawable(
            new ColorStateList(new int[][] {new int[] {}}, new int[] {pressed}), GG, null);
