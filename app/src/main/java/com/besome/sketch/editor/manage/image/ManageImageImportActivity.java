...
public class ManageImageImportActivity extends BaseAppCompatActivity
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    tv_samename.setText(
        xB.b().a(getApplicationContext(), R.string.design_manager_image_title_apply_same_naming));
